        ...
        TWIRlang = {}, TWIR = {
            ...
            TWIR.storage.get("chat_smart") && (! function() {
                ...
                var a = new RegExp(/^https?:\/\/(?:(?:www|m)\.)?(?:youtube\.com\/watch(?:\?v=|\?.+?&v=)|youtu\.be\/)([a-z0-9_-]+)$/i),
                    ...
                    l = new RegExp(/https?:\/\/\S+?\/\S+?\.(?:jpg|jpeg|gif|png)/);
                switch (!0) {
                    case l.test(e):
                        var p = l.exec(e);
                        if (p && e.length === p[0].length) {
                            var A = '<div style="width: 280px; height: 165px; margin: 15px; cursor: pointer;" onclick="showlink(\'' + p[0].escapeHTML() + '\');return false" target="_blank"> <img src="' + p[0] + '" style="height: 100%;width: auto;"/></div>';
