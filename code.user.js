      ...
      .addButton("OK").show() : (TWIRlang = {}, TWIR = {
        ...
        storage:
        {
          ...
          getValidMarketList: function()
          {
            ...
            for (var p = Object.keys(TWIR.marketWatcher.regexItems()), A = 0; A < p.length; A++)
            {
              var l = p[A];
              i.push(
              {
        ...
        {
          TWIR.storage.get("inv_window_minititle") ? Inventory.window.setMiniTitle(t.cutIt(50)) : Inventory.window.setMiniTitle("TWIR"), TWIR.storage.get(
            "inv_window_title") ? Inventory.window.setTitle('<span style="margin-top: 4px; font-size: 16pt;">' + e.replace("*", "").replace("#", "")
            .cutIt(50) + "</span>") : Inventory.window.setTitle('<span style="margin-top: 4px; font-size: 16pt;">TWIR - ' + TWIRlang.invent + "</span>")
        },
        replUml: function(e)
        {
          ...
          openFeat: function()
          {
            ...
            try
            {
              ...
              var s = $("<div/>"),
                ...
                p = $("<div/>"),
                A = $("<div/>");
              for (var c in TWIR.storage.features) c.indexOf("inv_") > -1 ? (this.gui.check[c] = (new west.gui.Checkbox).setLabel(TWIRlang.feat_strings[
                c]).setSelected(TWIR.storage.get(c)).appendTo(s), s.append('<br><div style="height:5px;" />')) : c.indexOf("pop_") > -1 ? (this.gui
                .check[c] = (new west.gui.Checkbox).setLabel(TWIRlang.feat_strings[c]).setSelected(TWIR.storage.get(c)).appendTo(l), l.append(
                  '<br><div style="height:5px;" />')) : c.indexOf("mw_") > -1 ? (this.gui.check[c] = (new west.gui.Checkbox).setLabel(TWIRlang
                .feat_strings[c]).setSelected(TWIR.storage.get(c)).appendTo(p), p.append('<br><div style="height:5px;" />')) : (this.gui.check[c] = (
                new west.gui.Checkbox).setLabel(TWIRlang.feat_strings[c]).setSelected(TWIR.storage.get(c)).appendTo(A), A.append(
              ...
              for (var d = (new west.gui.Combobox).setWidth(50), m = 7; m <= 14; m++) d.addItem(m, m.toString());
              d.select(TWIR.Inventory.data.menuSize), t.appendContent(
                ...
                .appendContent(d.getMainDiv().css(
                {
                  ...
                  '<div style="font-weight: bold;margin-top: 8px;text-shadow: 2px 1px 2px #fae3ad;color: #5e321a;font-size: 16px;margin-bottom: 5px;">' +
                  TWIRlang.features.other + "</div>"), t.appendContent(A), t.appendContent("<br>"), $(t.getMainDiv()).css(
                {
                  height: "305px",
                  "margin-top": "10px",
                  "margin-left": "20px",
              ...
              var u = new west.gui.Button(TWIRlang.organizing.submit, function()
                {
              ...
              w.append(u.getMainDiv()), h.append(b, w), $(this.gui.window.getContentPane()).append(t.getMainDiv()).append(h)
            }
            catch (e)
            {
              TWIR.bugHunt(e)
        ...
        init: function()
        {
          if (ItemManager.isLoaded() && Bag.loaded && west.storage.ItemSetManager._initialized) try
          {
            TWIR.handler(), TWIR.storage.init(), TWIR.usebonus.getKeys(), TWIR.usebonus.getDesc(), TWIR.enhancedPlayerProfile(), TWIR.smarterChat(),
              ...
              }), TWIR.fbInfo.init(), TWIR.gameInject.init(), TWIR.images.getSkillImg(), TWIR.Inventory.initCol(), TWIR.console("TWIR version " + TWIR
                .version + " by Jamza SUCCESSFULLY LOADED.", "green")
          }
          catch (e)
          {
            TWIR.bugHunt(e)
        ...
        gameInject:
        {
          init: function()
          {
            this.addAllToAddressbook(), this.addAliToTownWindow(), this.fixJobNumbers(), this.addBattleCount(), this.addBestClothes4Build(), this
              .addMsgToFb(), this.sendMsgAli(), this.afterBattleMsg(), this.bonusToProfile(), this.travelButton(), this.betterBattleTopic(), this
              .sortedTitles(), setInterval(this.addBattleCount, Math.floor(Math.random() * (3e5 + 1) + 3e5))
          },
          ...
          bonusToProfile: function()
          {
            PlayerProfileMain.twir_setWear = PlayerProfileMain.twir_setWear || PlayerProfileMain.setWear, PlayerProfileMain.setWear = function(e, t)
            {
              ...
              if (a.length)
              {
                ...
                var A = TWIR_calc.exportFullBonus(s, !0, !1, t.level),
                  c = '<div style="color: #8b4513;margin-bottom: 10px;">' + TWIRlang.calc.bonus_count_title + ":&nbsp;</div>";
                c += TWIR.Inventory.fullBonusTooltip(A, !1), i.append(new west.gui.Icon("shirt").getMainDiv().css(
                {
                  position: "absolute",
                  cursor: "pointer",
                  top: "36px",
              ...
              ! function o()
              {
                ...
                }, function(s)
                {
                  ...
                  if (l)
                  {
                    ...
                    if (n < e.length - 1)
                    {
                      var A = ++n > 20 ? Math.floor(501 * Math.random() + 500) : n > 30 ? Math.floor(501 * Math.random() + 1500) : 0;
                      setTimeout(function()
                      {
                        o()
                      }, A)
          ...
          getData: function()
          {
            ...
            FortBattle.twir_flashShowCharacterInfo = FortBattle.twir_flashShowCharacterInfo || FortBattle.flashShowCharacterInfo, FortBattle
              .flashShowCharacterInfo = function(t, i, a, n, r, o, s, l, p)
              {
                ...
                {
                  var A = JSON.parse(l),
                    c = A.offense + A.defense + A.leadbonus != 0;
                  e.data.playerId = i, e.data.fortId = t, e.data.isAllied = c
                }
                catch (e)
                {}
              ...
              FortBattleWindow.changeCellPopupText = function(t)
              {
                ...
                if (a)
                {
                  ...
                  var n = a.westPlayerId,
                    ...
                    A = e.formatRank(n, r) ? e.formatRank(n, r) : "",
                    c = '<td><img src="%1" /></td><td>&nbsp;%2&nbsp;</td>',
                    g = "<div style='margin-left: 10px;'><table cellpadding=0 cellspacing=0><tr>" + (0 != a.bonusinfo.offense ? s(c,
                      "/images/fort/battle/attacker_secondary.png", a.bonusinfo.offense || 0) : "") + (0 != a.bonusinfo.defense ? s(c,
                      "/images/fort/battle/defender_secondary.png", a.bonusinfo.defense || 0) : "") + (0 != a.bonusinfo.leadbonus ? s(c,
                  ...
                  g += '<table style="margin:0;padding:0;font-size:8pt"><tr style="font-size:8pt;height:20px;font-weight:bold;">', g +=
                    ...
                    a.name + '&nbsp;</div></td><td style="vertical-align: middle;">' + (TWIR.storage.get("fb_online_status") && n !== Character.playerId ?
                      p : "") + '&nbsp;</td><td style="vertical-align: middle;">' + (TWIR.storage.get("fb_ranks") ? A : "") + "</td>";
        ...
        smarterChat: function()
        {
          ...
          }, Chat.Formatter.twir_formatText = Chat.Formatter.twir_formatText || Chat.Formatter.formatText, Chat.Formatter.formatText = function(e, t)
          {
            ...
            switch (!0)
            {
              case p.test(e):
                var A = p.exec(e);
                if (A && e.length === A[0].length)
                {
                  var c = '<div style="width: 280px; height: 165px; margin: 15px; cursor: pointer;" onclick="showlink(\'' + A[0].escapeHTML() +
                    '\');return false" target="_blank"> <img src="' + A[0] + '" style="height: 100%;width: auto;"/></div>';
                  return e = e.replace(A[0], c)
                }
                break;
              case a.test(e):
                var g = a.exec(e),
                ...
                {
                  var m = '<div class="twir_embed-container"><iframe src="https://www.youtube.com/embed/' + g[1] +
              ...
              case o.test(e):
                ...
                {
                  var f = '<div class="twir_embed-container"><iframe src="https://www.facebook.com/plugins/video.php?href=' + encodeURIComponent(I[
                    0]) +
              ...
              case l.test(e):
                ...
                {
                  var y = '<div class="twir_embed-container"><iframe src="https://player.twitch.tv/?video=' + k[1] +
              ...
              case s.test(e):
                ...
                {
                  var R = '<div class="twir_embed-container"><iframe src="https://player.twitch.tv/?channel=' + x[1] +
                    '&autoplay=false&width=280&height=157" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true" allowFullScreen="true"></iframe></div>';
                  return e = e.replace(x[0], R)
                }
            }
          ...
          calcPosition: function(e, t)
          {
            try
            {
              ...
              i || (i = $("#popup-container").find(".twir_popup")), (o = MousePopup.prototype.wrap(l)) !== a && (i.html(o), a = o, n = i.height(), r = i
                .width()), t > Map.width / 2 ? e.left = e.left - r : e.left = e.left + p, A - e.top < n + 10 && (e.top = A - (n + 10)), i.css(
              {
                top: e.top,
                left: e.left
              })
              ...
              Map.PopupHandler.twir_getJobPopup = Map.PopupHandler.twir_getJobPopup || Map.PopupHandler.getJobPopup, Map.PopupHandler.getJobPopup =
                function(e)
                {
                  ...
                  if (JobsModel.Beans[e.id])
                  {
                    ...
                    for (var A in e.yields)
                    {
                      var c = ItemManager.get(A, !0),
                        g = void 0 !== a[c.short] && 0 != a[c.short].percentage ? a[c.short].percentage : Math.ceil(600 * e.yields[A].prop),
                        d = JobsModel.Beans[e.id].basis.long.duration.getTime2EndToken();
                      t = t.replace("</div>" + c.name + "</div>", "</div>" + c.name +
          ...
          itemPopup: function()
          {
              ...
              /hand:\s{0,1}_{0,1}\({0,1}"(.*?)"\){0,1}/.exec(t[1])[1]), ItemPopup.getXHTML = function()
            {
              try
              {
                ...
                {
                  for (var A = TWIR.usebonus.keys.energy, c = TWIR.usebonus.keys.health, g = "", d = 0; d < this.item_obj.usebonus.length; d++)
                  ...
                  else if (this.item_obj.usebonus[d].match(c))
                  {
                ...
                var b = TWIR.storage.popups.marketPrice,
                  ...
                  f = TWIR.storage.popups.shop_limited_prices,
                  k = TWIR.storage.popups.crafting,
                  y = b[this.item_obj.short] && b[this.item_obj.short].weight >= 1e4 ? TWIR.replSum(b[this.item_obj.short].weight) : b[this.item_obj
                  ...
                  y + "</div>" : "";
                if (I[this.item_obj.short] && TWIR.storage.get("pop_ups_price"))
                {
                  var R = 1 === this.item_obj.item_level ? 3 : 2 === this.item_obj.item_level ? 9 : 3 === this.item_obj.item_level ? 27 : 4 === this
                    .item_obj.item_level ? 81 : 5 === this.item_obj.item_level ? 243 : 1,
                    v = 3 === I[this.item_obj.short].currency ? '<span style="display: inline-block;position: relative;top: 3px;background: url(' + TWIR
                    .images.currency.bonds_nuggets + ') no-repeat;width: 16px;height: 16px;"></span><span>&nbsp;' + (TWIR.storage.get(
                      "pop_short_currency") ? TWIR.replSum(I[this.item_obj.short].price_bonds * R, !0) : I[this.item_obj.short].price_bonds * R) +
                    ...
                    ') no-repeat;width: 16px;height: 16px;"></span><span>&nbsp;' + (TWIR.storage.get("pop_short_currency") ? TWIR.replSum(I[this
                      .item_obj.short].price_nuggets * R, !0) : I[this.item_obj.short].price_nuggets * R) + "</span>" : 1 === I[this.item_obj.short]
                    .currency ? '<span style="display: inline-block;position: relative;top: 3px;background: url(' + TWIR.images.currency.bonds +
                    ') no-repeat;width: 16px;height: 16px;"></span><span>&nbsp;' + (TWIR.storage.get("pop_short_currency") ? TWIR.replSum(I[this
                      .item_obj.short].price_bonds * R, !0) : I[this.item_obj.short].price_bonds * R) + "</span>" : 8 === I[this.item_obj.short]
                    .currency ? '<span style="display: inline-block;position: relative;top: 3px;background: url(' + TWIR.images.currency.veteran +
                    ') no-repeat;width: 16px;height: 16px;"></span><span>&nbsp;' + (TWIR.storage.get("pop_short_currency") ? TWIR.replSum(I[this
                      .item_obj.short].price_veteran * R, !0) : I[this.item_obj.short].price_veteran * R) + "</span>" : 7 === I[this.item_obj.short]
                    .currency ? '<span style="display: inline-block;position: relative;top: 3px;background: url(' + TWIR.images.currency.bonds_nuggets +
                    ') no-repeat;width: 16px;height: 16px;"></span><span>&nbsp;' + (TWIR.storage.get("pop_short_currency") ? TWIR.replSum(I[this
                      .item_obj.short].price_nuggets * R, !0) : I[this.item_obj.short].price_nuggets * R) +
                    ...
                    R) + "</span>" : "",
                    T = null !== I[this.item_obj.short].limited_time ? '<span style="color: #666;">&nbsp;(' + TWIR.msToTime((new Date(1e3 * I[this
                      .item_obj.short].limited_time).getTime() - (new Date).getTime()) / 1e3) + ")</span>" : "",
                    V = 0 != I[this.item_obj.short].reduced_value ? '<span style="color: #666;">&nbsp;/-' + I[this.item_obj.short].reduced_value +
                    "%</span>" : "";
                  t = t.replace(/(<div\s+class="inventory_popup_prices">[\S\s]*?)(<\/div>)/gi, "$1" + x +
                    '<div class="twir_other_popup_prices">&nbsp;' + v + V + T + "</div> $2")
                }
                else if (f[this.item_obj.short] && TWIR.storage.get("pop_ups_price"))
                {
                  var R = 1 === this.item_obj.item_level ? 3 : 2 === this.item_obj.item_level ? 9 : 3 === this.item_obj.item_level ? 27 : 4 === this
                    .item_obj.item_level ? 81 : 5 === this.item_obj.item_level ? 243 : 1,
                    v = 3 === f[this.item_obj.short].currency ? '<span style="display: inline-block;position: relative;top: 3px;background: url(' + TWIR
                    .images.currency.bonds_nuggets + ') no-repeat;width: 16px;height: 16px;"></span><span>&nbsp;' + (TWIR.storage.get(
                      "pop_short_currency") ? TWIR.replSum(f[this.item_obj.short].price_bonds * R, !0) : f[this.item_obj.short].price_bonds * R) +
                    ...
                    ') no-repeat;width: 16px;height: 16px;"></span><span>&nbsp;' + (TWIR.storage.get("pop_short_currency") ? TWIR.replSum(f[this
                      .item_obj.short].price_nuggets * R, !0) : f[this.item_obj.short].price_nuggets * R) + "</span>" : 1 === f[this.item_obj.short]
                    .currency ? '<span style="display: inline-block;position: relative;top: 3px;background: url(' + TWIR.images.currency.bonds +
                    ') no-repeat;width: 16px;height: 16px;"></span><span>&nbsp;' + (TWIR.storage.get("pop_short_currency") ? TWIR.replSum(f[this
                      .item_obj.short].price_bonds * R, !0) : f[this.item_obj.short].price_bonds * R) + "</span>" : 8 === f[this.item_obj.short]
                    .currency ? '<span style="display: inline-block;position: relative;top: 3px;background: url(' + TWIR.images.currency.veteran +
                    ') no-repeat;width: 16px;height: 16px;"></span><span>&nbsp;' + (TWIR.storage.get("pop_short_currency") ? TWIR.replSum(f[this
                      .item_obj.short].price_veteran * R, !0) : f[this.item_obj.short].price_veteran * R) + "</span>" : 7 === f[this.item_obj.short]
                    .currency ? '<span style="display: inline-block;position: relative;top: 3px;background: url(' + TWIR.images.currency.bonds_nuggets +
                    ') no-repeat;width: 16px;height: 16px;"></span><span>&nbsp;' + (TWIR.storage.get("pop_short_currency") ? TWIR.replSum(f[this
                      .item_obj.short].price_nuggets * R, !0) : f[this.item_obj.short].price_nuggets * R) +
                    '</span><span style="display: inline-block;position: relative;top: 3px;background: url(' + TWIR.images.currency.dollars +
                    ') no-repeat;width: 16px;height: 16px;margin-left: 5px;"/><span>&nbsp;&#36;' + TWIR.replSum(f[this.item_obj.short].price_dollar *
                    R) + "</span>" : "";
                  t = t.replace(/(<div\s+class="inventory_popup_prices">[\S\s]*?)(<\/div>)/gi, "$1" + x +
                    '<div class="twir_popup_limited_prices">&nbsp;' + v + "</div> $2")
                }
                ...
                if (!this.item_obj.sellable && this.item_obj.auctionable && TWIR.storage.get("pop_min_market_price"))
                {
                  ...
                  {
                    var B = TWIR.storage.get("pop_short_currency") ? TWIR.replSum(this.item_obj.sell_price, !0) : this.item_obj.sell_price;
                    W = '<span class="inventory_popup_trader_price_sell"><span class="invPopup_sellicon"/>&nbsp;$' + B + "</span>"
                  }
                    ...
                    .item_obj.item_id])
                {
                  ...
                  var J = ItemManager.getByBaseId(k[this.item_obj.item_id].recipe, !0).min_level >= 50;
                  TWIR.storage.get("pop_recipe_table") && J && (Q +=
                ...
                {
                  var D = JobList.getJobsByItemId(this.item_obj.item_id);
                      ...
                      Z = 0; Z < D.length; Z++)
                  {
                    var P = 0,
                      N = 0;
                    if ($.isEmptyObject(JobsModel.Beans) || null == JobsModel.Beans[D[Z].id].basis.long.yields[0]) P = Math.ceil(600 * D[Z].yields[this
                      .item_obj.item_id].prop), N = 0;
                    else if (!$.isEmptyObject(JobsModel.Beans) && void 0 !== JobsModel.Beans[D[Z].id].basis.long.yields[0])
                      for (var z = 0; z < JobsModel.Beans[D[Z].id].basis.long.yields.length; z++) JobsModel.Beans[D[Z].id].basis.long.yields[z]
                        .itemid === this.item_obj.item_id && (P = JobsModel.Beans[D[Z].id].basis.long.yields[z].prop, N = JobsModel.Beans[D[Z].id].basis
                    ...
                    ), null !== this.item_obj.set)
                {
                  ...
                  if (TWIR.storage.get("pop_partial_bonus") && 0 == ee && !1 === i)
                  {
                    ...
                    var pe = ae > re ? _.getMergedStages(re) : 0 === ae ? _.getMergedStages(re) : _.getMergedStages(ae),
                      Ae = null !== ie && ae > re ? ie.getMergedStages(re) : null !== ie ? ie.getMergedStages(ae) : [];
                    ...
                    for (var ce = [], ge = [], de = 0; de < pe.length; de++)
                    {
                      var me = void 0 !== oe.getDesc(pe[de]) ? oe.getDesc(pe[de]).replace(/[^0-9.\%]/g, "") : "",
                        ue = void 0 !== oe.getDesc(pe[de]) ? oe.getDesc(pe[de]).replace(/[0-9\%\+\.\,]/g, "").replace(/(\(|\)).*/g, "").trim() : "";
                      ce.push(
                      {
                        skill: ue,
                        value: me
                    ...
                    {
                      var we = void 0 !== oe.getDesc(Ae[he]) ? oe.getDesc(Ae[he]).replace(/[^0-9.\%]/g, "") : "",
                        be = void 0 !== oe.getDesc(Ae[he]) ? oe.getDesc(Ae[he]).replace(/[0-9\%\+\.\,]/g, "").replace(/(\(|\)).*/g, "").trim() : "";
                      ge.push(
                      {
                        skill: be,
                        value: we
                    ...
                    for (var Ie = [], fe = 0; fe < ce.length; fe++)
                    {
                      for (var ke = 0; ke < ge.length; ke++)
                        if (ce[fe].skill === ge[ke].skill)
                        {
                          var ye = ce[fe].value.indexOf("%") > -1 && ge[ke].value.indexOf("%") > -1,
                            xe = parseFloat(ce[fe].value) - parseFloat(ge[ke].value);
                          Ie.push(
                          {
                            skill: ce[fe].skill,
                            diff: ye ? xe + "%" : xe,
                    ...
                    for (var Re = 0; Re < ge.length; Re++) Ie.find(function(e)
                    {
                      return e.skill === ge[Re].skill
                    }) || Ie.push(
                    {
                      skill: ge[Re].skill,
                      diff: "red",
                    ...
                    for (var ve = 0; ve < Ie.length; ve++)
                      if ("red" !== Ie[ve].diff)
                      {
                        var Te = null === Ie[ve].diff ? '&nbsp;(<span class="tw_green">+' + Ie[ve].value + "</span>)&nbsp;" : parseFloat(Ie[ve].diff) >
                          0 ? '&nbsp;(<span class="tw_green">+' + Ie[ve].diff + "</span>)&nbsp;" : parseFloat(Ie[ve].diff) < 0 ?
                          '&nbsp;(<span class="tw_red">' + Ie[ve].diff + "</span>)&nbsp;" : "&nbsp;",
                          Ve = 0 === Ie[ve].diff ? "color: #CC7722" : "color: #666";
                        le += '<li style="' + Ve + ';">' + Ie[ve].value + "&nbsp;" + Ie[ve].skill + Te + "</li>"
                      } for (var We = 0; We < Ie.length; We++) "red" === Ie[We].diff && (le += '<li class="tw_red">-' + Ie[We].value + "&nbsp;" + Ie[We]
                      .skill + "</li>");
                    t += le += "</ul>"
                  }
                  var Be = ee > 0 ? "&nbsp;(" + ee + "/" + re + ")" : "";
          ...
          for (var i in e)
            if (e[i])
            {
              ...
              if ((a.short.indexOf("_fine") >= 0 && null === a.set || null === a.traderlevel && "yield" !== a.type && "recipe" !== a.type && !0 === a
                  .auctionable && !0 === a.dropable && null === a.set) && (TWIR.storage.inventory.collectibles.includes(a.item_base_id) || TWIR.storage
        ...
        initItems: function()
        {
          try
          {
            var e = Bag.items_by_id,
              t = [],
              i = (ItemManager.getAll(), TWIR.usebonus),
              a = i.keys,
              n = Wear.get("right_arm") && "shot" === Wear.get("right_arm").obj.sub_type ? CharacterSkills.keyNames.shot : CharacterSkills.keyNames.punch,
              r = [CharacterSkills.keyNames.aim, CharacterSkills.keyNames.tough, CharacterSkills.keyNames.reflex, CharacterSkills.keyNames.dodge,
                CharacterSkills.keyNames.tactic, CharacterSkills.keyNames.appearance, n
              ],
              o = Object.values(a),
              s = Object.keys(a),
              l = [],
            ...
            for (var A in e)
            {
              if (e[A]) var c = e[A].obj;
              if (c.has_cooldown && e[A].showCooldown(), "yield" === c.type)
                if ("mapdrop" === c.spec_type && "none" === c.usetype) TWIR.storage.inventory.work.includes(c.item_id) || TWIR.storage.inventory.work
                  .push(c.item_id);
                else if (null !== c.set || countObjectKeys(ItemManager.get(A, !0).exportBoni()) > 0) TWIR.storage.inventory.bonus.includes(c.item_id) ||
                TWIR.storage.inventory.bonus.push(c.item_id);
              else if ("crafting" === c.spec_type)
              {
                if (c.usebonus)
                  ...
                  {
                    var d = c.usebonus[g],
                      m = o.findIndex(function(e)
                      {
                        return i.same(e, d)
                      });
                    switch (!0)
                    {
                      case m > -1 && !$.isNumeric(s[m]):
                        p[s[m]] || (p[s[m]] = []), p[s[m]].includes(c.item_id) || p[s[m]].push(c.item_id);
                        break;
                      case Object.keys(CharacterSkills.keyNames).some(function(e)
                      {
                        return i.same(CharacterSkills.keyNames[e].toLowerCase(), d.toLowerCase())
                      }) && !i.same(a.lp, d):
                        p.skills || (p.skills = []), p.skills.includes(c.item_id) || p.skills.push(c.item_id);
                      case Object.keys(CharacterSkills.keyNames).some(function(e)
                      {
                        return i.same(CharacterSkills.keyNames[e].toLowerCase(), d.toLowerCase()) && $.inArray(CharacterSkills.keyNames[e], r) > -1
                      }):
                        p.duels || (p.duels = []), p.duels.includes(c.item_id) || p.duels.push(c.item_id);
                        break;
                      default:
                    ...
                    if (u) switch (!0)
                    {
                      case i.same(a.unpack_card, d):
                        p.craft_cards || (p.craft_cards = []), p.craft_cards.includes(c.item_id) || p.craft_cards.push(c.item_id);
                        break;
                      case !i.same(a.unpack_card, d):
                        p.crafted_items || (p.crafted_items = []), p.crafted_items.includes(c.item_id) || p.crafted_items.push(c.item_id)
                    }
                  }
                var h = TWIR.storage.popups.crafting[c.item_id];
                h && (p["prof_" + h.profsymbol] || (p["prof_" + h.profsymbol] = []), p["prof_" + h.profsymbol].includes(c.item_id) || p["prof_" + h
                  .profsymbol].push(c.item_id))
              }
              else if ("bonus_medal" === c.spec_type && "use" === c.usetype || 50991e3 === c.item_id) p.bonus_medal || (p.bonus_medal = []), p.bonus_medal
                .includes(c.item_id) || p.bonus_medal.push(c.item_id);
              else if ("none" === c.usetype || "jobdrop" === c.spec_type) TWIR.storage.inventory.quest.includes(c.item_id) || TWIR.storage.inventory.quest
                .push(c.item_id);
              ...
              "recipe" === c.type && (p.recipes || (p.recipes = []), p.recipes.includes(c.item_id) || p.recipes.push(c.item_id))
            }

            function w(e)
            {
              if (!Array.isArray(e)) return p[e] || [];
              for (var t = [], i = 0; i < e.length; i++) p[e[i]] && (t = t.concat(p[e[i]]));
              return t
            }
            var b = TWIR.storage.inventory.buffs = {},
              I = [],
              f = {
                energy: w("energy"),
                health: w("health"),
                work_motivation: w("work_motivation"),
                duel_motivation: w("duel_motivation"),
                adventures: w(["attack", "defense"]),
                skills: w("skills"),
                labor_points: w("lp"),
                luck_money: w(["money", "luck", "drop"]),
                fort_battles: w(["attack", "defense", "fort"]),
                duels: w(["duel_dmg", "duel_dmg_pl", "duel_hp_pl", "duels"]),
                speed: w("speed_passive"),
                waytime_shortening: w("speed_active"),
                xp: w(["xp", "xp_bottle"]),
                regen: w("regen")
              };
            $.each(f, function(e, t)
            {
              b[e] = {
                ...
                items: t
              }, I = I.concat(t.filter(function(e)
              {
                return I.indexOf(e) < 0
              }))
            });
            var k = TWIR.storage.inventory.use = {},
              y = [],
              x = {
                events: w(["event_1", "event_2", "event_3", "event_4", "event_5"]),
                premium: w("bonus_medal"),
                unpacks: w(["unpack_multiple", "unpack_one"]),
                coll_cards: w("unpack_card"),
                bonds_money: w(["money_small", "money_big", "bonds"]),
                avatar_part: w("avatar")
              };
            $.each(x, function(e, t)
            {
              k[e] = {
                name: TWIRlang.inventory[e],
                items: t
              }, y = y.concat(t.filter(function(e)
              {
                return y.indexOf(e) < 0
              }))
            });
            var R = TWIR.storage.inventory.crafting = {},
              v = [],
              T = {
                field_cook: w("prof_1"),
                tonic_peddler: w("prof_2"),
                blacksmith: w("prof_3"),
                master_saddler: w("prof_4"),
                craft_cards: w("craft_cards"),
                crafted_items: w("crafted_items"),
                recipes: w("recipes")
              };
            $.each(T, function(e, t)
            {
              R[e] = {
                name: TWIRlang.inventory[e],
                items: t
              }, v = v.concat(t.filter(function(e)
              {
                return v.indexOf(e) < 0
              }))
            }), TWIR.storage.inventory.use_all = y, TWIR.storage.inventory.buffs_all = I, TWIR.storage.inventory.crafting_all = v;
            var V = TWIR.storage.inventory.bonus,
              W = TWIR.storage.inventory.quest,
              B = TWIR.storage.inventory.use_all.concat(TWIR.storage.inventory.buffs_all).concat(TWIR.storage.inventory.crafting_all).concat(V).concat(W);
            l = $.grep(t, function(e)
            {
              return $.inArray(e, B) < 0
            }), k.others = {
        ...
        checkShop: function()
        {
          ...
          {}, function(i)
          {
            if (i.error) return new UserMessage(i.msg).show();
            if (void 0 !== i.inventory)
            {
              for (var a = i.inventory.trader || [], n = west.window.shop.model._l10n.mouseovers.categories.trader, r = 0; r < a.length; r++)
              {
                var o = ItemManager.get(a[r].item_id, !0),
                  s = {
                    type: o.type,
                    auction_ends_in: 0,
                    auction_end_date: i.traderTime,
                    item_id: a[r].item_id,
                    item_count: 1,
                    auction_price: null,
                    max_price: a[r].price_dollar,
                    seller_name: n || "Trader",
                    seller_id: 0,
                    market_town_id: 0,
                    market_town: "",
                    posx: 0,
              ...
              var l = new Date(1e3 * i.traderTime).getTime() - (new Date).getTime();
              for (var p in setTimeout(function()
                {
                  TWIR.checkShop()
                }, l), i.inventory)
                if (i.inventory[p])
                  for (var A = 0; A < i.inventory[p].length; A++)
                  {
                    var c = i.inventory[p][A],
                      g = ItemManager.get(c.item_id, !0);
                    t[g.short] = {
                      currency: c.currency,
              ...
              TWIR.marketWatcher.trader = e, TWIR.storage.popups.shop_limited_prices = t, TWIR.storage.save("twir_limitedSale", t)
            }
          })
        },
        ...
        checkMap: function(e)
        {
          ...
          {}, function(t)
          {
            ...
            for (var s in o)
              ...
              A = t.quest_locations;
            for (var c in A) A[c] && A[c][0] && p.push([parseInt(A[c][0][0] / Map.tileSize), parseInt(A[c][0][1] / Map.tileSize)]);
              ...
              if (!$.isEmptyObject(l))
                for (var A in i)
                  for (var c = 0; c < i[A].length; c++)
                    for (var g = 0; g < l[A].length; g++) void 0 !== l[A] && void 0 !== l[A][g].quests && l[A][g].posx == i[A][c].posx && l[A][
                      g].posy == i[A][c].posy && (i[A][c].quests = l[A][g].quests);
              TWIR.storage.NPC = i, 1 != TWIR.npcLoading && 1 != TWIR.npcLoaded && TWIR.loadNPCData(), void 0 !== e && e()
            })
          })
        },
        checkRank:
            ...
            try
            {
              ...
              for (var t = {}, i = 0; i < e.length; i++)
              {
                  ...
                  }), t[a.short]))
                {
                  ...
                  var c = A(p, "weight_avg");
                  c ? t[a.short].weight_avg[c] += 1 : t[a.short].weight_avg[p] = 1, t[a.short].item_count += e[i].item_count, t[a.short].offer_count += 1,
          ...
          calcRecommended: function(e, t)
          {
            ...
            for (var n in e)
            {
              ...
              for (var p in o)
              {
                ...
                {
                  var A = i(Number(p), l);
                  A ? l[A] += 1 : l[Number(p)] = 1
                }
                if (r >= Number(p))
                {
                  var c = i(Number(p), s);
                  c ? s[c] += 1 : s[Number(p)] = 1
                }
              }
        ...
        marketWatcher:
        {
          ...
          openMWTab: function()
          {
            ...
            var t = this.idField,
              ...
              A = this.categories,
              c = (new west.gui.Combobox).setWidth(120);
            c.addItem(1, TWIRlang.informative.enabled), c.addItem(0, TWIRlang.informative.disabled), c.select(i), c.addListener(function(t)
            {
            ...
            function h()
            {
              m = "", MarketWindow.window.$("div.twir_mwl_tab", MarketWindow.DOM).empty(), e.gui.table = (new west.gui.Table).addColumn("twir_mw_idx")
              ...
              for (var t = e.mwl, i = 0; i < t.length; i++)
              {
                var a = t[i].type && "buff" === t[i].type ? p[t[i].item_id] : t[i].type && "set" === t[i].type ? west.storage.ItemSetManager.get(t[i]
                  ...
                  n = A.includes(t[i].type) ? 'data-item-id="' + t[i].item_id + '"' : "",
                ...
                e.gui.table.appendToCell(-1, "twir_mw_item", "<img " + n + ' style="cursor: pointer;" title="' + (A.includes(t[i].type) ? new ItemPopup(a)
                    .getXHTML().escapeHTML() : t[i].type && "set" === t[i].type ? TWIR.Inventory.itemShowcase(a.items, !1, !0) : a.name) + '" src="' + (
                    A.includes(t[i].type) ? a.image : t[i].type && "buff" === t[i].type ? ItemManager.get(p[t[i].item_id].image).image : t[i].type &&
                ...
                var c = new west.gui.Icon("abort").getMainDiv().css(
                {
                  "margin-bottom": "2px",
                  "margin-left": "5px",
                  cursor: "pointer"
                ...
                if (e.gui.table.appendToCell(-1, "twir_mw_remove", c), $.isNumeric(t[i].item_id) && A.includes(t[i].type)) m += "[item=" + t[i].item_id +
                  "]&nbsp;";
                else if ("set" === t[i].type)
                  for (var g = 0; g < a.items.length; g++) m += "[item=" + 1e3 * a.items[g] + "]&nbsp;"
              }
              ...
              t.length && e.gui.table.appendToFooter("twir_mw_remove", b), o.append(e.gui.table.getMainDiv()), e.gui.table.noScrollbar || (null === u && (
                u = e.gui.table.bodyscroll.getScrollPos()), e.gui.table.bodyscroll.scrollTo(u.x, u.y), u = e.gui.table.bodyscroll.getScrollPos())
            }
            ...
            function w(t)
            {
              if (!0 !== e.checking)
              {
                e.gui.table.noScrollbar || (u = e.gui.table.bodyscroll.getScrollPos());
            ...
            h();
            var I = (new west.gui.Textfield).onlyNumeric().setName().maxlength(8).setPlaceholder("$").setWidth(75),
              f = $('<div style="position: absolute;top: 60px;left: 2px;width: 245px;"/>');
            ...
            k(t);
            var y = new west.gui.Button(TWIRlang.market_watcher.add_item, function()
            {
              var t = e.idField;
              if (0 !== t.val)
              {
            ...
            function x()
            {
              e.gui.table.noScrollbar || (u = e.gui.table.bodyscroll.getScrollPos()), TWIR.storage.save("twir_marketAlert", e.mwl)
            }
            var R = $(
              ...
              v = "twir_mw_mainlist";
            TWIR.itemList.init(TWIR.storage.itemList, v), R.on("click", function()
            {
              var e = {
                cmd: function(e)
                {
              ...
              TWIR.itemList.getMainDiv(v).is(":visible") ? TWIR.itemList.close(v) : (TWIR.itemList.open(null, e, v), TWIR.itemList.gui[v].input
              .focus())
            });
            ...
            return V.append($('<span style="width: 90px;display: inline-block;text-align: right;padding-right: 8px;vertical-align: middle;">' + TWIRlang
              .market_watcher.max_buyout + "</span>")).append(I.getMainDiv().css(
            {
              "vertical-align": "middle"
            })), f.append((new west.gui.Groupframe).appendToContentPane($('<div style="height: 244px;"/>').append(s, R, l).append(TWIR.itemList
              .getMainDiv(v).css(
              {
                left: "40px",
                top: "90px",
            ...
            {
              k(t), I.setValue("")
            })).append(V).append(y.getMainDiv())).getMainDiv()), a.append(f, $(
                ...
                !0 === l ? (e.checking = !0, TWIR.storage.get("mw_status") && i.status(s(TWIRlang.market_watcher.progress_page + " " + a)), Ajax
                  ...
                  }, function(l)
                  {
                    if (!l.error)
                      if (!1 === l.error)
                      {
                        for (var A = l.msg.search_result, c = 0; c < A.length; c++)
                        {
                          0;
                          var g = ItemManager.get(A[c].item_id, !0).item_base_id,
                            d = ItemManager.get(A[c].item_id, !0),
                            m = {
                              date: r,
                              ...
                              seller: A[c].seller_player_id
                            };
                          if (2 === A[c].sell_rights)
                            if ("yield" !== d.type || null !== d.set || TWIR.storage.inventory.collectibles.includes(g))
                              ...
                              {
                                var u = e.marketItems.findIndex(function(e)
                                {
                                  return e.offer_id === A[c].market_offer_id
                                });
                                e.marketItems[u].date = r, e.marketItems[u].auction_price = A[c].current_bid ? A[c].current_bid : A[c].auction_price
                              }
                          else e.marketItems.push(m);
                            ...
                            }))
                          {
                            ...
                            e.marketProducts[h].date = r, e.marketProducts[h].auction_price = A[c].current_bid ? A[c].current_bid : A[c].auction_price
                          }
                          else e.marketProducts.push(m);
                          var w = e.getWatched(A[c].item_id),
                            b = {
                              type: d.type,
                              set: d.set,
                              ...
                              seller_town: A[c].seller_town_name,
                              posx: A[c].market_town_x,
                              posy: A[c].market_town_y,
                              offer_id: A[c].market_offer_id,
                              curr_bid: A[c].current_bid,
                              sell_rights: A[c].sell_rights
                            };

                          function I(e)
                          {
                            t[e][d.short] ? t[e][d.short].some(function(e)
                            {
                              return e.offer_id === A[c].market_offer_id
                            }) || t[e][d.short].push(b) : (t[e][d.short] = [], t[e][d.short].some(function(e)
                            {
                              return e.offer_id === A[c].market_offer_id
                            }) || t[e][d.short].push(b))
                          }
                          if (I("auctions"), TWIR.storage.get("mw_collections") && e.missing.includes(d.name) && !1 === e.getBuyed(A[c].item_id) && I(
                              "wtb_missing"), w)
                          {
                            TWIR.storage.popups.marketPrice, TWIR.storage.popups.marketPriceJunk;
                            var f = null != A[c].max_price ? A[c].max_price : null != A[c].curr_bid ? Number(A[c].curr_bid + 10) : Number(A[c]
                              .auction_price + 10);
                            w.auto && 0 != w.auto && !A[c].is_highest_bidder && f <= w.auto && Number(Character.money + Character.deposit) > f ? e
                              .bid(
                              {
                                bid: f,
                                offer_id: A[c].market_offer_id
                              }) : (f < w.item_price || 0 === w.item_price) && (TWIR.storage.get("mw_status") && i.status(s(TWIRlang.market_watcher
                                .progress_found + ": " + d.name)), e.getWatched(A[c].item_id, !0) && (b.spec = "buff"), I("wtb"))
                          }
                        }
                        setTimeout(function()
                        {
                          ...
                          else
                          {
                            if (e.wtb = t.wtb, e.wtb_missing = t.wtb_missing, e.auctions = t.auctions, TWIR.storage.get("mw_trader"))
                              ...
                              {
                                var A = ItemManager.get(r[s].item_id, !0),
                                  c = o.find(function(e)
                                  {
                                    return e.item_id === r[s].item_id
                                  }),
                                  g = new Date(1e3 * r[s].auction_end_date).getTime() - (new Date).getTime();
                                r[s].auction_ends_in = g / 1e3, r[s].posx = Character.position.x, r[s].posy = Character.position.y, e.wtb_missing[
                                    A.short] && 0 === e.wtb_missing[A.short].filter(function(e)
                                  {
                                    return "trader" === e.spec
                                  }).length ? e.wtb_missing[A.short].unshift(r[s]) : e.missing.indexOf(A.name) >= 0 && !e.wtb_missing[A.short] &&
                                  (e.wtb_missing[A.short] = [], e.wtb_missing[A.short].push(r[s])), e.wtb[A.short] && 0 === e.wtb[A.short].filter(
                                    function(e)
                                    {
                                      return "trader" === e.spec
                                    }).length ? e.wtb[A.short].unshift(r[s]) : !e.wtb[A.short] && c && (e.wtb[A.short] = [], e.wtb[A.short].push(
                                    r[s]))
                              }
                            e.marketItems = TWIR.recycleData(e.marketItems), e.marketProducts = TWIR.recycleData(e.marketProducts);
                            var d = e.marketItems,
                              m = e.marketProducts;
                            if (void 0 !== localStorage)
                            {
                              var u = TWIR.minData(d),
                                h = TWIR.minData(m),
                                w = e.wtb,
                                b = e.auctions;
                              TWIR.storage.save("twir_marketData", u), TWIR.storage.save("twir_marketDataJunk", h), TWIR.storage.save(
                                "twir_marketDataTemp", w, !0), TWIR.storage.save("twir_marketDataFullTemp", b, !0);
                              var I = (new Date).getTime();
                              TWIR.marketPrice.init(), TWIR.console("TWIR/: Market Scan completed at " + Chat.Formatter.formatTime((new Date)
                                  .getTime(), !1) + " in " + ((I - n) / 1e3).getTime2EndToken() + " (" + a + " pages).", "green"),
                                sessionStorage && sessionStorage.setItem("twir_timer", (new Date).getTime().toString())
                            }
                            else new UserMessage(TWIRlang.informative.storage_error + "!", UserMessage.TYPE_ERROR).show();
                            e.showMarketAlert(), e.checking = !1, TWIR.storage.get("mw_status") && i.hide(), e.checkCollectible(), TWIR
                            .checkShop(), e.rescan(!0)
                          }
                        }, Math.floor(TWIR.npcLoaded ? 2001 * Math.random() + 2e3 : 2001 * Math.random() + 3e3))
                      }
              ...
              if (i = this.filterBySettings(i, t), Object.keys(i).length)
              {
                ...
                for (var s = r, l = 0; l < s.length; l++)
                {
                  ...
                  if (!p[0].spec || "buff" != p[0].spec || "buffs" === e)
                  {
                    ...
                    if (p.length > 1)
                    {
                      for (var c = p.length <= 11 ? p.length : 11, g = 1; g < c; g++)
                      {
                        var d = null !== p[g].max_price ? TWIRlang.market_watcher.price : TWIRlang.market_watcher.bid,
                          m = null !== p[g].max_price ? parseInt(p[g].max_price / p[g].item_count) : null !== p[g].curr_bid ? parseInt(p[g].curr_bid / p[
                            g].item_count) : parseInt(p[g].auction_price / p[g].item_count);
                        A += "<tr><td>[" + g + "]</td>", A += "<td>@" + p[g].seller_name.cutIt(14) + "</td>", A += "<td>(x" + p[g].item_count +
                          "),&nbsp;</td>", A += "<td>" + d + ":</td>", A += "<td>$" + TWIR.replSum(m, !0) + (p[g].item_count > 1 ? "&nbsp;(" + TWIRlang
                            .tooltips.each + ")" : "") + ",&nbsp;</td>", A += "<td>" + TWIRlang.market_watcher.time_left + ":</td>", A += "<td>" + TWIR
                          .msToTime(p[g].auction_ends_in) + "</td></tr>"
                      }
                      A += "</table>", p.length >= 11 && (A += '<div style="text-align: center;">...</div>')
                    }
                    var u = ItemManager.get(p[0].item_id, !0),
                      ...
                      I = p[0].curr_bid && null !== p[0].curr_bid ? p[0].curr_bid / p[0].item_count : null,
                      f = TWIR.storage.popups.marketPrice,
                      k = p[0].spec && "trader" == p[0].spec ? "blue" : f[u.short] && b <= f[u.short].weight && f[u.short].offer_count > 2 ? "#070" : f[u
                        .short] && f[u.short].offer_max.price <= b && f[u.short].offer_count > 2 && p[0].seller_name != TWIR.author ? "#900" : "unset",
                      y = Map.calcWayTime(TWIR.lastPos(),
                      {
                        x: p[0].posx,
                        y: p[0].posy
                      }),
                      x = "<div>@" + p[0].seller_name + (p[0].market_town ? "&nbsp;(" + p[0].market_town + ")" : "") + "</div><div>" + TWIRlang
                      .informative.distance + ":&nbsp;" + y.formatDuration() + "</div>",
                      R = l !== s.length - 1 || 9 === l ? "1px solid rgba(140,92,20,0.65)" : "none",
                      v = "trader" !== p[0].spec ? "javascript:void(PlayerProfileWindow.open(" + p[0].seller_id + "))" :
                      ...
                      v + '" title="' + x.escapeHTML() + '">@' + p[0].seller_name.cutIt(14) + '</a>&nbsp;<span title="' + A.escapeHTML() + '">' + TWIRlang
                      ...
                      B = "browse" !== e && a.length != n.length && p.filter(function(e)
                      {
                        return a.includes(e.offer_id)
                      }).length ? '<img src="' + TWIR.images.new_sign + '" style="position:absolute;top: -5px;left: -10px;width: 28px;"/>' : "";
                    o +=
                      ...
                      p[0].item_id + '" style="cursor: pointer;" title="' + new ItemPopup(u).getXHTML().escapeHTML() + '" src="' + u.image +
                      '"; height="29"; width="29"></img>' + W + B + "</div></td>", o +=
                      '<td style="padding: 2px;vertical-align: middle;"><div style="margin-bottom: -2px; cursor: pointer;"><span title="' + u.name +
                      '" data-item-id="' + p[0].item_id +
                      '" style="width: 190px;text-overflow: ellipsis;white-space: nowrap;overflow: hidden;display: inline-block; color: ' + k + ';">' + u
                      ...
                      .market_watcher.curr_bid + '</div><div style="margin-top: 4px;">' + ("trader" != p[0].spec && null !== I ? TWIR.replSum(I) :
          ...
          showMarketAlert: function()
          {
            ...
            if (delete this.OnGoing, !$.isEmptyObject(t) || !$.isEmptyObject(a) || !$.isEmptyObject(r))
            {
              ...
              var A = new RegExp("^.*" + TWIRlang.market_watcher.add_name + ":(.*)$", "i"),
                c = 0 != Character.homeTown.town_id ? Chat.Resource.Manager.getRoom("room_town_" + Character.homeTown.town_id) : Chat.Resource.Manager
                .getGeneralRoom();
              if (!$.isEmptyObject(t) && c && e.newOffers().length && TWIR.storage.get("mw_wtb_chat_alert") && -1 === c.history.findIndex(function(e)
                {
                  return A.test(e)
                }))
              {
                ...
                for (var u in m) m[u].addMessage(d)
              }
        ...
        stats:
        {
          ...
          statsQuantities: function()
          {
            ...
            for (var p in t)
            {
              if (t[p]) var A = t[p].obj;
              switch ("yield" !== A.type && null !== A.set && (l("set_count", 1), l("set_total", t[p].count)), "yield" !== A.type && "recipe" !== A
                .type && (!e.count_max.obj_max || t[p].count > e.count_max.obj_max.count) && (e.count_max.obj_max = {
                  item_id: A.item_base_id,
                  count: t[p].count
                }), A.type)
              {
                case "belt":
                ...
                case "animal":
                case "left_arm":
                  l("obj_count", 1), l("obj_total", t[p].count), l(A.type + "_count", 1), l(A.type + "_total", t[p].count);
                  break;
                case "right_arm":
                  l("obj_count", 1), l("obj_total", t[p].count), A.sub_type && (l(A.sub_type + "_count", 1), l(A.sub_type + "_total", t[p].count));
                  break;
                case "yield":
                  ...
                  break;
                case "recipe":
                  l(A.type + "_count", 1), l(A.type + "_total", t[p].count)
              }
            }
            for (var c = 0; c < i.length; c++) l("use_count", 1), l("use_total", i[c].count);
            ...
            for (var m = 0; m < r.length; m++) l("bonus_count", 1), l("bonus_total", r[m].count);
            for (var u = 0; u < o.length; u++) l("work_count", 1), l("work_total", o[u].count);
          ...
          statsSalesValue: function()
          {
            ...
            for (var p in t)
              ...
              {
                var A = t[p].obj,
                  c = $.isNumeric(A.price) ? A.price * t[p].count : 0,
                  g = $.isNumeric(A.sell_price) ? A.sell_price * t[p].count : 0;
                switch (l[A.short] && a("market_price", l[A.short].weight * t[p].count), A.type)
                {
                  case "yield":
                    a("average_prod_buy_price", c), a("average_prod_sell_price", g), a("products_buy_price", c), a("products_sell_price", g);
                    break;
                  case "recipe":
                    a(A.type + "_buy_price", c), a(A.type + "_sell_price", g);
                    break;
                  case "belt":
                  case "body":
                  case "foot":
                  ...
                  case "right_arm":
                  case "left_arm":
                    a("average_obj_buy_price", c), a("average_obj_sell_price", g), a("objects_buy_price", c), a("objects_sell_price", g)
                }
                "yield" !== A.type && t[p].count > 1 && (a("duplicates_buy_price", c), a("duplicates_sell_price", g)), "yield" !== A.type && !0 === A
                  .dropable && (a("droppable_buy_price", c), a("droppable_sell_price", g))
              ...
              .menulink.walk + "</span>").addListener(function(e)
            {
              switch (e[0])
              {
                ...
                case 1:
                  ...
                  MarketWindow.open(e[1].id), MarketWindow.showTab(i.length ? "sell" : "offer");
                  break;
                case 4:
                  fetch = function(e)
                  {
          ...
          createItemsPoints4Worldmap: function(e, t)
          {
            ...
            for (var a in e)
            {
              ...
              var l = Object.values(n.items),
                ...
                c = A[~~(A.length * Math.random())] || [],
                g = ItemManager.get(c ? c.id : 0, !0),
                d = {};
              if (d = this.calcCoord4Worldmap([n.posx, n.posy]))
              {
                ...
                i.push($('<img onclick="' + u + '" title="' + r + '" src="' + m + '" style="cursor: pointer; position: absolute;width:' + (p.length === l
                    .length ? "16px" : "22px") +
            ...
            if (!1 === $.isEmptyObject(i))
            {
                  ...
                  TWIRlang.menulink.market_map + "</span>", TWIRlang.menulink.market_map).addEmpty(), a)
              {
                var o = a[r],
                  ...
                  l = 0,
                  p = 0;
                for (var A in s += "<div class=&quot;popup_yield&quot; style=&quot;display: block;max-width: 396px;&quot;>", o.items)
                {
                  "offer_sold" === o.items[A].type ? p += o.items[A].money : "offer_sold" !== o.items[A].type && (l += o.items[A].count), Object.keys(o
                    .items).length;
                  var c = ItemManager.get(A, !0);
                  s +=
                    "<div class=&quot;popup_yield_image&quot; style=&quot;margin-right: 1px;margin-bottom: 1px;display: inline-block;&quot;><div class=&quot;item&quot;><span class=&quot;count&quot; style=&quot;display:block;top:30px;left:1px&quot;>" +
                    TWIR.replSum(o.items[A].count) + "</span><img src=&quot;" + c.image + "&quot; alt=&quot;" + c.name +
                    "&quot; width=&quot;43&quot; height=&quot;43&quot; /></div>", "offer_sold" === o.items[A].type && (s +=
                      "<span style=&quot;font-size: 11px;text-align: center;display: block;&quot;>$" + TWIR.replSum(o.items[A].money) + "</span>"), s +=
                    "</div>"
                }
              ...
              for (var g = 0, d = 0; d < t.items.length; d++)
              {
                var m = t.items[d].node.text(),
                  u = 10 * m.length;
                u > g && (t.setWidth(u <= 300 && u >= 240 ? u : u <= 240 ? 240 : 300), g = u)
              }
          ...
          try
          {
            ...
            if (Object.keys(TWIR.storage.towns).length > 0)
            {
              ...
              t.addItem(["nearest"],
                ...
                '<img src="/images/map/minimap/icons/miniicon_foreign_towns.png?2" style="left: 5px;top: 8px;"/><span style="margin-left: 15px;color: #5e321a; text-overflow: ellipsis;white-space: nowrap;overflow: hidden;word-wrap: break-word; margin-top: 2px; max-width: 200px;display: inline-block;">' +
                TWIRlang.menulink.nearest_five + "</span>", TWIRlang.menulink.nearest_five).addEmpty()
            }
            ...
            {
              var A = t.items[p].node.text(),
                c = 7.5 * A.length + 60;
              c > l && (t.setWidth(c <= 300 ? c : 300), l = c)
            }
            return t.addListener(function(e)
            {
              var t = e[0],
              ...
              function o(e)
              {
                ...
                }, function(s)
                {
                  ...
                  return s.hotel_level >= e && A <= 3600 ? TaskQueue.add(new TaskSleep(a[t].town_id, i[s.hotel_level - 1])) : A > 3600 ?
              ...
              for (var n in Object.keys(TWIR.storage.NPC).sort(function(e, t)
                ...
                for (var r = i[n], o = 0; o < r.length; o++)
                {
                  var s = r[o],
                    ...
                    A = '<div style="max-width:250px"><span class="teaser_headline"></span>';
                  A += '<div class="teaser_content">', 0 != l.p4 && (A +=
                    ...
                    l.p1f + "x</span></span>"), A += "</div></div>", (TWIR.npcLoaded && null == r[o].quests || 0 == l.tot) && (A = "");
                  var c = TWIR.npcLoaded && null != r[o].quests && 0 != l.tot ? '<span title="' + A.escapeHTML() +
                  ...
                  t.addItem(0, '<img src="/images/quest/employer/' + r[o].key +
                    ...
                    (TWIR.npcLoaded && null != r[o].quests && 0 != l.tot ? "150px" : "250px") + ';display: inline-block;">' + n + "</span>" + c, (
        ...
        Inventory:
        {
                  ...
                  .clearCustom(), "twir" !== e && ($("#bag", Inventory.DOM).empty(), self.data.lastItems = []), e)
                {
                  case "new":
                    Inventory.showLastItems(), void 0 !== Inventory.guiElements.scrollPane && Inventory.guiElements.scrollPane.verticalBar.move(0, !1, !
                      0), TWIR.repTitle("TWIR - " + TWIRlang.invent, "TWIR");
                    break;
                  case "twir":
                    self.showItems(), TWIR.repTitle(self.data.title[0], self.data.title[1]);
                    break;
                  case "bonus":
                  case "work":
                  case "quest":
                    self.showItems(Bag.getItemsByItemIds(TWIR.storage.inventory[e])), TWIR.repTitle(self.data.title[0], self.data.title[1]);
                    break;
                  case "sets":
                    Inventory.showCustom(), TWIR.repTitle(self.data.title[0], self.data.title[1]);
                    break;
                  case "set":
          ...
          showSearch: function()
          {
            ...
            try
            {
              ...
              for (var t = 0; t < kbItems.length; t++) l.addItem(kbItems[t][0], kbItems[t][1]);
              ...
              var p = (new west.gui.Combobox).setWidth(45);
              bItems = this.getBonusKeywords(), p.addItem(1, "&#8226;&#8226;&#8226;");
              for (var A = 0; A < bItems.length; A++) p.addItem(bItems[A][0], bItems[A][1]);
              p.select(1), p.addListener(function(e)
              {
                if (1 !== e)
                {
                  switch (e)
                  ...
                  $("#inventory_search").val() !== e && ($("#inventory_search").val(e), Inventory.search()), p.select(1)
                }
              });
              var c = $("<tr/>");
              ...
              })).appendTo(c), $("<td/>").append(l.getMainDiv().css(
              {
                "margin-left": "20px"
              })).appendTo(c), $("<td/>").append(p.getMainDiv().css(
              {
                "margin-left": "20px"
              })).appendTo(c), $('<table style="margin-bottom: 5px;margin-left: auto;margin-right: auto;"/>').append(r, c).appendTo(n);
              var g = $("<tr/>"),
                d = new west.gui.Checkbox(TWIRlang.organizing.invert, ""),
                m = new west.gui.Combobox;
              m.addItem("none", TWIRlang.informative.any);
              for (var u = this.getFiltBox(), h = 0; h < u.length; h++) m.addItem(u[h].filter, u[h].name);
              ...
              }), d.setCallback(function()
              {
                ...
                e.data.filter[1] = d.isSelected(), "" === t && $("#inventory_search").val("allitems"), Inventory.search()
              }), d.setSelected(e.data.filter[1], !0);
              var w = (new west.gui.Combobox).setWidth(90);
              w.addItem("none", TWIRlang.informative.any);
              for (var b = this.getSearchTypes(), I = 0; I < b.length; I++) w.addItem(b[I].type, b[I].name);
              w.select(e.data.searchType), w.addListener(function(t)
              {
                var i = $("#inventory_search").val();
              ...
              }), $("<td/>").append(m.getMainDiv().css(
              {
                "margin-right": "10px",
                "margin-left": "20px"
              })).appendTo(g), $("<td/>").append(d.getMainDiv().css(
              {
                "margin-right": "25px"
              })).appendTo(g), $("<td/>").append(w.getMainDiv().css(
              {
                "margin-right": "10px"
              })).appendTo(g), $('<table style="margin-bottom: 10px;margin-left: auto;margin-right: auto;"/>').append(o, g).appendTo(n), n.append(
                "<hr>");
              var f = $('<div style="margin-top: 15px; display: none;"/>'),
                k = $("<div/>"),
                y = $('<span style="cursor: pointer;">' + TWIRlang.organizing.sort_by + ":&nbsp;</span>"),
                x = $('<img src="' + TWIR.images.arrow + '" width="13" style="margin-left: 2px;"/>');
              y.append(x), k.append(y.on("click", function()
              {
                f.toggle(), $(x).toggleClass("twir_flip")
              })), n.append(k);
              ...
              for (var v = new west.gui.Combobox, T = this.getSortBox(), V = 0; V < T.length; V++) v.addItem(T[V].sort, T[V].name);
              v.select(e.data.order[0]);
              var W = (new west.gui.Combobox).setWidth(90);
              W.addItem("asc", TWIRlang.organizing.sort_up), W.addItem("desc", TWIRlang.organizing.sort_down), W.select(e.data.order[1]), R.setCallback(
                ...
                {
                  "margin-right": "10px"
                })), n.append(f), this.gui.searchDialog = new west.gui.Dialog("", n).setDraggable(!0).setBlockGame(!1).setPosition(i, a).setId("twir_as")
                .show(), this.gui.searchDialog.setTitle('<span style="margin-top: 4px; font-size: 16pt;">' + TWIRlang.inventory.search +
                  ...
                  ), this.gui.searchDialog.getMainDiv().find(".tw2gui_inner_window_title").append($('<div title="' + TWIRlang.informative.hide +
                  '" class="tw2gui_window_buttons_close" style="position: absolute;right: 6px;top: 8px;"></div>').click(function()
                {
                  TWIR.storage.get("inv_searchwindow_remember_search") || e.as_reset(), e.gui.searchDialog.hide()
                })), s.focus()
            }
            catch (e)
            {
          ...
          order: function(e)
          {
            ...
            try
            {
              e.sort(function(e, i)
              {
                var a = t.data.order[0],
                  n = "asc" === t.data.order[1],
                  r = "desc" === t.data.order[1];
                switch (a)
                {
                  case "sort_id":
                    if (!0 === n) return e.obj.item_id - i.obj.item_id;
                    if (!0 === r) return i.obj.item_id - e.obj.item_id;
                    break;
                  case "sort_ab":
                    if (!0 === n) return e.obj.name.localeCompare(i.obj.name);
                    if (!0 === r) return i.obj.name.localeCompare(e.obj.name);
                    break;
                  case "sort_buyprice":
                    if (!0 === n) return e.obj.price - i.obj.price;
                    if (!0 === r) return i.obj.price - e.obj.price;
                    break;
                  case "sort_sellprice":
                    if (!0 === n) return e.obj.sell_price - i.obj.sell_price;
                    if (!0 === r) return i.obj.sell_price - e.obj.sell_price;
                    break;
                  case "sort_reqlvl":
                    if (!0 === n) return e.obj.level - i.obj.level;
                    if (!0 === r) return i.obj.level - e.obj.level;
                    break;
                  case "sort_upglvl":
                    if (!0 === n) return e.obj.item_level - i.obj.item_level;
                    if (!0 === r) return i.obj.item_level - e.obj.item_level;
                    break;
                  case "sort_mindamage":
                    if (e.obj.damage === i.obj.damage) return 0;
                    if (null === e.obj.damage) return 1;
                    if (null === i.obj.damage) return -1;
                    if (n) return e.obj.getDamage(Character).min - i.obj.getDamage(Character).min;
                    if (r) return i.obj.getDamage(Character).min - e.obj.getDamage(Character).min;
                    break;
                  case "sort_maxdamage":
                    if (e.obj.damage === i.obj.damage) return 0;
                    if (null === e.obj.damage) return 1;
                    if (null === i.obj.damage) return -1;
                    if (n) return e.obj.getDamage(Character).max - i.obj.getDamage(Character).max;
                    if (r) return i.obj.getDamage(Character).max - e.obj.getDamage(Character).max;
                    break;
                  case "sort_quantity":
                    if (!0 === n) return e.count - i.count;
                    if (!0 === r) return i.count - e.count;
                    break;
                  case "sort_setname":
                    if (e.obj.set === i.obj.set) return 0;
                    if (null === e.obj.set) return 1;
                    if (null === i.obj.set) return -1;
                    var o = west.storage.ItemSetManager.get(e.obj.set).name,
                      s = west.storage.ItemSetManager.get(i.obj.set).name;
                    if (n) return o.localeCompare(s);
                    if (r) return s.localeCompare(o);
                    break;
                  case "sort_marketprice":
                    var l = TWIR.storage.popups.marketPrice[e.obj.short] ? TWIR.storage.popups.marketPrice[e.obj.short].weight : 0,
                      p = TWIR.storage.popups.marketPrice[i.obj.short] ? TWIR.storage.popups.marketPrice[i.obj.short].weight : 0;
                    if (0 < l && 0 < p && l === p) return 0;
                    if (0 === l) return 1;
                    if (0 === p) return -1;
                    if (n) return l - p;
                    if (r) return p - l;
                    break;
                  case "sort_ups":
                    var l = TWIR.storage.popups.shop_prices[e.obj.short] ? TWIR.storage.popups.shop_prices[e.obj.short].price_nuggets : TWIR.storage
                      .popups.shop_limited_prices[e.obj.short] ? TWIR.storage.popups.shop_limited_prices[e.obj.short].price_nuggets : 0,
                      p = TWIR.storage.popups.shop_prices[i.obj.short] ? TWIR.storage.popups.shop_prices[i.obj.short].price_nuggets : TWIR.storage
                      .popups.shop_limited_prices[i.obj.short] ? TWIR.storage.popups.shop_limited_prices[i.obj.short].price_nuggets : 0,
                      A = TWIR.storage.popups.shop_prices[e.obj.short] ? TWIR.storage.popups.shop_prices[e.obj.short].price_veteran : TWIR.storage
                      .popups.shop_limited_prices[e.obj.short] ? TWIR.storage.popups.shop_limited_prices[e.obj.short].price_veteran : 0,
                      c = TWIR.storage.popups.shop_prices[i.obj.short] ? TWIR.storage.popups.shop_prices[i.obj.short].price_veteran : TWIR.storage
                      .popups.shop_limited_prices[i.obj.short] ? TWIR.storage.popups.shop_limited_prices[i.obj.short].price_veteran : 0,
                      g = TWIR.storage.popups.shop_prices[e.obj.short] ? TWIR.storage.popups.shop_prices[e.obj.short].price_dollar : TWIR.storage
                      .popups.shop_limited_prices[e.obj.short] ? TWIR.storage.popups.shop_limited_prices[e.obj.short].price_dollar : 0,
                      d = TWIR.storage.popups.shop_prices[i.obj.short] ? TWIR.storage.popups.shop_prices[i.obj.short].price_dollar : TWIR.storage
                      .popups.shop_limited_prices[i.obj.short] ? TWIR.storage.popups.shop_limited_prices[i.obj.short].price_dollar : 0;
                    if (!(l || A || g)) return 1;
                    if (!(p || c || d)) return -1;
                    if (n) return l - p || c - A || d - g;
                    if (r) return p - l || A - c || g - d;
                    break;
                  default:
                    if (!0 === n) return e.obj.item_id - i.obj.item_id;
                    if (!0 === r) return i.obj.item_id - e.obj.item_id
                ...
                .css("cssText", "position: absolute !important;right: 5px; display: inline-block;"), $(e.gui.setShowButton).on("click", function(t)
                {
                  ...
                  else
                  {
                    var i = function()
                      ...
                      a = $(this).offset().left;
                    a -= a / 100 * 20;
                    var n = $(this).offset().top + $(this).height() + 5;
                    e.makeSetsSelect(i, a, n)
                  }
                })
            }
            catch (e)
          ...
          updateSetsHtml: function(e)
          {
            try
            {
              ...
              {
                var A = $('<img src="/images/items/unknown.png" style="width: 45px;height: auto;position: absolute;left: 3px;top: 3px;"/>');
                o.append(A)
              }
              ...
              if (3 == g.length)
              {
                var d = $('<img src="' + g[0] + '" style="width: 40px; height: auto;position: absolute;left: -5px; top: 5px;"/>'),
                  m = $('<img src="' + g[1] + '" style="width: 30px;height: auto;position: absolute;right: -3px;top: -2px;"/>'),
                  u = $('<img src="' + g[2] + '" style="width: 30px;height: auto;position: absolute;right: -3px;bottom: -2px;"/>');
                c.append(d, m, u)
              }
              else
              {
              ...
              if (2 == b.length)
              {
                var I = $('<img src="' + b[0] + '" style="width: 40px; height: auto;position: absolute;left: -5px; top: 2px;"/>'),
                  f = $('<img src="' + b[1] + '" style="width: 40px; height: auto;position: absolute;right: -5px; bottom: 0px;"/>');
                w.append(I, f)
              }
              else if (1 == b.length)
              {
              ...
              {
                var y = $('<img src="/images/items/unknown.png" style="width: 45px;height: auto;position: absolute;left: 3px;top: 3px;"/>');
                w.append(y)
              }
              var x = $("#twir_sets_other");
              x.empty();
              var R = this.getSetsImages(t, "other");
              if (3 == R.length)
              {
                var v = $('<img src="' + R[0] + '" style="width: 40px; height: auto;position: absolute;left: -5px; top: 5px;"/>'),
                  T = $('<img src="' + R[1] + '" style="width: 30px;height: auto;position: absolute;right: -3px;top: -2px;"/>'),
                  V = $('<img src="' + R[2] + '" style="width: 30px;height: auto;position: absolute;right: -3px;bottom: -2px;"/>');
                x.append(v, T, V)
              }
              else if (1 == R.length)
              {
                var W = $('<img src="' + R[0] + '" style="width: 40px;height: auto;position: absolute;left: 5px;top: 5px;"/>');
                x.append(W)
              }
              else
              {
            ...
            try
            {
              ...
              switch (t)
              {
                ...
                case "ride":
                  ...
                  A && i.push(A.image), c && i.push(c.image);
                  break;
                case "clothes":
                  ...
                  g && i.push(g.image), d && i.push(d.image), m && i.push(m.image);
                  break;
                case "other":
                  var g = r.find(function(e)
                    {
                  ...
                  b && n.length < 6 ? i.push(b.image) : (g && i.push(g.image), d && i.push(d.image), !d && w && i.push(w.image), w && "set_sleeper" === w
                    .set ? i.push(w.image) : u ? i.push(u.image) : b ? i.push(b.image) : h ? i.push(h.image) : m && i.push(m.image))
              }
              return i
            }
            catch (e)
          ...
          makeSetsSelect: function(e, t, i)
          {
            ...
            try
            {
              ...
              var A = $('<span id="twir_sets_other" title="' + TWIRlang.inventory.other_sets +
                '" style="border: 2px solid #6B5A3F;border-radius: 8px;height: 50px;width: 50px;display: inline-block; margin: 5px; cursor: pointer; position: relative;"/>'
                );
              A.click(function(t)
              {
              ...
              c.getField().on("input paste", TWIR.delay(function(e)
              {
                g()
              }, 500));
              var d = (new west.gui.Combobox).setWidth(45);
              bItems = this.getBonusKeywords(), d.addItem(1, "&#8226;&#8226;&#8226;");
              for (var m = 0; m < bItems.length; m++) d.addItem(bItems[m][0], bItems[m][1]);
              ...
              {
                c.setValue(""), a.data.searchVal = null, a.updateSetsHtml(e)
              })).appendTo(u), $("<td/>").append(d.getMainDiv().css(
              {
                "margin-left": "20px"
              })).appendTo(u), $('<table style="margin-bottom: 5px;margin-left: auto;margin-right: auto;"/>').append(r, u).appendTo(n);
              var h = $('<div style="margin-top: 10px;"/>'),
                w = new west.gui.Combobox;
              w.addItem("all", TWIRlang.informative.any);
              var b = [];
              for (var I in TWIRlang.keyWords)
              {
                var f = Array.isArray(TWIRlang.keyWords[I]) ? TWIRlang.keyWords[I][0] : TWIRlang.keyWords[I],
                  k = "independance" === I ? "independence" : I;
                b.push(
                {
                  name: f,
                  key: k
              ...
              for (var y = 0; y < b.length; y++)
              {
                var x = '<span style="vertical-align: middle;display: inline-block;margin-bottom: 2px;margin-right: 2px;"><img src="' + TWIR.images
                  .gameEvents[b[y].key] + '" height="16" width="auto"/></span>';
                w.addItem(b[y].key, x + b[y].name)
              }
              w.addItem("none", TWIRlang.informative.none), w.addListener(function(t)
                ...
                {
                  "margin-right": "10px"
                })), n.append(h), this.gui.setsDialog = new west.gui.Dialog(TWIRlang.inventory.sets, n).setDraggable(!0).setId("twir_sm").setBlockGame(!1)
                .setPosition(t, i).show(), $(".tw2gui_inner_window_title", this.gui.setsDialog.getMainDiv()).find(".textart_title").css(
                {
                  "margin-top": "4px",
                  "font-size": "16pt"
                }), a.gui.setsDialog.getMainDiv().find(".tw2gui_inner_window_title").append($('<div title="' + TWIRlang.informative.hide +
                  '" class="tw2gui_window_buttons_close" style="position: absolute;right: 6px;top: 8px;"></div>').click(function()
                {
                  TWIR.storage.get("inv_setwindow_remember_search") || a.ss_reset(), a.gui.setsDialog.hide()
                })), c.focus(), this.updateSetsHtml(e)
            }
            catch (e)
            {
              TWIR.bugHunt(e)
          ...
          itemShowcase: function(e, t, i)
          {
            function a(a)
            {
              ...
              {
                if (e && e.length)
                  for (var d in Wear.wear) e.includes(t ? Wear.wear[d].getId() : Wear.wear[d].getItemBaseId()) && A.push(Wear.wear[d]);
                for (var m = 0; m < p.length; m++)
                {
                  var u = p[m].obj;
                  u.type === a && (!n || u.item_level > n.obj.item_level) && (n = p[m])
                }
                for (var h = 0; h < A.length; h++)
                {
                  var u = A[h].obj;
                  u.type === a && (!r || u.item_level > r.obj.item_level) && (r = A[h])
                }
          ...
          fullBonusTooltip: function(e, t, i)
          {
            if (e)
            {
              for (var a = TWIR_calc.preset.skills, n = '<div style="text-align: center;">', r = 0; r < CharacterSkills.allAttrKeys.length; r++)
              {
                ...
                o in e.attribute && ((!i || "object" == typeof a && o in a) && (n += m("group5", o, e.attribute[o])))
              }
              for (var s = 0; s < CharacterSkills.allSkillKeys.length; s++)
              {
                var l = CharacterSkills.allSkillKeys[s];
                l in e.skill && ((!i || "object" == typeof a && l in a) && (n += m("group4", l, e.skill[l])))
              }
              for (var p in e.income)(!i || "object" == typeof a && p in a) && (n += m("group3", p, e.income[p]));
              for (var A in e.job)
                if (!i || "object" == typeof a && A in a)
                {
                  var c = JobsModel.getById(Number(A));
                  c && "job" !== A ? n += m(void 0, A, e.job[A]) : "job" === A && (n += m("group3", "job", e.job.job))
                } for (var g in e.fortbattle) i && "object" == typeof a || (n += m("group1", g, e.fortbattle[g]));
              for (var d in e.other) "ms" !== d && (!i || "object" == typeof a && d in a) && (n += m("group2", "speed" !== d ? d : "ms", e.other[d]));
              return i && "ms" === a && (n += m("group2", "ms", Math.round(TWIR_calc.calcByFormula(
              {
                speed: e.other.speed || 0,
                ms: e.other.ms || 0,
                ride: u("ride")
              }, "ms")))), i && "construct" === a && (n += m("group2", "construct", TWIR_calc.calcByFormula(
              {
                build: u("build"),
                repair: u("repair"),
            ...
            Bag.search = function(t)
            {
              if (Bag.loaded)
              {
                ...
                return west.common.forEach(a, function(a, o)
                {
                  var l = a.obj,
                    p = l.bonus.item,
                    A = "none" === e.data.searchType || e.data.searchType === l.type;
                  if (!r.length && A) switch (t.toLowerCase())
                  {
                    case "allitems":
                      l.active && n.push(a);
                      break;
                    ...
                    case "xp":
                    case "experience":
                      for (var c = 0; c < p.length; c++)(p[c].type && "experience" === p[c].type || s(p[c].bonus) && "experience" === p[c].bonus
                        .type) && n.push(a);
                      break;
                    case "dollar":
                      for (var c = 0; c < p.length; c++)(p[c].type && "dollar" === p[c].type || s(p[c].bonus) && "dollar" === p[c].bonus.type) &&
                        n.push(a);
                      break;
                    case "drop":
                      for (var c = 0; c < p.length; c++)(p[c].type && "drop" === p[c].type || s(p[c].bonus) && "drop" === p[c].bonus.type) && n
                        .push(a);
                      break;
                    case "luck":
                      for (var c = 0; c < p.length; c++)(p[c].type && "luck" === p[c].type || s(p[c].bonus) && "luck" === p[c].bonus.type) && n
                        .push(a);
                      break;
                    case "job":
                    case "lp":
                    case "pb":
                      for (var c = 0; c < p.length; c++)(p[c].type && "job" === p[c].type && "all" === p[c].job || s(p[c].bonus) && "job" === p[c]
                        .bonus.type && "all" === p[c].bonus.job) && n.push(a);
                      break;
                    case "resistance":
                      for (var c = 0; c < p.length; c++)(p[c].type && "fortbattle" === p[c].type && "resistance" === p[c].name || s(p[c].bonus) &&
                        "fortbattle" === p[c].bonus.type && "resistance" === p[c].bonus.name) && n.push(a);
                      break;
                    case "damage":
                    case "dmg":
                      for (var c = 0; c < p.length; c++)(p[c].type && "fortbattle" === p[c].type && "damage" === p[c].name || s(p[c].bonus) &&
                        "fortbattle" === p[c].bonus.type && "damage" === p[c].bonus.name) && n.push(a);
                      break;
                    case "defense":
                    case "def":
                      for (var c = 0; c < p.length; c++)(p[c].type && "fortbattle" === p[c].type && "defense" === p[c].name || s(p[c].bonus) &&
                        "fortbattle" === p[c].bonus.type && "defense" === p[c].bonus.name) && n.push(a);
                      break;
                    case "offense":
                    case "off":
                      for (var c = 0; c < p.length; c++)(p[c].type && "fortbattle" === p[c].type && "offense" === p[c].name || s(p[c].bonus) &&
                        "fortbattle" === p[c].bonus.type && "offense" === p[c].bonus.name) && n.push(a);
                      break;
                    case "speed":
                    case "ms":
                      for (var c = 0; c < p.length; c++)(p[c].type && "speed" === p[c].type || s(p[c].bonus) && "speed" === p[c].bonus.type) && n
                        .push(a);
                      break;
                    case "regen":
                      for (var c = 0; c < p.length; c++)(p[c].type && "regen" === p[c].type || s(p[c].bonus) && "regen" === p[c].bonus.type) && n
                        .push(a);
                      break;
                    case "pray":
                      for (var c = 0; c < p.length; c++)(p[c].type && "pray" === p[c].type || s(p[c].bonus) && "pray" === p[c].bonus.type) && n
                        .push(a);
                      break;
                    default:
                      i.test(l.item_id) || i.test(l.name) || null !== l.set && i.test(west.storage.ItemSetManager.get(l.set).name) || Bag
                        ...
                        n.push(a) : (TWIR.storage.setList.eventIcons[l.set] && TWIR.storage.setList.eventIcons[l.set][1] === t || TWIR.storage
                          ...
                          .eventIcons[l.set][1] === t.toLowerCase()) && A && n.push(a)
                  }
        ...
        comboCalc:
        {
          ...
          showCase: function(e, t)
          {
            function i(i)
            {
              ...
              {
                var A = o[p].obj;
                A.type === i && (!a || A.item_level > a.obj.item_level) && (a = o[p])
              }
              for (var c = 0; c < s.length; c++)
              {
                var A = s[c].obj;
                A.type === i && (!n || A.item_level > n.obj.item_level) && (n = s[c])
              }
              var g = "";
          ...
          appendRes: function(e, t)
          {
            ...
            var l, p, A, c = $('<span style="position: absolute;left: 5px;top: 8px;">' + TWIRlang.calc.equipment_number.replace("$1", "#" + (a + 1)) +
            ...
            n.cont = $((l = r, p = a, A = $('<div id="twir_bw_' + p +
              '" style="display: inline-block;width: 490px;height: 50px; margin-bottom: 4px;padding-left: 2px;"></div>'), A.append(i.showCase(l, !
              0)), A)).data("id", a), n.items = r, i.gui.resultHtml.push(n), i.gui.resultContent.getContentPane().append($(n.line).append(c, g), n.cont)
          },
          ...
          load_bw0: function(e, t)
          {
            ...
            for (var c in CharacterSkills.skillKeys4Attr)
            {
              A(c);
              for (var g = CharacterSkills.skillKeys4Attr[c], d = 0; d < g.length; d++) A(g[d])
            }
            a.append(r, p);
            var m = this.gui.bw0_Dialog = new west.gui.Dialog("", a).setPosition(e, t).show();
