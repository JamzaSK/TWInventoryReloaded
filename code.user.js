  ...
  script.setAttribute("type", "application/javascript"), script.textContent = "(" + function()
  {
    isDefined(window.TWIR) ? new west.gui.Dialog(TWIR.name, '<div class="txcenter"><b><br>The UserScript ' + TWIR.name + " is installed twice. You will have to uninstall older version for the script to work properly!</br></b></div>", west.gui.Dialog.SYS_WARNING).addButton("OK").show() : (TWIRlang = {}, TWIR = {
      ...
      initLang: function()
      {
        ...
        TWIR.lang = e[localStorage.getItem("scriptsLang")] ? localStorage.getItem("scriptsLang") : e[Game.locale.substr(0, 2)] ? Game.locale.substr(0, 2) : "en",
          ...
          }), $.getScript(TWIR.calcUrl)).done(function()
          {
            ...
            i.mouseenter(function()
              ...
              }), $("div#ui_menubar").find("#TWIR").length || $("div#ui_menubar").append($('<div class="ui_menucontainer" id="TWIR" />').append(i).append('<div class="menucontainer_bottom" />')),
              TWIR.beCompatible(),
      ...
      storage:
      {
        ...
        save: function(e, t, i)
        {
          ...
          {
            "undefined" != typeof InstallTrigger ? i ? sessionStorage.setItem(e, TWIR.LZ.compressToUTF16(JSON.stringify(t))) : localStorage.setItem(e, TWIR.LZ.compressToUTF16(JSON.stringify(t))) : i ? sessionStorage.setItem(e, TWIR.LZ.compress(JSON.stringify(t))) : localStorage.setItem(e, TWIR.LZ.compress(JSON.stringify(t)))
          }
          catch (e)
          {
        ...
        cleanUp: function()
        {
          if (localStorage)
          {
            var e = ["twir_fb", "twir_checkTimer", "twir_inventory", "twir_lastWatch", "twir_marketDataTemp", "twir_menulink", "twir_mw_keep", "twir_mw_scan", "twir_orderCache", "twir_popup", "twir_profiles", "twir_sortBy", "inventory", "orderCache", "orderCacheTWIR", "popup"];
            for (var t in localStorage) localStorage.hasOwnProperty(t) && (-1 != t.indexOf("_betteritems") || e.includes(t)) && localStorage.removeItem(t);
            return !0
          }
        },
        ...
        if (e)
        {
          for (var t = [], i = 0; i < e.length; i++)
          {
            ...
            t[i] = {},
              ...
              void 0 !== a.b && (t[i].auction_price = a.b), void 0 !== a.p && (t[i].max_price = a.p), void 0 !== a.d && (t[i].date = a.d), void 0 !== a.o && (t[i].offer_id = a.o),
      ...
      getStorage: function()
      {
        ...
        var e, t, i = 0,
          a = 0;
        for (t in localStorage) localStorage.hasOwnProperty(t) && (-1 == t.indexOf("_betteritems") ? (e = 2 * (localStorage[t].length + t.length), i += e, -1 != t.indexOf("twir_market") && (a += e)) : localStorage.removeItem(t));
      ...
      timeSince: function(e)
      {
        ...
        return i > 1 ? TWIRlang.informative.years.replace("$1", Math.floor(i)) : (i = Math.floor(t / 2592e3)) > 1 ? TWIRlang.informative.months.replace("$1", Math.floor(i)) : (i = Math.floor(t / 86400)) > 1 ? TWIRlang.informative.days.replace("$1", Math.floor(i)) : (i = Math.floor(t / 3600)) > 1 ? TWIRlang.informative.hours.replace("$1", Math.floor(i)) : (i = Math.floor(t / 60)) > 1 ? TWIRlang.informative.minutes.replace("$1", Math.floor(i)) : TWIRlang.informative.seconds.replace("$1", Math.floor(t))
      },
      msToTime: function(e)
      {
      ...
      bugHunt: function(e)
      {
        TWIR.console("TWIR/ please report following error at https://greasyfork.org/scripts/373294-tw-inventory-reloaded/feedback ", "red"), console.log(e), TWIR.console("TWIR version: " + TWIR.version + " on " + Game.version + ", locale: " + Game.locale, "red"),
      ...
      menu:
      {
        ...
        showSelect: function(e)
        {
          ...
          return i.addItem(1, '<span style="color: #5e321a; display: inline-block; margin-left: 5px;">' + TWIRlang.features.preferences + "</span>"), i.addItem(3, '<span style="color: #5e321a; display: inline-block; margin-left: 5px;">' + TWIRlang.market_watcher.add_name + "</span>"), i.addItem(4, '<span style="color: #5e321a; display: inline-block; margin-left: 5px;">' + TWIRlang.calc.add_name + "</span>"), i.addItem(2, '<span style="color: #5e321a; display: inline-block; margin-left: 5px;">' + TWIRlang.donate_title + "</span>"), i.addListener(function(e)
          {
            switch (e)
            {
              case 1:
        ...
        open: function(e)
        {
          switch (this.gui.window = wman.open("TWIR", null, "escape noreload").setMiniTitle("TWIR - " + TWIRlang.inventory.twir_menu).setSize(748, 471).setTitle("TW Inventory Reloaded").addTab(TWIRlang.features.preferences, "twir_feat", function()
          {
            TWIR.menu.openFeat()
        ...
        openFeat: function()
        {
          ...
          try
          {
            ...
            for (var n in Object.keys(TWIR.translations).sort().forEach(function(e)
              ...
              }), a) i.addItem(n, '<span title="' + a[n].translator + '" style="background: url(//portal-bar.innogamescdn.com/images/west-sprite_01.1541670091.png) no-repeat top left;height: 12px;padding-left: 25px;background-position:' + a[n].icon + ';">' + a[n].translate + "</span>");
            i.select(TWIR.lang);
            var r = $('<div style="width: 250px;float: right;margin-right: 10px;"/>'),
              o = $('<div style="font-weight: bold;margin-top: 5px;text-shadow: 2px 1px 2px #fae3ad;color: #5e321a;font-size: 16px;margin-bottom: 5px;">' + TWIRlang.language + "</div>");
            ...
            var s = $("<div/>"),
              ...
              p = $("<div/>"),
              c = $("<div/>");
            for (var A in TWIR.storage.features) A.indexOf("inv_") > -1 ? (this.gui.check[A] = (new west.gui.Checkbox).setLabel(TWIRlang.feat_strings[A]).setSelected(TWIR.storage.get(A)).appendTo(s), s.append('<br><div style="height:5px;" />')) : A.indexOf("pop_") > -1 ? (this.gui.check[A] = (new west.gui.Checkbox).setLabel(TWIRlang.feat_strings[A]).setSelected(TWIR.storage.get(A)).appendTo(l), l.append('<br><div style="height:5px;" />')) : A.indexOf("mw_") > -1 ? (this.gui.check[A] = (new west.gui.Checkbox).setLabel(TWIRlang.feat_strings[A]).setSelected(TWIR.storage.get(A)).appendTo(p), p.append('<br><div style="height:5px;" />')) : (this.gui.check[A] = (new west.gui.Checkbox).setLabel(TWIRlang.feat_strings[A]).setSelected(TWIR.storage.get(A)).appendTo(c), c.append('<br><div style="height:5px;" />'));
            ...
            d.select(TWIR.Inventory.data.menuSize), t.appendContent('<div style="font-weight: bold;margin-top: 8px;text-shadow: 2px 1px 2px #fae3ad;color: #5e321a;font-size: 16px;margin-bottom: 5px;">' + TWIRlang.features.inventory_menus + "</div>"),
              t.appendContent("<span>" + TWIRlang.feat_strings.inv_menu_size + "</span>").appendContent(d.getMainDiv().css(
              {
                "margin-left": "10px"
              })), t.appendContent(s),
              t.appendContent('<div style="font-weight: bold;margin-top: 8px;text-shadow: 2px 1px 2px #fae3ad;color: #5e321a;font-size: 16px;margin-bottom: 5px;">' + TWIRlang.features.popup_tooltips + "</div>"),
              t.appendContent(l), t.appendContent('<div style="font-weight: bold;margin-top: 8px;text-shadow: 2px 1px 2px #fae3ad;color: #5e321a;font-size: 16px;margin-bottom: 5px;">' + TWIRlang.market_watcher.add_name + "</div>"),
              t.appendContent("<span>" + TWIRlang.feat_strings.mw_clear_time + "</span>").appendContent(g.getMainDiv().css(
              {
                "margin-left": "10px"
              })), t.appendContent(p),
              t.appendContent('<div style="font-weight: bold;margin-top: 8px;text-shadow: 2px 1px 2px #fae3ad;color: #5e321a;font-size: 16px;margin-bottom: 5px;">' + TWIRlang.features.other + "</div>"), t.appendContent(c),
        ...
        openDonate: function()
        {
          try
          {
            ...
            var e = new west.gui.Scrollpane,
              ...
              a = $('<div><span style="color: #5e321a;font-weight: bold;text-align: center;margin-left: auto;margin-right: auto;display: block;font-size: 15px;">' + TWIRlang.donate_paypal + ':<br><br><form target="_blank" action="https://www.paypal.com/cgi-bin/webscr method="post"><input type="hidden" name="cmd" value="_s-xclick"><input type="hidden" name="hosted_button_id" value="TE95VRHUPXCUW"><input type="image" src="https://www.paypalobjects.com/en_US/i/btn/btn_donateCC_LG.gif" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!"><img  border="0" src="https://www.paypalobjects.com/en_US/i/scr/pixel.gif" width="1" height="1"></form></span></div>'),
        ...
        init: function()
        {
          ...
          if (e)
          {
            var t = this,
              ...
              r = this.gui.btn = $('<div title="' + i + '" style="position: absolute; right: 2px; top: 2px; width: 30px; height: 30px; z-index: 3; cursor: pointer;"><div style="background: url(/images/map/icons/instant-work-1.png) no-repeat center / 20px auto; width: 20px;height: 20px;position: absolute;bottom: 0px;right: 0px;"/><div style="background: url(' + TWIR.images.gameEvents[this.events[e]] + '); width: 16px;height: 16px;position: absolute;left: 2px;top: 6px;background-size: contain; background-repeat: no-repeat;filter: drop-shadow(rgb(48, 21, 6) 2px 3px 3px);"/></div>');
            r.on("click", function()
            {
              var e = $(this),
            ...
            this.getFriends(function(r)
            {
              ...
              if (!$.isEmptyObject(o))
              {
                ...
                !async function r()
                {
                  ...
                  d && (A = await e.send(t, l[s]), e.gui.progressBar.increase(), e.gui.progressMsg.text(TWIRlang.event_helper.sent_msg.replace("$1", p.name.cutIt(14))), A.error && e.gui.progressMsg.text(A.msg), e.gui.progressBar.getMainDiv().addMousePopup(TWIRlang.event_helper.already_sent.replace("$event_curr", n).replace("$1", e.gui.progressBar.getValue()).replace("$2", e.gui.progressBar.maxValue)));
                  s < l.length - 1 ? (s++, e.t = window.setTimeout(function()
                  {
                    r()
                  }, A ? Math.floor(1501 * Math.random() + 1500) : 100)) : (e.sending = !1, e.gui.progressMsg.text(TWIRlang.event_helper.all_sent.replace("$event_curr", n)), e.gui.progressBar.getMainDiv().addMousePopup(TWIRlang.event_helper.all_sent.replace("$event_curr", n)), e.gui.stopBtn.disable())
                }()
              }
            })
          }
          ...
          if (i)
          {
            ...
            this.getFriends(function(i)
            {
              ...
              p = l - s, o.setValue(p), o.setMaxValue(l),
                o.getMainDiv().addMousePopup(TWIRlang.event_helper.already_sent.replace("$event_curr", r).replace("$1", p).replace("$2", l)), window.HiroFriends && "function" == typeof HiroFriends.guiManager.updateCounters && HiroFriends.guiManager.updateCounters(s, l), s < 1 && t.gui.startBtn.disable(),
        ...
        load_query: function(e, t)
        {
          if (!this.gui.dialog || !this.gui.dialog.getMainDiv().is(":visible"))
          {
            ...
            this.updateCounters(function()
            {
              ...
              0 === t.length && (t = $('<div class="tw2gui_dialog_actions" style="text-align: center;"/>'), $(".tw2gui_dialog_content", c.getMainDiv()).after(t)), t.append(s.getMainDiv(), l.getMainDiv()), $(".textart_title", s.getMainDiv()).append(p), $(".tw2gui_inner_window_title", c.getMainDiv()).empty().css(
              {
                height: "20px"
              ...
              {
                "min-width": "unset"
              }), c.getMainDiv().append($('<div title="' + TWIRlang.informative.hide + '" class="tw2gui_window_buttons_close" style="position: absolute;right: 6px;top: 8px;"></div>').click(function()
              {
                i.gui.dialog.hide()
      ...
      opener:
      {
        ...
        ask: function(e, t, i)
        {
          if (!(this.gui.ask_dialog && this.gui.ask_dialog.getMainDiv().is(":visible") || this.opening))
          {
            ...
            A.disable(), n.append($('<div class="bag_item"></div>').append(new tw2widget.Item(r, "item_popup_item").setShowcompare(!1).getMainDiv()), s, p.getMainDiv(), c);
            var g = this.gui.ask_dialog = new west.gui.Dialog("", n).setPosition(t, i).show(),
              d = $(".tw2gui_dialog_actions", g.getMainDiv());
            0 === d.length && (d = $('<div class="tw2gui_dialog_actions" style="text-align: center;"/>'), $(".tw2gui_dialog_content", g.getMainDiv()).after(d)), d.append(A.getMainDiv()),
              ...
              {
                "min-width": "unset"
              }), g.getMainDiv().append($('<div title="' + TWIRlang.informative.hide + '" class="tw2gui_window_buttons_close" style="position: absolute;right: 6px;top: 8px;"></div>').click(function()
              {
        ...
        start: function(e, t, i, a)
        {
          if (!this.gui.open_dialog || !this.gui.open_dialog.getMainDiv().is(":visible"))
          {
            ...
            r.append($("<div></div>").append(l.getMainDiv()), $('<div style="line-height: 30px;">' + TWIRlang.opener.loot_text + " ..... :</div>"), o.append(s.getMainDiv()));
            ...
            0 === A.length && (A = $('<div class="tw2gui_dialog_actions" style="text-align: center;"/>'), $(".tw2gui_dialog_content", c.getMainDiv()).after(A)), A.append(p.getMainDiv()),
                    ...
                    case "content":
                      c.items.each(function(e)
                      {
                        var t = ItemManager.get(e.item_id),
                          i = e.count;
                        o[e.item_id] ? (i += o[e.item_id].count, o[e.item_id].count = i, o[e.item_id].itm.setCount(i)) : (o[e.item_id] = {}, o[e.item_id].count = i, o[e.item_id].itm = new tw2widget.InventoryItem(t), a.updateLoot(o[e.item_id].itm.setCount(i).setShowcompare(!1).getMainDiv(), Object.keys(o).length)),
                          a.updateCounters(r)
                      })
                  }
                }
                r < t ? (r++, a.t = window.setTimeout(e, Math.floor(2001 * Math.random() + 500), n)) : (s.push(o), a.opening = !1, a.finish(), i && i(s))
              })
            }(e)
          }
        }
      ...
      reminder:
      {
        ...
        init: function()
        {
          ...
          {
            e.signals = ["inventory_loaded", "inventory_changed", "cooldown_changed", "item_lifetime_changed", "item_used"], e.getList(), e.adventGetOpen(),
        ...
        addItem: function(e)
        {
          this.gui.reminder && this.gui.reminder.getMainDiv().is(":visible") ? (!this.gui.items || this.gui.items.length < 10 && !this.gui.items.includes(e)) && (this.gui.items = this.gui.items || [], this.gui.itemDiv.append(this.getItemDiv(e)), this.gui.items.push(e)) : this.show_rem([e])
        },
      ...
      gameInject:
      {
                ...
                for (var i in t)
                  if (t[i].id.indexOf("room_fortbattle_") > -1 && t[i].fortId == this.fortId)
                  {
                    ...
                    a = a.split(/[\s\u2060](?=\/\d\d\d)/).map(function(e)
                      ...
                      e += '<br><div><span style="font-weight: bold;color: #523F30;">Topic:&nbsp;</span>' + ("" !== a ? '<span style="font-size: 11px;">&quot;' + a + "&quot;</span>" : "") + "</div>"
                  }
              }
              return e
            }
        ...
        addBestClothes4Build: function()
        {
          try
          {
            ...
            oldBuild = oldBuild.replace(/'\<div class\="build_left_divider" \/\>'\+/, "").replace(/'\<div class\="build_skills" \/\>'\+/, "'<div class=\"build_skills\" />'+'<div class=\"twir_bestwear\" />'+"), oldBuild = oldBuild.replace(/this\.initInfo\(data\);/, "$&BuildWindow.twir_bestWear(this, data);"),
        ...
        {
          TWIR.storage.get("fb_count") && (Character.level < 25 || (EventHandler.listen("fort_battle_end", this.addBattleCount), Ajax.remoteCall("fort_overview", "",
          {}, function(e)
          {
            var t = 0;
            if (e.js)
          ...
          if (!0 !== this.checking && void 0 !== e && void 0 !== t)
          {
            ...
            ! function o()
            {
              ...
              }, function(s)
              {
                ...
                if (l)
                {
                  for (var p = 0; p < l.length; p++) l[p].name !== Character.name && l[p].town_rights > t && !i.includes(l[p].player_id) && r.push(l[p].name);
                  if (n < e.length - 1)
                  {
                    var c = ++
        ...
        sendMsgAli: function()
        {
          ...
          newOver = newOver.replace(/\.addColumn\("bnd_town_points"\)/, '$&.addColumn("twir_town_joined")'), newOver = newOver.replace(/\.appendToThCell\("head","bnd_town_points",\s{0,1}(.*?),\s{0,1}'&nbsp;'\)/, '$&.appendToThCell("head", "twir_town_joined", TWIRlang.informative.joined, \'&nbsp;\');'), eval("AllianceWindow.Overviewinit = " + newOver),
          ...
          buttonPos = buttonPos.replace(/this\.window\.\$\('div\.ally\-overview'\)\.append\(change_btn\.getMainDiv\(\)\);/, 'this.window.$(\'div.ally-overview\').append($(change_btn.getMainDiv()).css({"left":"350px"}));'), eval("AllianceWindow.OverviewinitCont = " + buttonPos),
            ...
            }, AllianceWindow.twir_createPosPoint4Alliancemap = function(e)
            {
              ...
              return (t = AllianceWindow.twir_calcCoord4Worldmap(
                ...
                ])) ? $('<img title="' + Character.name + '" src="/images/map/minimap/icons/miniicon_pos.png" class="mmap_wmappoint" style="cursor: pointer;" />').css(
              {
                left: t.x + e.left + "px",
                top: t.y + e.top + "px"
              }).click(function()
            ...
            }, AllianceWindow.twir_createAlliPoints4Alliancemap = function(e, t, i)
            {
                  ...
                  n = 0; n < e.length; n++)
              {
                ...
                (o = AllianceWindow.twir_calcCoord4Worldmap(
                  [r.x, r.y])) && a.push($('<img onclick="javascript:void(Map.center(' + r.x + "," + r.y + '))" title="' + r.name + '" src="/images/map/minimap/icons/miniicon_alliance_' + t + '.png" class="mmap_wmappoint" style="cursor: pointer;" />').css(
                {
                  left: o.x + i.left + "px",
                  top: o.y + i.top + "px"
                }))
        ...
        addMsgToFb: function()
        {
          ...
          newfunction = newfunction.replace(/if\(nav\s{0,1}\[match\[1\]\].func\)\s{0,1}that\[nav\[match\[1\]\].func\]\(\);/, "$&if(nav[match[1]].func&&nav[match[1]].func==='updateRecruitlist')that.twir_updateRecruitlist_msg();"), eval("FortBattleWindow.infoareaNavigation = " + newfunction),
            FortBattleWindow.twir_updateRecruitlist_msg = function()
            {
              try
              {
                ...
                t.append('<div><img title="' + TWIRlang.organizing.msg + '" src="/images/window/friendslist/mail_icon.png?1"  style="height: 18px;cursor: pointer;"/></div>').click(function()
                {
        ...
        {
          MessagesWindow.Telegram.twir_refresh_addressbook = MessagesWindow.Telegram.twir_refresh_addressbook || MessagesWindow.Telegram.refresh_addressbook,
            MessagesWindow.Telegram.refresh_addressbook = function()
            {
              MessagesWindow.Telegram.twir_refresh_addressbook.apply(this, arguments),
                ...
                }, function(e)
                {
                  ...
                  setTimeout(function()
                  {
                    ABhtml = $("<p><a href=\"javascript:MessagesWindow.Telegram.insert_to(null, '" + t.join(";") + "');\">" + TWIRlang.organizing.msg_world + "&nbsp;(" + t.length + ")</a></p>"),
        ...
        addInfo: function()
        {
          ...
          FortBattle.twir_getCharDataSheet = FortBattle.twir_getCharDataSheet || FortBattle.getCharDataSheet,
            FortBattle.getCharDataSheet = function(t)
            {
              ...
              return i = i.replace(/\<div class\="recruitlist_avatar"\>/, '<div class="recruitlist_avatar" onclick="' + o + '" style="cursor: pointer"> <div style="position: absolute;z-index: 100;left: 16px;">' + (TWIR.storage.get("fb_online_status") && a !== Character.playerId ? s : "") + (TWIR.storage.get("fb_ranks") ? l : "") + "</div>")
            ...
            FortBattleWindow.changeCellPopupText = function(t)
            {
              ...
              if (a)
              {
                ...
                var n = a.westPlayerId,
                  ...
                  g = "<div style='margin-left: 10px;'><table cellpadding=0 cellspacing=0><tr>" + (0 != a.bonusinfo.offense ? s(A, "/images/fort/battle/attacker_secondary.png", a.bonusinfo.offense || 0) : "") + (0 != a.bonusinfo.defense ? s(A, "/images/fort/battle/defender_secondary.png", a.bonusinfo.defense || 0) : "") + (0 != a.bonusinfo.leadbonus ? s(A, "/images/fort/battle/leadsupport.png", a.bonusinfo.leadbonus || 0) : "") + "</tr></table></div>";
                g += '<table style="margin:0;padding:0;font-size:8pt"><tr style="font-size:8pt;height:20px;font-weight:bold;">',
                  g += '<td style="vertical-align: middle;"><div style="font-size:13px; font-family: georgia, times new roman, serif; font-weight: bold;">' + a.name + '&nbsp;</div></td><td style="vertical-align: middle;">' + (TWIR.storage.get("fb_online_status") && n !== Character.playerId ? p : "") + '&nbsp;</td><td style="vertical-align: middle;">' + (TWIR.storage.get("fb_ranks") ? c : "") + "</td>";
                var d = a.health / a.healthmax * 84 + "px";
                g += '<td style="vertical-align: middle;"><div style="background: url(/images/character_bars/bars.png) right top;width: 100px;height: 14px;display: inline-block;padding: 2px;margin: 5px;font-size: 8pt;text-align: left"><div style="background: url(/images/character_bars/filler.png);width: ' + d + ';height: 14px;margin-top: 2px;padding: 0;margin: 0;position: absolute;"></div><div style="position: absolute;color: white;width: 85px;text-align: center;">' + a.health + " / " + a.healthmax + "</div></div></td>",
                  g += "</tr></table>",
                  g += '<div style="text-align: center"><span style="background: url(/images/fort/battle/report_icons.png) no-repeat;background-position: 0 -51px;height: 16px;width: 16px; display: inline-block;vertical-align: middle;"/>&nbsp;<span style="font-weight: bold; font-size: 11px;">' + a.causeddamage + "</span></div>",
      ...
      smarterChat: function()
      {
        ...
        }(), e = Game.TextHandler.parse, Game.TextHandler.parse = function(t)
        {
          return t = t.replace(/\[item=(.*?)\]/g, function(e, t, i)
          {
            ...
            return n ? "<a href='javascript:void(0)' oncopy='TWIR.handleCopy(this)' style='display: inline-block;' data-item-id='" + n.getId() + "' class='bbcode itemlink' title='" + new ItemPopup(n).getXHTML().escapeHTML() + "'>[" + (n.getItemLevel() ? ' <span class="item_level' + (n.isUpgradeable() ? "" : " fake") + '">' + n.getItemLevel() + "</span>" : "") + n.name.escapeHTML() + "]</a>" : e
          }), e(t)
        }, Chat.Formatter.twir_formatText = Chat.Formatter.twir_formatText || Chat.Formatter.formatText, Chat.Formatter.formatText = function(e, t)
        {
          ...
          switch (!0)
          {
            ...
            case a.test(e):
              ...
              {
                var u = '<div class="twir_embed-container"><iframe src="https://www.youtube.com/embed/' + g[1] + '" frameborder="0" allowfullscreen></iframe></div>';
            ...
            case n.test(e):
              ...
              {
                var h = '<div class="twir_embed-container"><iframe src="https://player.vimeo.com/video/' + m[1] + '" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div>';
            ...
            case r.test(e):
              ...
              {
                var b = '<div class="twir_embed-container"><iframe src="https://www.dailymotion.com/embed/video/' + w[1] + '" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div>';
            ...
            case o.test(e):
              ...
              {
                var I = '<div class="twir_embed-container"><iframe src="https://www.facebook.com/plugins/video.php?href=' + encodeURIComponent(f[0]) + '&show_text=0&width=280&height=157" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true" allowFullScreen="true"></iframe></div>';
            ...
            case l.test(e):
              ...
              {
                var x = '<div class="twir_embed-container"><iframe src="https://player.twitch.tv/?video=' + k[1] + '&autoplay=false&width=280&height=157" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true" allowFullScreen="true"></iframe></div>';
            ...
            case s.test(e):
              ...
              {
                var y = '<div class="twir_embed-container"><iframe src="https://player.twitch.tv/?channel=' + v[1] + '&autoplay=false&width=280&height=157" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true" allowFullScreen="true"></iframe></div>';
          ...
          return e = e.split(/[\s\u2060](?=\/\d\d\d)/).map(function(e)
            ...
            TWIR.storage.get("mw_bbcode_tooltip") && (e = e.replace(/\[item=(.*?)\]/g, function(e, t, i)
            {
              ...
              return "<a href='javascript:void(0)' oncopy='TWIR.handleCopy(this)' style='display: inline-block;' data-item-id='" + n.getId() + "' class='bbcode itemlink' title='" + new ItemPopup(n).getXHTML().escapeHTML() + "'>[" + (n.getItemLevel() ? ' <span class="item_level' + (n.isUpgradeable() ? "" : " fake") + '">' + n.getItemLevel() + "</span>" : "") + (r ? '<span title="' + r.escapeHTML() + '" style="display: inline-block;padding: 0 2px 0 0;margin-left: -4px;"><img  style="width:16px;height:16px;display: inline-block;" src="' + TWIR.images.currency.dollars + '"/></span>' : "") + n.name.escapeHTML() + "]</a>"
        ...
        PlayerProfileMain.twir_ranking = {
            init: function(t, i)
            {
              PlayerProfileMain.twir_ranking.getDuelRank(t),
                ...
                PlayerProfileMain.twir_ranking.getMpiRank(t), e && (PlayerProfileMain.twir_ranking.setRankBar(i), PlayerProfileMain.twir_ranking.addProfPoints(i))
            },
            ...
            setBuildTitle: function()
            {
              ...
              return o += "<ul style=&quot;list-style-type:none&quot;>",
                ...
                o += "<li>" + a + ":&nbsp;" + (t.build.points >= 1e4 ? TWIR.replSum(t.build.points) : t.build.points) + "</li>", o += "<li>" + n + ":&nbsp;" + (t.build.fair >= 1e4 ? TWIR.replSum(t.build.fair) : t.build.fair) + "</li>",
            ...
            setRankBar: function(e)
            {
              ...
              var i = $('<div style="position:absolute;top:184px;left:100px;border-collapse:separate!important;border-spacing:1px!important;width:151px;height:18px;z-index:100; text-align: center;"/>');
              t.duels.html = $('<span class="twir_profitem" title="' + PlayerProfileMain.twir_ranking.setDuelsTitle() + '" style="background: rgba(0,0,0,0.4) url(' + TWIR.images.profile.duels + ') 0 50% no-repeat;"/> ' + t.duels.rank + " </span>"),
                t.forts.html = $('<span class="twir_profitem" title="' + PlayerProfileMain.twir_ranking.setFortsTitle() + '" style="background: rgba(0,0,0,0.4) url(' + TWIR.images.profile.forts + ') 0 50% no-repeat;"/> ' + t.forts.rank + " </span>"),
                t.build.html = $('<span class="twir_profitem" title="' + PlayerProfileMain.twir_ranking.setBuildTitle() + '" style="background: rgba(0,0,0,0.4) url(' + TWIR.images.profile.build + ') 0 50% no-repeat;"/> ' + t.build.rank + " </span>"),
                t.craft.html = $('<span class="twir_profitem" title="' + PlayerProfileMain.twir_ranking.setCraftTitle() + '" style="background: rgba(0,0,0,0.4) url(' + TWIR.images.profile.craft + ') 0 50% no-repeat;"/> ' + t.craft.rank + " </span>"),
                t.mpi.html = $('<span class="twir_profitem" title="' + PlayerProfileMain.twir_ranking.setMpiTitle() + '" style="background: rgba(0,0,0,0.4) url(' + TWIR.images.profile.mpi + ') 0 50% no-repeat;"/> ' + t.mpi.rank + " </span>");
              for (var a = Object.keys(t).sort(function(e, i)
                ...
                {}), n = 0; n < 3; n++) a[n].rank > 0 ? i.append(a[n].html) : ($(a[n].html).html($(a[n].html).html().replace(a[n].rank, "IDK")), i.append(a[n].html));
              TWIR.storage.get("prof_rank_bar") && 5 == Object.keys(TWIR.storage.stats.global).length && e.append('<style type="text/css">.twir_profitem{display:inline-block;height:14px;line-height:14px;font-size:11px;padding:0 3px 0 17px;text-align:center;color:#fff;text-shadow: #3b3b3b -1px 0 1px, #3b3b3b 0 1px 1px, #3b3b3b 1px 0 1px, #3b3b3b 0 -1px 1px;border-radius:0 0 2px 0;font-weight:400;margin-right: 2px;margin-left: 2px;vertical-align: middle;box-shadow: 1px 1px 3px #000000;}</style>').append(i)
            }
      ...
      addPopup:
      {
        ...
        calcPosition: function(e, t)
        {
          try
          {
            ...
            var p = e.width,
              c = Map.height;
            i || (i = $("#popup-container").find(".twir_popup")), (o = MousePopup.prototype.wrap(l)) !== a && (i.html(o), a = o, n = i.height(), r = i.width()), t > Map.width / 2 ? e.left = e.left - r : e.left = e.left + p, c - e.top < n + 10 && (e.top = c - (n + 10)), i.css(
            {
              top: e.top,
              left: e.left
            })
        ...
        getMarketPrice: function(e)
        {
          try
          {
            ...
            {
              var r = '<span><img src="' + t.image + '"; height="25"; width="auto"></img></span><span style="color: #8b4513; text-align: center;margin-bottom: 2px;padding-left: 15px;">' + TWIRlang.tooltips.market_price + ":</span>";
              0 != i[t.short].change && (r += '<span style="color:' + (i[t.short].change < 0 ? "#900" : "#070") + '; text-align: center;margin-bottom: 2px;padding-left: 15px;">' + (i[t.short].change > 0 ? "+" : "") + i[t.short].change + "%</span>"),
              ...
              r += '<tr><td style="vertical-align: middle!important;padding-left: 2px;color: #00153f;border-spacing: 1px !important;">' + TWIRlang.tooltips.suggested_price + ':&nbsp;</td><td style="color: black;float: right;vertical-align: middle;">$' + TWIR.replSum(o) + (s > o + 1e3 ? "&nbsp;-&nbsp;$" + TWIR.replSum(s) : "") + "</td></tr>",
                r += '<tr><td style="vertical-align: middle!important;padding-left: 2px;color: #00153f;border-spacing: 1px !important;font-size: 12px;">' + TWIRlang.tooltips.minimal_price + "&nbsp;/&nbsp;" + TWIRlang.tooltips.maximal_price + ':&nbsp;</td><td style="color: black;vertical-align: middle;float: right;">$' + TWIR.replSum(i[t.short].offer_min.price) + "&nbsp;/&nbsp;$" + TWIR.replSum(i[t.short].offer_max.price) + "</td></tr>",
                r += '<tr><td style="vertical-align: middle!important;padding-left: 2px;color: #00153f;border-spacing: 1px !important;font-size: 12px;">' + TWIRlang.tooltips.average + ':&nbsp;</td><td style="color: black;vertical-align: middle;float: right;">$' + TWIR.replSum(i[t.short].weight) + "</td></tr>",
                0 != i[t.short].weight_since && (r += '<tr><td style="vertical-align: middle!important;padding-left: 2px;color: #00153f;border-spacing: 1px !important;font-size: 12px;">' + TWIRlang.tooltips.average_since.replace("$1", "7") + ':&nbsp;</td><td style="color: black;vertical-align: middle;float: right;">$' + TWIR.replSum(i[t.short].weight_since) + "</td></tr>"),
                r += "</tbody></table></div><br>",
                r += '<div style="color: #00153f;font-size: 12px;text-align:center;">' + TWIRlang.tooltips.seen.replace("$1", i[t.short].offer_count) + "</div>",
                0 != i[t.short].unique && (r += '<div style="color: #00153f;font-size: 12px;text-align:center;">' + TWIRlang.tooltips.uniq_sellers.replace("$1", i[t.short].unique) + "</div>");
              var l = new Date - new Date(i[t.short].seen);
              return r += '<div style="color: #00153f;text-align: center;font-size: 12px;">' + TWIRlang.tooltips.last_seen + ":&nbsp;" + TWIR.timeSince(new Date(Date.now() - l)) + "</div>"
            }
            if (a[t.short] && TWIR.storage.get("mw_product_price_tooltip"))
            {
              ...
              r += '<tr><td style="vertical-align: middle!important;padding-left: 2px;color: #00153f;border-spacing: 1px !important;">' + TWIRlang.tooltips.suggested_price + ':&nbsp;</td><td style="color: black;float: right;vertical-align: middle;">$' + TWIR.replSum(o) + (s > o + 1e3 ? "&nbsp;-&nbsp;$" + TWIR.replSum(s) : "") + "</td></tr>",
                r += '<tr><td style="vertical-align: middle!important;padding-left: 2px;color: #00153f;border-spacing: 1px !important;font-size: 12px;">' + TWIRlang.tooltips.minimal_price + "&nbsp;(" + TWIRlang.tooltips.each + "&nbsp;/&nbsp;" + a[t.short].offer_min_x.count + '):&nbsp;</td><td style="color: black;vertical-align: middle;float: right;">$' + TWIR.replSum(a[t.short].offer_min.price) + "&nbsp;/&nbsp;$" + TWIR.replSum(a[t.short].offer_min_x.price) + "</td></tr>",
                r += '<tr><td style="vertical-align: middle!important;padding-left: 2px;color: #00153f;border-spacing: 1px !important;font-size: 12px;">' + TWIRlang.tooltips.maximal_price + "&nbsp;(" + TWIRlang.tooltips.each + "&nbsp;/&nbsp;" + a[t.short].offer_max_x.count + '):&nbsp;</td><td style="color: black;vertical-align: middle;float: right;">$' + TWIR.replSum(a[t.short].offer_max.price) + "&nbsp;/&nbsp;$" + TWIR.replSum(a[t.short].offer_max_x.price) + "</td></tr>",
                r += "</tbody></table></div><br>",
                0 != a[t.short].unique && (r += '<div style="color: #00153f;font-size: 12px;text-align:center;">' + TWIRlang.tooltips.uniq_sellers.replace("$1", a[t.short].unique) + "</div>"),
                r += '<div style="color: #00153f;font-size: 12px;text-align:center;">' + TWIRlang.tooltips.seen.replace("$1", a[t.short].offer_count) + "</div>";
      ...
      enhancedPopups:
      {
          ...
          try
          {
            Map.PopupHandler.twir_getJobPopup = Map.PopupHandler.twir_getJobPopup || Map.PopupHandler.getJobPopup, Map.PopupHandler.getJobPopup = function(e)
            {
              ...
              if (JobsModel.Beans[e.id])
              {
                ...
                t = t.replace('<div class="strong">' + e.name + "</div>", '$&  <div class="marker_popup_small_text" style="font-weight: bold;">' + i + "&nbsp;xp&nbsp;/" + JobsModel.Beans[e.id].basis.short.duration.getTime2EndToken() + "</strong></div>");
                for (var a = {},
                ...
                for (var c in e.yields)
                {
                  ...
                  t = t.replace("</div>" + A.name + "</div>", "</div>" + A.name + '<div class="marker_popup_small_text" style="font-weight: normal!important;">(' + g + "&nbsp;%&nbsp;/" + d + ")</div></div>")
                }
              }
              return t
            }
        ...
        itemPopup: function()
        {
          ...
          t && t[1] && (TWIRlang.stats.shot = /shot:\s{0,1}_{0,1}\({0,1}"(.*?)"\){0,1}/.exec(t[1])[1], TWIRlang.stats.hand = /hand:\s{0,1}_{0,1}\({0,1}"(.*?)"\){0,1}/.exec(t[1])[1]),
            ItemPopup.getXHTML = function()
            {
              try
              {
                ...
                TWIR.storage.get("pop_item_id") && (t = t.replace(/\<div\>\<img src\="(.*?)\/images\/fort\/battle\/divider\.png" alt\=""\>\<\/div\>/, '<div class="twir_id" style="margin-top: 2px;color: blue;text-align: center;font-size: 12px;">[item=<b>' + this.item_obj.item_id + '</b>]</div> <div style="text-align: center;"><img src="/images/fort/battle/divider.png" ></div>'));
                ...
                var b = TWIR.storage.popups.marketPrice,
                  ...
                  x = b[this.item_obj.short] && b[this.item_obj.short].weight >= 1e4 ? TWIR.replSum(b[this.item_obj.short].weight) : b[this.item_obj.short] ? b[this.item_obj.short].weight.toFixed(0) : 0,
                  v = b[this.item_obj.short] && TWIR.storage.get("pop_market_price") ? '<div style="margin-top: 5px;"><span class="tw2gui-iconset tw2gui-icon-world" style="display: inline-block; vertical-align: top;"/>&nbsp;&#36;' + x + "</div>" : "";
                if (f[this.item_obj.short] && TWIR.storage.get("pop_ups_price"))
                {
                  var y = 1 === this.item_obj.item_level ? 3 : 2 === this.item_obj.item_level ? 9 : 3 === this.item_obj.item_level ? 27 : 4 === this.item_obj.item_level ? 81 : 5 === this.item_obj.item_level ? 243 : 1,
                    R = 3 === f[this.item_obj.short].currency ? '<span style="display: inline-block;position: relative;top: 3px;background: url(' + TWIR.images.currency.bonds_nuggets + ') no-repeat;width: 16px;height: 16px;"></span><span>&nbsp;' + (TWIR.storage.get("pop_short_currency") ? TWIR.replSum(f[this.item_obj.short].price_bonds * y, !0) : f[this.item_obj.short].price_bonds * y) + "</span>" : 2 === f[this.item_obj.short].currency ? '<span style="display: inline-block;position: relative;top: 3px;background: url(' + TWIR.images.currency.nuggets + ') no-repeat;width: 16px;height: 16px;"></span><span>&nbsp;' + (TWIR.storage.get("pop_short_currency") ? TWIR.replSum(f[this.item_obj.short].price_nuggets * y, !0) : f[this.item_obj.short].price_nuggets * y) + "</span>" : 1 === f[this.item_obj.short].currency ? '<span style="display: inline-block;position: relative;top: 3px;background: url(' + TWIR.images.currency.bonds + ') no-repeat;width: 16px;height: 16px;"></span><span>&nbsp;' + (TWIR.storage.get("pop_short_currency") ? TWIR.replSum(f[this.item_obj.short].price_bonds * y, !0) : f[this.item_obj.short].price_bonds * y) + "</span>" : 8 === f[this.item_obj.short].currency ? '<span style="display: inline-block;position: relative;top: 3px;background: url(' + TWIR.images.currency.veteran + ') no-repeat;width: 16px;height: 16px;"></span><span>&nbsp;' + (TWIR.storage.get("pop_short_currency") ? TWIR.replSum(f[this.item_obj.short].price_veteran * y, !0) : f[this.item_obj.short].price_veteran * y) + "</span>" : 7 === f[this.item_obj.short].currency ? '<span style="display: inline-block;position: relative;top: 3px;background: url(' + TWIR.images.currency.bonds_nuggets + ') no-repeat;width: 16px;height: 16px;"></span><span>&nbsp;' + (TWIR.storage.get("pop_short_currency") ? TWIR.replSum(f[this.item_obj.short].price_nuggets * y, !0) : f[this.item_obj.short].price_nuggets * y) + '</span><span style="display: inline-block;position: relative;top: 3px;background: url(' + TWIR.images.currency.dollars + ') no-repeat;width: 16px;height: 16px;margin-left: 5px;"/><span>&nbsp;&#36;' + TWIR.replSum(f[this.item_obj.short].price_dollar * y) + "</span>" : "",
                    T = f[this.item_obj.short].limited_time ? '<span style="color: #666;">&nbsp;(' + TWIR.msToTime((new Date(1e3 * f[this.item_obj.short].limited_time).getTime() - (new Date).getTime()) / 1e3) + ")</span>" : "",
                    V = f[this.item_obj.short].reduced_value ? '<span style="color: #666;">&nbsp;/-' + f[this.item_obj.short].reduced_value + "%</span>" : "";
                  t = t.replace(/(<div\s+class="inventory_popup_prices">[\S\s]*?)(<\/div>)/gi, "$1" + v + '<div class="twir_other_popup_prices">&nbsp;' + R + V + T + "</div> $2")
                }
                else if (I[this.item_obj.short] && TWIR.storage.get("pop_ups_price"))
                {
                  var y = 1 === this.item_obj.item_level ? 3 : 2 === this.item_obj.item_level ? 9 : 3 === this.item_obj.item_level ? 27 : 4 === this.item_obj.item_level ? 81 : 5 === this.item_obj.item_level ? 243 : 1,
                    R = 3 === I[this.item_obj.short].currency ? '<span style="display: inline-block;position: relative;top: 3px;background: url(' + TWIR.images.currency.bonds_nuggets + ') no-repeat;width: 16px;height: 16px;"></span><span>&nbsp;' + (TWIR.storage.get("pop_short_currency") ? TWIR.replSum(I[this.item_obj.short].price_bonds * y, !0) : I[this.item_obj.short].price_bonds * y) + "</span>" : 2 === I[this.item_obj.short].currency ? '<span style="display: inline-block;position: relative;top: 3px;background: url(' + TWIR.images.currency.nuggets + ') no-repeat;width: 16px;height: 16px;"></span><span>&nbsp;' + (TWIR.storage.get("pop_short_currency") ? TWIR.replSum(I[this.item_obj.short].price_nuggets * y, !0) : I[this.item_obj.short].price_nuggets * y) + "</span>" : 1 === I[this.item_obj.short].currency ? '<span style="display: inline-block;position: relative;top: 3px;background: url(' + TWIR.images.currency.bonds + ') no-repeat;width: 16px;height: 16px;"></span><span>&nbsp;' + (TWIR.storage.get("pop_short_currency") ? TWIR.replSum(I[this.item_obj.short].price_bonds * y, !0) : I[this.item_obj.short].price_bonds * y) + "</span>" : 8 === I[this.item_obj.short].currency ? '<span style="display: inline-block;position: relative;top: 3px;background: url(' + TWIR.images.currency.veteran + ') no-repeat;width: 16px;height: 16px;"></span><span>&nbsp;' + (TWIR.storage.get("pop_short_currency") ? TWIR.replSum(I[this.item_obj.short].price_veteran * y, !0) : I[this.item_obj.short].price_veteran * y) + "</span>" : 7 === I[this.item_obj.short].currency ? '<span style="display: inline-block;position: relative;top: 3px;background: url(' + TWIR.images.currency.bonds_nuggets + ') no-repeat;width: 16px;height: 16px;"></span><span>&nbsp;' + (TWIR.storage.get("pop_short_currency") ? TWIR.replSum(I[this.item_obj.short].price_nuggets * y, !0) : I[this.item_obj.short].price_nuggets * y) + '</span><span style="display: inline-block;position: relative;top: 3px;background: url(' + TWIR.images.currency.dollars + ') no-repeat;width: 16px;height: 16px;margin-left: 5px;"/><span>&nbsp;&#36;' + TWIR.replSum(I[this.item_obj.short].price_dollar * y) + "</span>" : "";
                  t = t.replace(/(<div\s+class="inventory_popup_prices">[\S\s]*?)(<\/div>)/gi, "$1" + v + '<div class="twir_popup_limited_prices">&nbsp;' + R + "</div> $2")
                }
                ...
                if (!this.item_obj.sellable && this.item_obj.auctionable && TWIR.storage.get("pop_min_market_price"))
                {
                  ...
                  var S = TWIR.storage.get("pop_short_currency") ? TWIR.replSum(this.item_obj.price / 2 * (this.options.traderCharge || 1)) : this.item_obj.price / 2 * (this.options.traderCharge || 1);
                  t = t.replace(/(inventory_popup_prices")(>)/g, '$1 style="margin-bottom: 5px;"> <span class="inventory_popup_trader_price_buy"><span class="tw2gui-iconset tw2gui-icon-friends" style="display: inline-block; vertical-align: top;"/>&nbsp;&#36;' + S + "</span>" + B)
                }
                if (TWIR.storage.get("pop_short_currency") && (null !== this.item_obj.price && this.item_obj.price >= 1e4 && (t = t.replace("&nbsp;$" + this.item_obj.price * (this.options.traderCharge || 1), "&nbsp;&#36;" + TWIR.replSum(this.item_obj.price * (this.options.traderCharge || 1), !0))), 0 != this.item_obj.sell_price && this.item_obj.price >= 1e4 && (t = t.replace("&nbsp;$" + this.item_obj.sell_price, "&nbsp;&#36;" + TWIR.replSum(this.item_obj.sell_price, !0)))), "crafting" == this.item_obj.spec_type && k[this.item_obj.item_id])
                {
                  ...
                  {
                    var E = Character.professionId == k[this.item_obj.item_id].profsymbol && Character.professionSkill >= ItemManager.getByBaseId(k[this.item_obj.item_id].recipe).min_level ? "#070" : "#8b4513";
                    t += '<br><div style="color: ' + E + '; text-align: center;margin-bottom: 2px;">' + TWIRlang.tooltips.craftable + (0 != M ? "&nbsp;(" + TWIR.replSum(M) + ")" : "") + ":</div>";
                    for (var j = k[this.item_obj.item_id].resources.length,
                        Q = '<div class="twir_better_popup" style="text-align:center;margin: 0 auto;display: table;"><table style="display: table !important;border-collapse: separate !important;border-spacing: 1px !important;border-radius: 3px;border: 1px solid #804000;"><tbody><tr><td style="padding:' + (j > 5 ? "1px" : "5px") + ';border: 1px solid #996b39;border-color: rgba(110,57,0,0.5);background-color: #d4ba91 !important;background-image: none !important;color: #5e321a !important;font-size: 16px;border-collapse: separate !important;border-spacing: 1px !important;vertical-align: middle!important;"><img src="/images/crafting/profsymbol_' + k[this.item_obj.item_id].profsymbol + '_small.png"></td><td style="padding: ' + (j > 5 ? "2px" : "5px") + ';border: 1px solid #996b39;border-color: rgba(110,57,0,0.5);background-color: #d4ba91 !important;background-image: none !important;color: #5e321a !important;font-size: 16px;border-collapse: separate !important;border-spacing: 1px !important;"><table style="display: table !important;border-collapse: separate !important;border-spacing: 1px !important;border-radius: 3px;border: 1px solid #804000;"><tbody><tr>',
                        q = 0; q < k[this.item_obj.item_id].resources.length; q++)
                    {
                      ...
                      Q += '<td style="vertical-align: middle!important;padding: ' + (j > 5 ? "2px" : "5px") + ';border: 1px solid #996b39;border-color: rgba(110,57,0,0.5);background-color: #d4ba91 !important;background-image: none !important;color: #5e321a ;font-size: 16px;border-collapse: separate !important;border-spacing: 1px !important;"><img style="width:30px;height:30px;" src="' + ItemManager.get(k[this.item_obj.item_id].resources[q].item, !0).image + '"><div style="font-size:8pt;">(<span style="color: ' + G + ';">' + TWIR.replSum(Y) + "</span>)</div></td>"
                    }
                    Q += "</tr><tr>";
                    for (var O = 0; O < k[this.item_obj.item_id].resources.length; O++) Q += '<td style="vertical-align: middle!important;padding: ' + (j > 5 ? "2px" : "5px") + ';border: 1px solid #996b39;border-color: rgba(110,57,0,0.5);background-color: #d4ba91 !important;background-image: none !important;color: #5e321a !important;font-size: 14px;border-collapse: separate !important;border-spacing: 1px !important;"><span>x' + k[this.item_obj.item_id].resources[O].count + "</span></td>";
                    Q += "</tr></tbody></table></td></tr></tbody></table></div>"
                  }
                  var D = ItemManager.getByBaseId(k[this.item_obj.item_id].recipe, !0).min_level >= 50;
                  TWIR.storage.get("pop_recipe_table") && D && (Q += '<div class="twir_better_popup" style="text-align:center;margin: 0 auto;display: table;"><table style="display: table !important;border-collapse: separate !important;border-spacing: 1px !important;border-radius: 3px;border: 1px solid #804000;"><tbody><tr><td style="vertical-align: middle!important;padding: 5px;border: 1px solid #996b39;border-color: rgba(110,57,0,0.5);background-color: #d4ba91 !important;background-image: none !important;color: #5e321a !important;font-size: 16px;border-collapse: separate !important;border-spacing: 1px !important;"><img style="width: 30px;height: 30px;" src="' + ItemManager.getByBaseId(k[this.item_obj.item_id].recipe).image + '"/></td><td style="vertical-align: middle!important;padding: 5px;border: 1px solid #996b39;border-color: rgba(110,57,0,0.5);background-color: #d4ba91 !important;background-image: none !important;color: #5e321a !important;font-style: italic;font-size: 8pt;border-collapse: separate !important;border-spacing: 1px !important;width: 125px;"><span>' + ItemManager.getByBaseId(k[this.item_obj.item_id].recipe).name + "&nbsp;(" + ItemManager.getByBaseId(k[this.item_obj.item_id].recipe).min_level + ")</span></td></tr></tbody></table></div>"), t += Q
                }
                if ("mapdrop" === this.item_obj.spec_type && "none" === this.item_obj.usetype && TWIR.storage.get("pop_job_table"))
                {
                  ...
                  for (var H = '<div class="twir_better_popup" style="text-align:center;margin: 0 auto;display: table;"><table style="display: table !important;border-collapse: separate !important;border-spacing: 1px !important;border-radius: 3px;border: 1px solid #804000;"><tbody>',
                      Z = 0; Z < J.length; Z++)
                  {
                    var P = 0,
                      N = 0;
                    if ($.isEmptyObject(JobsModel.Beans) || null == JobsModel.Beans[J[Z].id].basis.long.yields[0]) P = Math.ceil(600 * J[Z].yields[this.item_obj.item_id].prop), N = 0;
                    else if (!$.isEmptyObject(JobsModel.Beans) && void 0 !== JobsModel.Beans[J[Z].id].basis.long.yields[0])
                      for (var z = 0; z < JobsModel.Beans[J[Z].id].basis.long.yields.length; z++) JobsModel.Beans[J[Z].id].basis.long.yields[z].itemid === this.item_obj.item_id && (P = JobsModel.Beans[J[Z].id].basis.long.yields[z].prop, N = JobsModel.Beans[J[Z].id].basis.long.yields[z].probBonus);
                    var L = P + N,
                      X = $.isEmptyObject(JobsModel.Beans) || 0 == L ? "" : "&nbsp;(" + L.toFixed(0) + "&nbsp;%)";
                    J[Z] && (H += '<tr><td style="vertical-align: middle!important;padding: 5px;border: 1px solid #996b39;border-color: rgba(110,57,0,0.5);background-color: #d4ba91 !important;background-image: none !important;color: #5e321a !important;font-size: 16px;border-collapse: separate !important;border-spacing: 1px !important;"><img style="width: 30px;height: 30px;" src="/images/jobs/' + J[Z].shortname + '.png"/></td><td style="vertical-align: middle!important;padding: 5px;border: 1px solid #996b39;border-color: rgba(110,57,0,0.5);background-color: #d4ba91 !important;background-image: none !important;color: #5e321a !important;font-style: italic;font-size: 8pt;border-collapse: separate !important;border-spacing: 1px !important;width: 125px;"><span>' + J[Z].name + X + "</span></td></tr>")
                  }
                  t += H += "</tbody></table></div>"
                }
                ...
                if (TWIR.storage.get("pop_partial_bonus") && null !== this.item_obj.set && 0 === ee && !1 === i && (t += '<td><div style="display: inline-block;background: url(/images/window/wof/prizes_sep.jpg);width: 25px;height: 270px;margin: 15px 0;"/></td><td class="twir_popup_pb" style="min-width: 200px;max-width: 275px;">'), null !== this.item_obj.set)
                {
                  function ne(e)
                  {
                    for (var t = 0; t < e.length; t++)
                  ...
                  var re = 0;
                  if (re = 11 == _.items.length ? 10 : 3 == _.items.length && ne(_.items) ? 2 : 9 == _.items.length ? 8 : 6 == _.items.length ? 6 : _.items.length, null !== ie)
                  {
                  ...
                  if (TWIR.storage.get("pop_partial_bonus") && 0 == ee && !1 === i)
                  {
                    ...
                    le += '<div style="color: #666; margin-bottom: 5px;font-style: italic;">' + (null !== ie ? "&nbsp;>&nbsp;" + ie.name : "") + "</div>",
                    ...
                    for (var Re = 0; Re < fe.length; Re++)
                      if ("red" !== fe[Re].diff)
                      {
                        var Te = null === fe[Re].diff ? '&nbsp;(<span class="tw_green">+' + fe[Re].value + "</span>)&nbsp;" : parseFloat(fe[Re].diff) > 0 ? '&nbsp;(<span class="tw_green">+' + fe[Re].diff + "</span>)&nbsp;" : parseFloat(fe[Re].diff) < 0 ? '&nbsp;(<span class="tw_red">' + fe[Re].diff + "</span>)&nbsp;" : "&nbsp;",
                          Ve = 0 === fe[Re].diff ? "color: #CC7722" : "color: #666";
                        le += '<li style="' + Ve + ';">' + fe[Re].value + "&nbsp;" + fe[Re].skill + Te + "</li>"
                      } for (var Be = 0; Be < fe.length; Be++) "red" === fe[Be].diff && (le += '<li class="tw_red">-' + fe[Be].value + "&nbsp;" + fe[Be].skill + "</li>");
                    t += le += "</ul>"
                  }
                  var We = ee > 0 ? "&nbsp;(" + ee + "/" + re + ")" : "";
                  if (ee > 0) t = t.replace('<span class="text_bold">' + _.name + ":</span>", '<span style="color: #800080 !important;font-weight: bold;max-width: 220px;display: block;text-align: center;margin-bottom: 5px;">' + _.name + We + "</span>");
                  else if (0 === ee)
                    if (TWIR.storage.get("pop_partial_bonus") && !1 === i)
                    {
                      var Se = '<span style="color: #800080 !important;font-weight: bold;max-width: 220px;display: block;text-align: center;margin-top: 15px;margin-bottom: 5px;">' + _.name + "</span>";
      ...
      fillOther: function()
      {
        ...
        for (var i in e)
          ...
          {
            var a = e[i];
            if ((a.short.indexOf("_fine") >= 0 && null === a.set || null === a.traderlevel && "yield" !== a.type && "recipe" !== a.type && !0 === a.auctionable && !0 === a.dropable && null === a.set) && (TWIR.storage.inventory.collectibles.includes(a.item__id) || TWIR.storage.inventory.collectibles.push(a.item_base_id)), "yield" === a.type && countObjectKeys(ItemManager.get(a.item_id, !0).exportBoni()) > 0 && a.auctionable && !TWIR.marketWatcher.valuables.includes(a.item_id) && TWIR.marketWatcher.valuables.push(a.item_id), "yield" === a.type && a.usebonus)
              for (var n = TWIR.usebonus.key4Val[a.short] = [], r = 0; r < a.usebonus.length; r++)
              {
                var o = -1 !== a.usebonus[r].indexOf(":") ? a.usebonus[r].match(/(.*):/g).pop().replace(":", "") : a.usebonus[r].replace(/[0-9\%\+\:\-\$\.]/g, "").replace(/(\(|\)).*/g, "").trim(),
        ...
        try
        {
          ...
          for (var d = 0; d < t.length; d++)
          {
            ...
            if (u.has_cooldown && t[d].showCooldown(), "yield" === u.type)
              if ("mapdrop" === u.spec_type && "none" === u.usetype) TWIR.storage.inventory.work.includes(u.item_id) || TWIR.storage.inventory.work.push(u.item_id);
            ...
            else if ("crafting" === u.spec_type)
            {
              if (u.usebonus)
                for (var m = 0; m < u.usebonus.length; m++)
                {
                  ...
                  switch (!0)
                  {
                    ...
                    case !1 !== g(h):
                      l.skills || (l.skills = []),
                        l.skills.includes(u.item_id) || l.skills.push(u.item_id), !1 !== g(h, !0) && (l.duels || (l.duels = []), l.duels.includes(u.item_id) || l.duels.push(u.item_id));
                      break;
                    default:
              ...
              f && (l["prof_" + f.profsymbol] || (l["prof_" + f.profsymbol] = []), l["prof_" + f.profsymbol].includes(u.item_id) || l["prof_" + f.profsymbol].push(u.item_id))
            }
            else if ("bonus_medal" === u.spec_type && "use" === u.usetype || 50991e3 === u.item_id) l.bonus_medal || (l.bonus_medal = []), l.bonus_medal.includes(u.item_id) || l.bonus_medal.push(u.item_id);
          ...
          {}, function(t)
          {
            ...
            for (var a = t.msg.search_result,
              ...
              if (a[n].auction_ends_in <= 0 || !isNaN(parseInt(a[n].max_price)) && a[n].current_bid == parseInt(a[n].max_price))
              {
                ...
                isDefined(i[a[n].market_town_id]) ? isDefined(i[a[n].market_town_id]) && isDefined(i[a[n].market_town_id].items[a[n].item_id]) && i[a[n].market_town_id].items[a[n].item_id].type === o ? (i[a[n].market_town_id].items[a[n].item_id].count += a[n].item_count, i[a[n].market_town_id].items[a[n].item_id].money += a[n].current_bid) : isDefined(i[a[n].market_town_id]) && (i[a[n].market_town_id].items[a[n].item_id] = {
          ...
          try
          {
            ...
            for (var t = {}, i = 0; i < e.length; i++)
            {
                ...
                }), t[a.short]))
              {
                ...
                new Date(e[i].date) > new Date(t[a.short].seen) && (t[a.short].seen = e[i].date), (l / e[i].item_count > t[a.short].offer_max.price || l / e[i].item_count == t[a.short].offer_max.price && new Date(e[i].date) > new Date(t[a.short].offer_max.date)) && (t[a.short].offer_max.price = parseInt(l / e[i].item_count), t[a.short].offer_max.date = e[i].date), (l / e[i].item_count < t[a.short].offer_min.price || l / e[i].item_count == t[a.short].offer_min.price && new Date(e[i].date) > new Date(t[a.short].offer_min.date)) && (t[a.short].offer_min.price = parseInt(l / e[i].item_count), t[a.short].offer_min.date = e[i].date)
              }
            }
          ...
          try
          {
            ...
            for (var t = {}, i = 0; i < e.length; i++)
            {
                ...
                }), t[a.short]))
              {
                ...
                new Date(e[i].date) > new Date(t[a.short].seen) && (t[a.short].seen = e[i].date), (p > t[a.short].offer_max.price || p == t[a.short].offer_max.price && new Date(e[i].date) > new Date(t[a.short].offer_max.date)) && (t[a.short].offer_max.price = parseInt(l / e[i].item_count), t[a.short].offer_max.date = e[i].date), (p > t[a.short].offer_max_x.each && e[i].item_count <= t[a.short].offer_max_x.count || p == t[a.short].offer_max_x.each && e[i].item_count <= t[a.short].offer_max_x.count && new Date(e[i].date) > new Date(t[a.short].offer_max_x.date)) && (t[a.short].offer_max_x.each = p, t[a.short].offer_max_x.count = e[i].item_count, t[a.short].offer_max_x.price = l, t[a.short].offer_max_x.date = e[i].date), (p < t[a.short].offer_min.price || p == t[a.short].offer_min.price && new Date(e[i].date) > new Date(t[a.short].offer_min.date)) && (t[a.short].offer_min.price = p, t[a.short].offer_min.date = e[i].date), (p < t[a.short].offer_min_x.each && e[i].item_count >= t[a.short].offer_min_x.count || p == t[a.short].offer_min_x.each && e[i].item_count >= t[a.short].offer_min_x.count && new Date(e[i].date) > new Date(t[a.short].offer_min_x.date)) && (t[a.short].offer_min_x.each = p, t[a.short].offer_min_x.price = l, t[a.short].offer_min_x.count = e[i].item_count, t[a.short].offer_min_x.date = e[i].date)
              }
            }
            return t = this.calcWeight(t),
      ...
      itemList:
      {
        ...
        init: function(e, t)
        {
          ...
          this.reset(t), this.ready[t] = !0, this.gui[t].main || (this.gui[t].main = this.getMainDiv(t)),
            ...
            this.gui[t].button = $('<div class="tw2gui_jobsearch_showall" style="display:block;cursor:pointer;"></div>'), this.gui[t].scrollpane = new west.gui.Scrollpane,
          ...
          for (var r = 0; r < e.length; r++) i = e[r], a = $("<p>" + i.name + "</p>"),
            ...
            i.key && (n.key = i.key), n.type = i.type, "set" !== i.type && "buff" !== i.type && (n.str += String(i.key).toUpperCase() + "Â§"), this.elements[t].push(n);
          this.gui[t].main.append($('<div style="position:relative;top:0;left:0;width:205px;" />').append(this.gui[t].input.getMainDiv()).append(this.gui[t].button)).append(this.gui[t].result)
        },
        open: function(e, t, i)
        {
          var a = this;
        ...
        search: function(e, t, i)
        {
          if (!(e.length < 4 && 0 !== e.length))
          {
            ...
            {
              l.dom.removeClass("focused"), a.test(l.str) && e.length ? (l.dom.removeClass(i + "_filter"), s++, l.dom.is(":visible") && (o.push(l.dom), n && (r.focused[i] = t, l.dom.addClass("focused"), n = !1))) : l.dom.addClass(i + "_filter")
            });
            var l = s >= 12 ? 180 : 15 * s;
        ...
        {
          return this.gui[e].main || (this.gui[e].main = $('<div class="' + e + '" style="position:absolute; display: none; z-index: 2;" />').append('<style type="text/css">.' + e + "_filter{display:none;}</style>")), this.gui[e].main
        },
        getInput(e)
        {
      ...
      marketWatcher:
      {
        ...
        rescan: function(e)
        {
          ...
          {
            t.scanMarket()
          }, p), TWIR.console("TWIR/: Next market scan in: " + (p / 1e3).getTime2EndString(!1) + ".", "#8b4513"), e || p > 18e4 && n && setTimeout(function()
          {
            t.wtb = n ||
            {}, t.lastAlert = n ||
            {}, t.auctions = r ||
        ...
        addCss: function()
        {
          if (0 === $("#twir_mw_css").length)
          {
            return "\t.twir_mw_idx       { width: 24px; text-align: right; padding-right: 8px; white-space: nowrap; overflow: hidden!important; text-overflow: ellipsis!important;font-size: 12px;background: url(/images/tw2gui/table/cell_shadow_y.png); }\n", "\t.twir_mw_name    { width: 200px; white-space: nowrap; overflow: hidden!important; text-overflow: ellipsis!important; padding-left: 5px;font-weight: bold;color: #523F30;font-size: 12px;cursor: pointer;}\n", "\t.twir_mw_price      { width: 80px; padding-left: 20px; white-space: nowrap; overflow: hidden!important; text-overflow: ellipsis!important;font-size: 12px;color: #523F30; }\n", "\t.twir_mw_ab    { width: 5px;}\n", "\t.twir_mw_bell    { width: 25px; background: url(/images/tw2gui/table/cell_shadow_y.png); float: right;}\n", "\t.twir_mw_remove    { width: 25px; background: url(/images/tw2gui/table/cell_shadow_y.png); float: right;}\n", "\t.twir_mw_watch    { position: absolute;bottom: 35px;left: 50%;margin-left: -50px;width: 100px;}\n", "\t.twir_mwl_tab .row_head span    { color: #523F30; background: none!important;cursor: unset!important;}\n", "\t.twir_mwl_tab .row_head .twir_mw_price span    { background: none!important; text-align: right!important;}\n", "\tdiv.tw2gui_selectbox ul.tw2gui_selectbox_content   { max-height: unset!important;}\n",
              ...
              document.styleSheets[0].insertRule('div.ongoing_entry div.image.twir_marketWatcher {background: url("' + TWIR.images.market_watcher + '") no-repeat;}', document.styleSheets[0].cssRules.length), this
          }
        },
        isValidItem: function(e, t)
        {
          ...
          return $.isNumeric(e) ? void 0 === a ? (t && new UserMessage(TWIRlang.informative.valid_id.replace("$1", e) + "!", UserMessage.TYPE_ERROR).show(), !1) : void 0 !== a && !1 === a.auctionable ? (t && new UserMessage(TWIRlang.informative.valid_auctionable.replace("$1", e) + "!", UserMessage.TYPE_ERROR).show(), !1) : void 0 === a || !0 !== a.auctionable || !this.mwl.some(function(t)
          {
            return t.item_id === e
          }) || (t && new UserMessage(TWIRlang.informative.valid_defined.replace("$1", e) + "!", UserMessage.TYPE_ERROR).show(), !1) : isDefined(i) && "buff" === i ? !this.mwl.some(function(t)
          {
            return t.type === i && t.item_id === e
          }) || (t && new UserMessage(TWIRlang.informative.valid_defined.replace("$1", e) + "!", UserMessage.TYPE_ERROR).show(), !1) : void 0 === n ? (t && new UserMessage(TWIRlang.informative.valid_id.replace("$1", e) + "!", UserMessage.TYPE_ERROR).show(), !1) : void 0 === n || r(n) ? void 0 === n || !r(n) || !this.mwl.some(function(t)
          {
            return t.item_id === e
        ...
        openMWTab: function()
        {
          ...
          var t = this.idField,
            ...
            s = $('<div class="twir_mw_itemframe" style="position: absolute;height: 58px;width: 58px;top: 30px;left: 10px;background: rgba(220, 165, 118, 0.4);border-radius: 3px;box-shadow: 0 0 1px inset;"/>'),
            l = $('<div class="twir_mw_itemname" style="position:absolute;width:163px;max-height:44px;left:70px;top:36px;color:#420;font:bold 11pt &quot;Times New Roman&quot;;word-wrap:break-word;text-overflow:ellipsis;overflow:hidden;background-color:#523f3029;text-align:center;background:rgba(220,165,118,.4);border-radius:3px;box-shadow:0 0 1px inset;line-height:20px;"></div>'),
          ...
          function h()
          {
            u = "", MarketWindow.window.$("div.twir_mwl_tab", MarketWindow.DOM).empty(), e.gui.table = (new west.gui.Table).addColumn("twir_mw_idx").addColumn("twir_mw_item").addColumn("twir_mw_name").addColumn("twir_mw_price").addColumn("twir_mw_ab").addColumn("twir_mw_bell").addColumn("twir_mw_remove").appendToCell("head", "twir_mw_idx").appendToCell("head", "twir_mw_item").appendToCell("head", "twir_mw_name", TWIRlang.market_watcher.watching).appendToCell("head", "twir_mw_price", TWIRlang.market_watcher.max_price).appendToCell("head", "twir_mw_ab").appendToCell("head", "twir_mw_bell").appendToCell("head", "twir_mw_remove");
            for (var t = e.mwl,
                i = 0; i < t.length; i++)
            {
              var a = t[i].type && "buff" === t[i].type ? p[t[i].item_id] : t[i].type && "set" === t[i].type ? west.storage.ItemSetManager.get(t[i].item_id) : ItemManager.get(t[i].item_id, !0),
              ...
              e.gui.table.appendToCell(-1, "twir_mw_item", "<img " + n + ' style="cursor: pointer;" title="' + (c.includes(t[i].type) ? new ItemPopup(a).getXHTML().escapeHTML() : t[i].type && "set" === t[i].type ? TWIR.Inventory.itemShowcase(a.items, !1, !0) : a.name) + '" src="' + (c.includes(t[i].type) ? a.image : t[i].type && "buff" === t[i].type ? ItemManager.get(p[t[i].item_id].image).image : t[i].type && "set" === t[i].type ? l.image : "") + '"; height="29"; width="29"></img>'), e.gui.table.appendToCell(-1, "twir_mw_name", r), t[i].item_price ? e.gui.table.appendToCell(-1, "twir_mw_price", "$" + (t[i].item_price >= 1e5 ? TWIR.replSum(t[i].item_price) : t[i].item_price)) : e.gui.table.appendToCell(-1, "twir_mw_price", "-"), t[i].auto && e.gui.table.appendToCell(-1, "twir_mw_ab", '<span title="' + TWIR.replSum(t[i].auto) + '">y</span>');
            ...
            }).click(function()
            {
              ! function()
              {
                ...
                var a = $('<span><input type="text" class="input_layout" readonly="readonly" style="text-align: center;resize: horizontal;" size="35" name="report_bbcode" value="' + u + '" onclick="this.select();" /></span>');
            ...
            }).click(function()
            {
              ...
              {
                !0 !== e.checking ? (e.mwl = [], h(), v()) : new UserMessage(TWIRlang.informative.error_wait + ".", UserMessage.TYPE_ERROR).show()
            ...
            t.length && e.gui.table.appendToFooter("twir_mw_remove", b),
              ...
              e.gui.table.noScrollbar || (null === m && (m = e.gui.table.bodyscroll.getScrollPos()), e.gui.table.bodyscroll.scrollTo(m.x, m.y), m = e.gui.table.bodyscroll.getScrollPos())
          }
          ...
          function b(e)
          {
            ...
            t.empty(), t.append(function(e)
            {
              ...
              else "buff" === i ? (l.text(TWIRlang.inventory[t].cutIt(36)), t = p[t].image) : $.isNumeric(t) && 0 != t ? l.text(ItemManager.get(t, !0).name.cutIt(36)) : l.text("-- " + TWIRlang.market_watcher.no_select + " --");
          ...
          var y = $('<div style="position:absolute;top:95px;left:15px;width:26px;height:20px;background:url(/images/window/character/title_editbtn.jpg) no-repeat scroll 0 0 transparent;cursor:pointer;"></div>'),
            R = "twir_mw_mainlist";
          TWIR.itemList.init(TWIR.storage.itemList, R), y.on("click", function()
          {
            ...
            TWIR.itemList.getMainDiv(R).is(":visible") ? TWIR.itemList.close(R) : (TWIR.itemList.open(null, e, R), TWIR.itemList.gui[R].input.focus())
          });
          var T = $('<div style="position: absolute; left: 250px; top: 15px;"></div>');
          T.append(g.getMainDiv().css(
          {
            "margin-right": "25px"
          })).append(d.getMainDiv()), n.append($('<div style="position: absolute; left: 30px; top: 0px;">' + TWIRlang.market_watcher.settings_watch + ":</div>")).append(A.getMainDiv().css(
          {
            position: "absolute",
            left: "40px",
            top: "15px"
          ...
          return V.append($('<span style="width: 90px;display: inline-block;text-align: right;padding-right: 8px;vertical-align: middle;">' + TWIRlang.market_watcher.max_buyout + "</span>")).append(f.getMainDiv().css(
            {
              "vertical-align": "middle"
            })), I.append((new west.gui.Groupframe).appendToContentPane($('<div style="height: 244px;"/>').append(s, y, l).append(TWIR.itemList.getMainDiv(R).css(
            {
              left: "40px",
              top: "90px",
              display: "none"
            ...
            a.append(I, $('<div class="market_devider_bottom" style="left: 10px;width: 225px;top: 55px;" />'), $('<div class="market_devider_bottom" style="top: 55px; width: 426px;" />'), r, n, o),
        ...
        scanMarket: function()
        {
          ...
          this.lastAlert = this.wtb, TWIR.storage.get("mw_status") && !1 !== l && i.show(TWIRlang.market_watcher.progress_title + "..", "..."),
            function p()
            {
              !0 === l ? (e.checking = !0, TWIR.storage.get("mw_status") && i.status(s(TWIRlang.market_watcher.progress_page + " " + a)), Ajax.remoteCall("building_market", "search",
              {
                page: a
              }, function(l)
              {
                if (!l.error)
                  if (!1 === l.error)
                  {
                        ...
                        A = 0; A < c.length; A++)
                    {
                      ...
                      if (f("auctions"), TWIR.storage.get("mw_collections") && e.missing.includes(d.name) && !1 === e.getBuyed(c[A].item_id) && f("wtb_missing"), w)
                      {
                        TWIR.storage.popups.marketPrice,
                          TWIR.storage.popups.marketPriceJunk;
                        var I = null != c[A].max_price ? c[A].max_price : null != c[A].curr_bid ? Number(c[A].curr_bid + 10) : Number(c[A].auction_price + 10);
                        w.auto && 0 != w.auto && !c[A].is_highest_bidder && I <= w.auto && Number(Character.money + Character.deposit) > I ? e.bid(
                        {
                          bid: I,
                          offer_id: c[A].market_offer_id
                        }) : (I < w.item_price || 0 === w.item_price) && (TWIR.storage.get("mw_status") && i.status(s(TWIRlang.market_watcher.progress_found + ": " + d.name)), e.getWatched(c[A].item_id, !0) && (b.spec = "buff"), f("wtb"))
                      }
                    }
                    setTimeout(function()
                    {
                        ...
                        if (e.wtb = t.wtb, e.wtb_missing = t.wtb_missing, e.auctions = t.auctions, TWIR.storage.get("mw_trader"))
                              ...
                              s = 0; s < r.length; s++)
                          {
                            ...
                            r[s].auction_ends_in = g / 1e3,
                              ...
                              }).length ? e.wtb_missing[c.short].unshift(r[s]) : e.missing.indexOf(c.name) >= 0 && !e.wtb_missing[c.short] && (e.wtb_missing[c.short] = [], e.wtb_missing[c.short].push(r[s])),
                              e.wtb[c.short] && 0 === e.wtb[c.short].filter(function(e)
                              {
                                return "trader" === e.spec
                              }).length ? e.wtb[c.short].unshift(r[s]) : !e.wtb[c.short] && A && (e.wtb[c.short] = [], e.wtb[c.short].push(r[s]))
                          }
        ...
        searchMarket: function(e)
        {
          ...
          $("div.marketplace").is(":visible") || (i ? MarketWindow.open(Character.homeTown.town_id) : MarketWindow.open()),
            ...
            $("div.market-buy .iSearchbox input", MarketWindow.DOM).val(e), $("span.iconBut_mpb_refresh", MarketWindow.DOM).click(), $("div.market-buy .iSearchbox input", MarketWindow.DOM).val(""), wman.close("inventory")
        },
        setMarketAlert:
        {
          gui:
          ...
          open: function(e)
          {
            ...
            var o = this.itemList;
            this.gui.window = wman.open("TWIR_MW", null, "escape noreload").setTitle(TWIRlang.market_watcher.add_name).setMiniTitle(TWIRlang.market_watcher.add_name).setSize(570, 475), !$.isEmptyObject(a) && Object.keys(a).length > Object.keys(n).length && this.gui.window.addTab(TWIRlang.market_watcher.watched, "twir_MWA_watched", function()
              {
              ...
              }), !$.isEmptyObject(i) && TWIR.storage.get("mw_collections") && this.gui.window.addTab(TWIRlang.market_watcher.collections, "twir_MWA_coll", function()
              {
              ...
              }), TWIR.itemList.init("watched" == e ? o.wtb : "buffs" == e ? o.buff : "coll" == e ? o.coll : o.all, "twir_mw_alertlist"), this.makeHtml(), this.browse(e),
              this.gui.window.activateTab("watched" == e ? "twir_MWA_watched" : "buffs" == e ? "twir_MWA_buffs" : "coll" == e ? "twir_MWA_coll" : "twir_MWA_browse")
          },
          makeHtml: function()
          {
            var e = this;
            this.gui.window.clearContentPane(),
              this.gui.scroll = (new west.gui.Scrollpane).appendContent("<div/>"), this.input.player = (new west.gui.Textfield).maxlength(14).setWidth(95),
              this.input.town = (new west.gui.Textfield).maxlength(14).setWidth(95),
              this.input.name = TWIR.itemList.getInput("twir_mw_alertlist"), this.gui.main.table = $('<div style="position: absolute; top: 40px; width: 515px;"></div>').append((new west.gui.Groupframe).appendToContentPane($('<div style="height: 288px;"/>').append(this.gui.scroll.getMainDiv())).getMainDiv());
            var t = $('<div style="position: relative; display: inline-block; top: 7px; width:26px;height:20px;background:url(/images/window/character/title_editbtn.jpg) no-repeat scroll 0 0 transparent;cursor:pointer;"></div>'),
              i = $('<div style="position: relative; display: inline-block; top: 7px;width:26px;height:20px;background:url(' + TWIR.images.inputIcon.player + ') no-repeat scroll 0 0 transparent;cursor:pointer;"></div>'),
              a = $('<div style="position: relative; display: inline-block; top: 7px;width:26px;height:20px;background:url(' + TWIR.images.inputIcon.town + ') no-repeat scroll 0 0 transparent;cursor:pointer;"></div>'),
              n = sessionStorage.getItem("twir_timer"),
              r = $('<div style="font-size: 11px;float: right;position: absolute;right: 20px;bottom: -4px;">' + (n ? TWIRlang.market_watcher.last_scan + ": " + get_server_date_string(!1, JSON.parse(n), !0) : "") + "</div>"),
              o = $('<img class="click_icon icon__map" src="/images/transparent.png" style="position: absolute;left: 35px;bottom: -10px;"/>').on("click", function(e)
              {
                var t = $(this);
            ...
            })).append(a).append(this.input.town.getMainDiv().css(
            {
              position: "relative",
              display: "none"
            })), $(this.gui.window.getContentPane()).append(s), $(this.gui.window.getContentPane()).append(this.gui.main.table).append(o, r), t.on("click", function()
            {
              TWIR.itemList.getMainDiv("twir_mw_alertlist").is(":visible") ? TWIR.itemList.getMainDiv("twir_mw_alertlist").hide() : (TWIR.itemList.getMainDiv("twir_mw_alertlist").show().css("display", "inline-block"), e.input.name.focus())
            }), i.on("click", function()
            {
              e.input.player.getMainDiv().is(":visible") ? e.input.player.getMainDiv().hide() : (e.input.player.getMainDiv().show().css("display", "inline-block"), e.input.player.focus())
            }), a.on("click", function()
            {
              e.input.town.getMainDiv().is(":visible") ? e.input.town.getMainDiv().hide() : (e.input.town.getMainDiv().show().css("display", "inline-block"), e.input.town.focus())
            }), this
          },
          browse: function(e)
          {
            ...
            function i(e)
            {
              var i = t.gui.tab,
                a = "";
              a = "object" == typeof e && !Object.keys(e).length || !e ? "browse" !== i ? t.format(i) : "" : t.format(i, e), t.gui.scroll.getContentPane().empty().append($(a)), t.gui.scroll.scrollToTop()
            }
            this.gui.tab = e,
              i();
            var a = {
          ...
          filterBySettings: function(e, t)
          {
            ...
            for (var s in e)
            {
              ...
              for (var l = 0; l < e[s].length; l++) n && !a && !e[s]
                ...
                [l].item_id !== t.val || t && t.player && !r(t.player).test(e[s][l].seller_name) || t && t.town && !r(t.town).test(e[s][l].market_town) && !r(t.player).test(e[s][l].seller_town) || o[s].push(e[s][l]);
          ...
          format: function(e, t)
          {
            var i = "watched" == e ? TWIR.marketWatcher.wtb : "coll" == e ? TWIR.marketWatcher.wtb_missing : "buffs" == e ? TWIR.marketWatcher.setMarketAlert.filterSpec("buff") : "browse" === e ? TWIR.marketWatcher.auctions :
            {};
                  ...
                  l = 0; l < s.length; l++)
              {
                ...
                if (!p[0].spec || "buff" != p[0].spec || "buffs" === e)
                {
                  ...
                  if (p.length > 1)
                  {
                    for (var A = p.length <= 11 ? p.length : 11, g = 1; g < A; g++)
                    {
                      var d = null !== p[g].max_price ? TWIRlang.market_watcher.price : TWIRlang.market_watcher.bid,
                        u = null !== p[g].max_price ? parseInt(p[g].max_price / p[g].item_count) : null !== p[g].curr_bid ? parseInt(p[g].curr_bid / p[g].item_count) : parseInt(p[g].auction_price / p[g].item_count);
                      c += "<tr><td>[" + g + "]</td>",
                  ...
                  var m = ItemManager.get(p[0].item_id, !0),
                    ...
                    I = TWIR.storage.popups.marketPrice,
                    k = p[0].spec && "trader" == p[0].spec ? "blue" : I[m.short] && b <= I[m.short].weight && I[m.short].offer_count > 2 ? "#070" : I[m.short] && I[m.short].offer_max.price <= b && I[m.short].offer_count > 2 && p[0].seller_name != TWIR.author ? "#900" : "unset",
                    x = Map.calcWayTime(TWIR.lastPos(),
                    {
                      x: p[0].posx,
                      y: p[0].posy
                    }),
                    v = "<div>@" + p[0].seller_name + (p[0].market_town ? "&nbsp;(" + p[0].market_town + ")" : "") + "</div><div>" + TWIRlang.informative.distance + ":&nbsp;" + x.formatDuration() + "</div>",
                    y = l !== s.length - 1 || 9 === l ? "1px solid rgba(140,92,20,0.65)" : "none",
                    R = "trader" !== p[0].spec ? "javascript:void(PlayerProfileWindow.open(" + p[0].seller_id + "))" : "javascript:void(west.window.shop.open(&quot;wear_window&quot;).showCategory(&quot;trader&quot;))",
                    T = p.length > 1 ? '<div style="font-style: italic;margin-left: 10px;color: #666; font-size: 8pt; cursor: pointer;"><a style="color: #523F30!important;font-style: normal;font-weight: normal;" href="' + R + '" title="' + v.escapeHTML() + '">@' + p[0].seller_name.cutIt(14) + '</a>&nbsp;<span title="' + c.escapeHTML() + '">' + TWIRlang.market_watcher.offer_count.replace("$1", p.length - 1) + "</span></div>" : '<div style="color: #666;margin-left: 10px;cursor: pointer; font-size: 8pt;"><a style="color: #523F30!important;font-weight: normal;" href="' + R + '" title="' + v.escapeHTML() + '">@' + p[0].seller_name + "</a></div>",
                    V = "trader" != p[0].spec ? "TWIR.marketWatcher.searchMarket(" + p[0].item_id + ")" : "west.window.shop.open(&quot;wear_window&quot;).showCategory(&quot;trader&quot;)",
                    B = p[0].spec && "trader" == p[0].spec ? '<img src="' + TWIR.images.trader + '" style="position: absolute; right: 0px; bottom: 0px;"/>' : 1 == p[0].sell_rights ? '<img src="/images/icons/friends.png" style="position: absolute; right: 0px; bottom: 0px;"/>' : 0 == p[0].sell_rights ? '<img src="/images/icons/town_new.png" style="position: absolute; right: 0px; bottom: 0px;"/>' : "",
                  ...
                  o += '<tr style="border-spacing: 1px !important;background: rgba(220, 165, 118, 0.4);border-radius: 3px;box-shadow: 0 0 1px inset;border-bottom: ' + y + ';"><td style="vertical-align: middle;padding-left: 4px;"><div style="position: relative; height: 29px; width: 35px;"><img data-item-id="' + p[0].item_id + '" style="cursor: pointer;" title="' + new ItemPopup(m).getXHTML().escapeHTML() + '" src="' + m.image + '"; height="29"; width="29"></img>' + B + W + "</div></td>",
                    o += '<td style="padding: 2px;vertical-align: middle;"><div style="margin-bottom: -2px; cursor: pointer;"><span title="' + m.name + '" data-item-id="' + p[0].item_id + '" style="width: 190px;text-overflow: ellipsis;white-space: nowrap;overflow: hidden;display: inline-block; color: ' + k + ';">' + m.name + '</span><span style="display: inline-block;overflow: hidden;float: right;">(x' + TWIR.replSum(p[0].item_count) + ")</span></div>" + T + "</td>",
                    o += '<td title="' + p[0].auction_end_date.getFormattedTimeString4Timestamp() + '" style="text-align: center;padding: 2px; padding-right: 8px; padding-left: 8px;cursor: pointer;"><div style="font-size: 8pt;">' + TWIRlang.market_watcher.time_left + '</div><div style="margin-top: 4px;">' + TWIR.msToTime(p[0].auction_ends_in) + "</div></td>",
                    o += '<td title="' + (h ? h.escapeHTML() : "") + '" style="text-align: center;padding: 2px;cursor: pointer; padding-left: 8px;"><div style="font-size: 8pt;">' + w + '</div><div style="color: ' + k + '; margin-top: 4px;">$' + TWIR.replSum(b) + "</div></td>",
                    o += '<td style="text-align: center;padding: 2px;cursor: pointer; padding-left: 8px;"><div style="font-size: 8pt;">' + TWIRlang.market_watcher.curr_bid + '</div><div style="margin-top: 4px;">' + ("trader" != p[0].spec && null !== f ? TWIR.replSum(f) : "trader" !== p[0].spec && null !== p[0].auction_price ? '<span style="font-size: 8pt;color: #666;">' + TWIRlang.market_watcher.no_bids + "</span>" : "-") + "</div></td>",
                    o += '<td style="vertical-align: middle;padding-right: 4px;"><div onclick="' + V + '" style="margin-left: 10px;cursor: pointer;"><img src="/images/icons/bid.png" title="' + ("trader" != p[0].spec ? TWIRlang.market_watcher.bid_now : TWIRlang.market_watcher.buy_trader) + '" /> </div></td>',
                    o += "</tr>"
                }
              }
        ...
        {
          if (!("hidden" in document && !1 === document.hidden && document.hasFocus()) && void 0 !== window.Notification && "granted" === Notification.permission)
          {
          ...
          if (delete this.OnGoing, !$.isEmptyObject(t) || !$.isEmptyObject(a) || !$.isEmptyObject(r))
          {
            if (TWIR.storage.get("mw_wtb_alert"))
            {
              ...
              if (this.OnGoing = new OnGoingPermanentEntry(function()
                {
                  !$.isEmptyObject(t) && Object.keys(t).length > Object.keys(i).length ? e.setMarketAlert.open("watched") : $.isEmptyObject(i) ? !$.isEmptyObject(a) && TWIR.storage.get("mw_collections") ? e.setMarketAlert.open("coll") : $.isEmptyObject(r) || e.setMarketAlert.open("browse") : e.setMarketAlert.open("buffs")
                }, l, "twir_marketWatcher", !1), WestUi.NotiBar.add(e.OnGoing), !$.isEmptyObject(t)) var p = $('<div style="text-shadow:black -1px 0 1px,black 0 1px 1px,black 1px 0 1px,black 0 -1px 1px;line-height:15px;font-size:10px;font-weight:700;text-align:center;position:absolute;width:21px;z-index:2;background:url(/images/interface/friendsbar/level_bg.png);height:15px;left:2px; top: 28px; color:white;">' + TWIR.replSum(Object.keys(t).length) + "</div>");
            ...
            {
              ChatWindow.open(A, !0);
              var g = TWIRlang.market_watcher.seen + '&nbsp;<a href="javascript:void(TWIR.marketWatcher.setMarketAlert.open(&quot;watched&quot;))">[' + Object.keys(t).length + "]</a>.",
                d = Chat.Formatter.formatMessage(Chat.Formatter.formatText(g, !0), "&nbsp;<b>" + TWIRlang.market_watcher.add_name + ":</b>", Date.now(), !0, "from_system"),
                u = Chat.Resource.Manager.getRooms();
              for (var m in u) u[m].addMessage(d)
            }
            o !== s && e.newOffers().length && this.OnGoing && this.OnGoing.highlightBorder(!0), e.newOffers().length && !TWIR.storage.get("mw_alert_playsound") && this.notify()
          }
      ...
      stats:
      {
        ...
        statsQuantities: function()
        {
          ...
          for (var p in t)
          {
            ...
            switch ("yield" !== c.type && null !== c.set && (l("set_count", 1), l("set_total", t[p].count)), "yield" !== c.type && "recipe" !== c.type && (!e.count_max.obj_max || t[p].count > e.count_max.obj_max.count) && (e.count_max.obj_max = {
        ...
        statsSalesValue: function()
        {
          ...
          for (var o in t)
            if (t[o])
            {
              ...
              a("inventory_buy_price", $.isNumeric(s.price) ? s.price * t[o].count : 0),
                a("inventory_sell_price", $.isNumeric(s.sell_price) ? s.sell_price * t[o].count : 0), 1 != t[o].count || i[s.type] && i[s.type].obj.item_id === s.item_id || (a("unique_buy_price", $.isNumeric(s.price) ? 1 * s.price : 0), a("unique_sell_price", $.isNumeric(s.sell_price) ? 1 * s.sell_price : 0))
          ...
          for (var p in t)
            if (t[p])
            {
              ...
              "yield" !== c.type && t[p].count > 1 && (a("duplicates_buy_price", A), a("duplicates_sell_price", g)), "yield" !== c.type && !0 === c.dropable && (a("droppable_buy_price", A), a("droppable_sell_price", g))
            } return e.value.average_obj_buy_price = Math.round(e.value.average_obj_buy_price / e.count.obj_count), e.value.average_obj_sell_price = Math.round(e.value.average_obj_sell_price / e.count.obj_count), e.value.average_prod_buy_price = Math.round(e.value.average_prod_buy_price / e.count.prod_count), e.value.average_prod_sell_price = Math.round(e.value.average_prod_sell_price / e.count.prod_count), this
        }
      },
      pps:
      {
        ...
        calc: function()
        {
              ...
              i = 0; i < e.length; i++)
          {
            ...
            t[a] || (t[a] = [0,
              ...
              t.cashObj || "yield" == r.type || "recipe" == r.type || (t.cashObj = 0), "yield" != r.type && "recipe" != r.type && (t.cashObj += r.sell_price), t.cashProd || "yield" !== r.type || (t.cashProd = 0), "yield" === r.type && (t.cashProd += r.sell_price), t.cashRec || "recipe" !== r.type || (t.cashRec = 0), "recipe" === r.type && (t.cashRec += r.sell_price)
          }
          return t
        },
        apply: function(e)
        {
          ...
          if (t && e)
          {
            ...
            var i = Inventory.categoryDesc,
              a = '<div><span class="teaser_headline"></span><div class="teaser_content"><table style="display:inline-table;margin-right: 5px;width: 225px;">';
            a += '<tr style="height: 20px;"><td style="font-size:13px; font-family: georgia, times new roman, serif; font-weight: bold;border-bottom: 2px solid rgba(25,25,25,0.25);">' + TWIRlang.stats.quantities + '</td><td style="border-bottom: 2px solid rgba(25,25,25,0.25);"></td><td style="text-align: center;font-weight: bold;border-bottom: 2px solid rgba(25,25,25,0.25);">[&#8800;]</td></tr>',
              e.head && (a += "<tr><td>" + i.head + ':&nbsp;</td><td style="text-align: center;">' + TWIR.replSum(e.head[1], !0) + '&nbsp;</td><td style="text-align: center;">[' + TWIR.replSum(e.head[0], !0) + "]</td></tr>"),
              e.neck && (a += "<tr><td>" + i.neck + ':&nbsp;</td><td style="text-align: center;">' + TWIR.replSum(e.neck[1], !0) + '&nbsp;</td><td style="text-align: center;">[' + TWIR.replSum(e.neck[0], !0) + "]</td></tr>"),
              e.body && (a += "<tr><td>" + i.body + ':&nbsp;</td><td style="text-align: center;">' + TWIR.replSum(e.body[1], !0) + '&nbsp;</td><td style="text-align: center;">[' + TWIR.replSum(e.body[0], !0) + "]</td></tr>"),
              e.pants && (a += "<tr><td>" + i.pants + ':&nbsp;</td><td style="text-align: center;">' + TWIR.replSum(e.pants[1], !0) + '&nbsp;</td><td style="text-align: center;">[' + TWIR.replSum(e.pants[0], !0) + "]</td></tr>"),
              e.belt && (a += "<tr><td>" + i.belt + ':&nbsp;</td><td style="text-align: center;">' + TWIR.replSum(e.belt[1], !0) + '&nbsp;</td><td style="text-align: center;">[' + TWIR.replSum(e.belt[0], !0) + "]</td></tr>"),
              e.foot && (a += "<tr><td>" + i.foot + ':&nbsp;</td><td style="text-align: center;">' + TWIR.replSum(e.foot[1], !0) + '&nbsp;</td><td style="text-align: center;">[' + TWIR.replSum(e.foot[0], !0) + "]</td></tr>"),
              e.hand && (a += "<tr><td>" + TWIRlang.stats.hand + ':&nbsp;</td><td style="text-align: center;">' + TWIR.replSum(e.hand[1], !0) + '&nbsp;</td><td style="text-align: center;">[' + TWIR.replSum(e.hand[0], !0) + "]</td></tr>"),
              e.shot && (a += "<tr><td>" + TWIRlang.stats.shot + ':&nbsp;</td><td style="text-align: center;">' + TWIR.replSum(e.shot[1], !0) + '&nbsp;</td><td style="text-align: center;">[' + TWIR.replSum(e.shot[0], !0) + "]</td></tr>"),
              e.left_arm && (a += "<tr><td>" + i.left_arm + ':&nbsp;</td><td style="text-align: center;">' + TWIR.replSum(e.left_arm[1], !0) + '&nbsp;</td><td style="text-align: center;">[' + TWIR.replSum(e.left_arm[0], !0) + "]</td></tr>"),
              e.animal && (a += "<tr><td>" + i.animal + ':&nbsp;</td><td style="text-align: center;">' + TWIR.replSum(e.animal[1], !0) + '&nbsp;</td><td style="text-align: center;">[' + TWIR.replSum(e.animal[0], !0) + "]</td></tr>"),
              e.yield && (a += "<tr><td>" + i.yield + ':&nbsp;</td><td style="text-align: center;">' + TWIR.replSum(e.yield[1], !0) + '&nbsp;</td><td style="text-align: center;">[' + TWIR.replSum(e.yield[0], !0) + "]</td></tr>"),
              e.recipe && (a += "<tr><td>" + TWIRlang.stats.recipes + ':&nbsp;</td><td style="text-align: center;">' + TWIR.replSum(e.recipe[1], !0) + '&nbsp;</td><td style="text-align: center;">[' + TWIR.replSum(e.recipe[0], !0) + "]</td></tr>"),
              a += '<tr style="height: 10px;"><td style="border-bottom: 2px solid rgba(25,25,25,0.25);"></td><td style="border-bottom: 2px solid rgba(25,25,25,0.25);"></td><td style="border-bottom: 2px solid rgba(25,25,25,0.25);"></td></tr>',
              e.total && (a += '<tr><td style="font-weight: bold;">' + TWIRlang.stats.total + ':&nbsp;</td><td style="text-align: center;">' + TWIR.replSum(e.total[1], !0) + '&nbsp;</td><td style="text-align: center;">[' + TWIR.replSum(e.total[0], !0) + "]</td></tr>"),
              a += "</table>",
              a += '<table style="display:inline-table; width: 225px;">',
              a += '<tr style="height: 20px;"><td style="font-size:13px; font-family: georgia, times new roman, serif; font-weight: bold;border-bottom: 2px solid rgba(25,25,25,0.25);">' + TWIRlang.stats.sales_value + '</td><td style="border-bottom: 2px solid rgba(25,25,25,0.25);text-align: center;"><img src="' + TWIR.images.sell + '"/></td><td style="text-align: center;font-weight: bold;border-bottom: 2px solid rgba(25,25,25,0.25);"></td></tr>',
              null != e.cashObj && (a += "<tr><td>" + TWIRlang.stats.items + ':&nbsp;</td><td style="text-align: center;">$' + format_money(e.cashObj) + "&nbsp;</td><td></td></tr>"),
              null != e.cashProd && (a += "<tr><td>" + TWIRlang.stats.products + ':&nbsp;</td><td style="text-align: center;">$' + format_money(e.cashProd) + "&nbsp;</td><td></td></tr>"),
              null != e.cashRec && (a += "<tr><td>" + TWIRlang.stats.recipes + ':&nbsp;</td><td style="text-align: center;">$' + format_money(e.cashRec) + "&nbsp;</td><td></td></tr>"),
              a += '<tr style="height: 10px;"><td style="border-bottom: 2px solid rgba(25,25,25,0.25);"></td><td style="border-bottom: 2px solid rgba(25,25,25,0.25);"></td><td style="border-bottom: 2px solid rgba(25,25,25,0.25);"></td></tr>',
              e.cash && (a += '<tr><td style="font-weight: bold;">' + TWIRlang.stats.total_buy_price + ':&nbsp;</td><td style="text-align: center;">$' + format_money(e.cash[0]) + "&nbsp;</td><td></td></tr>"),
              e.cash && (a += '<tr><td style="font-weight: bold;">' + TWIRlang.stats.total_sell_price + ':&nbsp;</td><td style="text-align: center;">$' + format_money(e.cash[1]) + "&nbsp;</td><td></td></tr>"),
              a += "</table></div></div>",
              t.addMousePopup(a)
          }
        }
      ...
      marketMap:
      {
        ...
        createItemsPoints4Worldmap: function(e, t)
        {
          ...
          for (var a in e)
          {
                ...
                [n.posx, n.posy]))
            {
              ...
              i.push($('<img onclick="' + m + '" title="' + r + '" src="' + u + '" style="cursor: pointer; position: absolute;width:' + (p.length === l.length ? "16px" : "22px") + ';height: auto;-webkit-filter: drop-shadow(rgb(34, 34, 34) 2px 3px 3px);filter: drop-shadow(rgb(48, 21, 6) 2px 3px 3px);" />').css(
              {
                left: d.x + t.left + "px",
                top: d.y + t.top + "px"
              }))
        ...
        calculateTotal: function()
        {
          ...
          for (var n in e)
            if (e[n])
              for (var r in e[n].items) "offer_sold" === e[n].items[r].type ? t += e[n].items[r].money : "offer_sold" !== e[n].items[r].type && (i += e[n].items[r].count), a += Object.keys(e[n].items).length;
          return [t, i, a]
        },
        createPosPoint4Worldmap: function(e)
        {
          ...
          return (t = this.calcCoord4Worldmap(
            [Character.getPosition().x, Character.getPosition().y])) ? $('<img title="' + Character.name + '" src="/images/map/minimap/icons/miniicon_pos.png" style="cursor: pointer; position: absolute;width: 16px;height: auto;-webkit-filter: drop-shadow(2px 2px 2px #222);filter: drop-shadow(2px 2px 2px #222);" />').css(
          {
            left: t.x + e.left + "px",
            top: t.y + e.top + "px"
          }) : $([])
        ...
        show: function()
        {
          ...
          this.gui.window = wman.open("twir_marketmap", null, "escape").setSize(800, 440),
            this.gui.window.showLoader(), this.gui.window.setTitle('<span style="margin-top: 4px; font-size: 16pt;">' + TWIRlang.menulink.market_map + "</span>"), this.gui.window.setMiniTitle("TWIR - " + TWIRlang.menulink.market_map), $(".tw2gui_window_inset", this.gui.window.getMainDiv()).css("background-size", "100%"), this.gui.window.addEventListener("WINDOW_RELOAD", function()
            {
              TWIR.marketMap.show()
            }), this.gui.window.clearContentPane();
          ...
          if (!1 === $.isEmptyObject(i))
          {
                ...
                t.addItem(["map"], ' <img src="/images/icons/welt.png" height="16px width="auto" style="left: 5px;top: 5px;"/><span style="margin-left: 15px;color: #5e321a; text-overflow: ellipsis;white-space: nowrap;overflow: hidden;word-wrap: break-word; margin-top: 2px; max-width: 200px;display: inline-block;">' + TWIRlang.menulink.market_map + "</span>", TWIRlang.menulink.market_map).addEmpty(), a)
            {
                  ...
                  o.items)
              {
                ...
                var A = ItemManager.get(c, !0);
                s += "<div class=&quot;popup_yield_image&quot; style=&quot;margin-right: 1px;margin-bottom: 1px;display: inline-block;&quot;><div class=&quot;item&quot;><span class=&quot;count&quot; style=&quot;display:block;top:30px;left:1px&quot;>" + TWIR.replSum(o.items[c].count) + "</span><img src=&quot;" + A.image + "&quot; alt=&quot;" + A.name + "&quot; width=&quot;43&quot; height=&quot;43&quot; /></div>", "offer_sold" === o.items[c].type && (s += "<span style=&quot;font-size: 11px;text-align: center;display: block;&quot;>$" + TWIR.replSum(o.items[c].money) + "</span>"),
                  s += "</div>"
              }
              s += "</div>", t.addItem(0, '<img src="/images/map/minimap/icons/miniicon_market_items.png" style="left: 5px;top: 8px;"/><span title="' + ("<div>" + o.name + "</div><div>" + TWIRlang.informative.distance + ":&nbsp;" + o.distance.formatDuration() + "</div>").escapeHTML() + '" style="margin-left: 15px;color: #5e321a; text-overflow: ellipsis;white-space: nowrap;overflow: hidden;word-wrap: break-word; margin-top: 2px; max-width: 170px;display: inline-block;">' + o.name + '</span><span title="' + s + '" style="display: inline-block;margin-top: 3px;color: #5e321a;position: relative;float: right;font-size: 12px;">&#124;&nbsp;' + (0 != p ? "$" + TWIR.replSum(p) + (0 != l ? ",&nbsp;" : "") : "") + (0 != l ? TWIR.replSum(l) + "&nbsp;" + TWIRlang.tooltips.items : "") + "</span>", (new west.gui.Selectbox).setHeader(o.name.cutIt(16)).setWidth(180).addItem([1,
                o
              ], '<span style="color: #5e321a;">' + TWIRlang.menulink.window_open + "</span>").addItem([2,
                o
          ...
          return t.addListener(function(e)
          {
            ...
            function o(e)
            {
              ...
              }, function(s)
              {
                ...
                return s.hotel_level >= e && c <= 3600 ? TaskQueue.add(new TaskSleep(a[t].town_id, i[s.hotel_level - 1])) : c > 3600 ? new UserMessage(TWIRlang.informative.error_hotel + "!").show() : n < r.length - 1 ? (n++, void setTimeout(function()
                {
                  o(e)
        ...
        try
        {
          if (Object.keys(TWIR.storage.NPC).length > 0)
          {
            ...
            for (var n in Object.keys(TWIR.storage.NPC).sort(function(e, t)
                ...
                }), 1 != TWIR.npcLoading && t.addItem("load", ' <img src="/images/icons/questbook.png" height="16px width="auto" style="left: 5px;top: 5px;"/><span style="margin-left: 15px;color: #5e321a; text-overflow: ellipsis;white-space: nowrap;overflow: hidden;word-wrap: break-word; margin-top: 2px; max-width: 200px;display: inline-block;">' + TWIRlang.menulink.quest_update + "</span>", TWIRlang.menulink.quest_update).addEmpty(),
                i)
              for (var r = i[n],
                  o = 0; o < r.length; o++)
              {
                ...
                c += '<div class="teaser_content">',
                  0 != l.p4 && (c += '<span><img style="margin-right: 2px;margin-bottom: 2px;" class="tw2gui-iconset tw2gui-icon-exclamation-priority-4" src="/images/tw2gui/pixel-vfl3z5WfW.gif"><span style="vertical-align: middle;">' + l.p4 + "x</span></span>"), 0 != l.p4f && (c += '<span><img style="margin-right: 2px;margin-bottom: 2px;" class="tw2gui-iconset tw2gui-icon-question-priority-4" src="/images/tw2gui/pixel-vfl3z5WfW.gif"><span style="vertical-align: middle;">' + l.p4f + "x</span></span>"), 0 != l.p3 && (c += '<span><img style="margin-right: 2px;margin-bottom: 2px;" class="tw2gui-iconset tw2gui-icon-exclamation-priority-3" src="/images/tw2gui/pixel-vfl3z5WfW.gif"><span style="vertical-align: middle;">' + l.p3 + "x</span></span>"), 0 != l.p3f && (c += '<span><img style="margin-right: 2px;margin-bottom: 2px;" class="tw2gui-iconset tw2gui-icon-question-priority-3" src="/images/tw2gui/pixel-vfl3z5WfW.gif"><span style="vertical-align: middle;">' + l.p3f + "x</span></span>"), 0 != l.p2 && (c += '<span><img style="margin-right: 2px;margin-bottom: 2px;" class="tw2gui-iconset tw2gui-icon-exclamation-priority-2" src="/images/tw2gui/pixel-vfl3z5WfW.gif"><span style="vertical-align: middle;">' + l.p2 + "x</span></span>"), 0 != l.p2f && (c += '<span><img style="margin-right: 2px;margin-bottom: 2px;" class="tw2gui-iconset tw2gui-icon-question-priority-2" src="/images/tw2gui/pixel-vfl3z5WfW.gif"><span style="vertical-align: middle;">' + l.p2f + "x</span></span>"), 0 != l.p1 && (c += '<span><img style="margin-right: 2px;margin-bottom: 2px;" class="tw2gui-iconset tw2gui-icon-exclamation-priority-1" src="/images/tw2gui/pixel-vfl3z5WfW.gif"><span style="vertical-align: middle;">' + l.p1 + "x</span></span>"), 0 != l.p1f && (c += '<span><img style="margin-right: 2px;margin-bottom: 2px;" class="tw2gui-iconset tw2gui-icon-question-priority-1"; src="/images/tw2gui/pixel-vfl3z5WfW.gif"><span style="vertical-align: middle;">' + l.p1f + "x</span></span>"), c += "</div></div>",
                  (TWIR.npcLoaded && null == r[o].quests || 0 == l.tot) && (c = "");
                var A = TWIR.npcLoaded && null != r[o].quests && 0 != l.tot ? '<span title="' + c.escapeHTML() + '" style="display: inline-block;margin-top: 3px;color: #5e321a;position: relative;float: right;font-size: 12px;">|&nbsp;' + l.tot + "&nbsp;" + TWIRlang.tooltips.quests + "</span>" : "";
                t.addItem(0, '<img src="/images/quest/employer/' + r[o].key + '.png" height="22px;" width="auto" style="left: 2px;border-radius: 5px;""><span title= "' + p + '"style="margin-left: 20px;color: #5e321a; text-overflow: ellipsis;white-space: nowrap;overflow: hidden;word-wrap: break-word; margin-top: 2px; max-width: ' + (TWIR.npcLoaded && null != r[o].quests && 0 != l.tot ? "150px" : "250px") + ';display: inline-block;">' + n + "</span>" + A, (new west.gui.Selectbox).setHeader(n.cutIt(16)).setWidth(180).addItem([1,
                  r[o]
                ], '<span style="color: #5e321a;">' + TWIRlang.menulink.window_open + "</span>").addItem([2,
                  r[o]
                ], '<span style="color: #5e321a;">' + TWIRlang.menulink.map_show + "</span>").addItem([3,
        ...
        if (!LinearQuestHandler.hasTutorialQuest())
        {
          ...
          try
          {
            var t = $('<div class="twir_charlink-container" style="display: none;height: 89px;background-position: -141px -55px;"></div>'),
              i = $('<div class="twir_charlink-arrow_right" style="position:absolute;top:20px;left:180px;height:25px;display:block;border:0 solid rgba(0,0,0,0);background-clip:content-box;z-index:15;width:12px;background-size:10px 25px;"></div>');
            ...
            var a = $('<div class="twir_charlink-link" title="' + TWIRlang.menulink.sleep + '" style="background: url(' + TWIR.images.menulink.sleep + ') no-repeat 0px 0px transparent; top: 2px;left: 6px;background-position: 0px 0px;"></div>').appendTo(t);
      ...
      Inventory:
      {
        ...
        as_reset: function()
        {
          return this.data.searchType = "none", this.data.order = localStorage && localStorage.hasOwnProperty("twir_sort") ? JSON.parse(localStorage.getItem("twir_sort")) : ["sort_id", "asc"], this.data.filter = ["none", !1], this.data.invSearchVal = null, "done"
        },
        ss_reset: function()
        {
        ...
        setInv: function()
        {
          ...
          Inventory.uid = "inventory",
            ...
            Inventory.width = 608, Inventory.availableCategories = ["new", "head", "neck", "body", "pants", "belt", "foot", "right_arm", "left_arm", "animal"], Inventory.addedCategories = ["bonus", "useable", "buff", "craft", "work", "quest"], Inventory.defaultCategory = "new", Inventory.latestSize = 66,
          ...
          return upButtonString && upButtonString[1] && (upButtonString = upButtonString[1]),
            ...
            oldFL = oldFL.replace(upButton, "Inventory.guiElements.upgradeButton=new west.gui.Iconbutton(TWIR.images.upgradeicon, west.window.item_upgrade.open, west.window.item_upgrade, null, null).setTitle(upTitle).addClass('upgrade_items');"), oldFL = oldFL.replace(/Inventory\.guiElements\.searchShowButton\s{0,1}\=\s{0,1}new west\.gui\.Iconbutton\(new west\.gui\.Icon\('search'\),\s{0,1}function\(\)\s{0,1}\{/, "Inventory.guiElements.searchShowButton=new west.gui.Iconbutton(new west.gui.Icon('search'),function(){").replace(/Inventory\.showCategory\('set'\);/, "TWIR.Inventory.showSearch();").replace(/\.addClass\('open_search'\)/, ".addClass('open_search').addClass('twir_searchButton')"),
            oldFL = oldFL.replace(/Inventory\.window\.appendToContentPane\([\w\W]*Inventory\.DOM\s{0,1}\=\s{0,1}Inventory\.window\.\$\('div\.tw2gui_window_content_pane'\);/, "Inventory.guiElements.scrollPane=new west.gui.Scrollpane().appendContent($(\"<div id='bag'></div>\"));Inventory.window.appendToContentPane($filters,$(\"<div id='twir_content_pane' style='width: 700px!important;height: 355px!important;overflow: hidden; position: absolute;top: 100px;'></div>\").append(Inventory.guiElements.scrollPane.getMainDiv()),$(\"<div class='instant_wear_container'></div>\").append(Inventory.guiElements.instantWearButton.getMainDiv()),$('<div class=\"actions\"></div>').append(Inventory.guiElements.upgradeButton.getMainDiv(),Inventory.guiElements.searchShowButton.getMainDiv()));Inventory.DOM=Inventory.window.$('div.tw2gui_window_content_pane');"), eval("Inventory.firstLoad=(function(){ var upTitle=upButtonString; return " + oldFL + "})();"),
            ...
            }, Inventory.showSearch = function()
            {
              try
              {
                ...
                setTimeout(function()
                {
                  for (var e = 0; e < i; ++e) Bag.getItemCount(Inventory.searchResult[e].obj.item_id) && Inventory.addItemDivToInv(Inventory.searchResult[e]),
                    t++;
                  Inventory.window.hideLoader(),
                    0 == t && $('<div style="margin:auto;"><span style="margin:auto; font-weight:bold;text-align: center!important;color: #4d392c!important;">' + TWIRlang.informative.error404 + "</span></div>").appendTo($("#bag", Inventory.DOM))
                }, i > 132 ? 100 : 0)
              }
              catch (e)
              {}
            ...
            {
              switch ($("#bag", Inventory.DOM).empty(), e = e || Inventory.defaultCategory, Inventory.setCategoryActive(e), $(Inventory.DOM).removeClass("search_enabled instant_wear_enabled"), "set" !== e && Inventory.clearSearch(), "custom" !== e && "sets" !== e && Inventory.clearCustom(), "twir" !== e && ($("#bag", Inventory.DOM).empty(), self.data.lastItems = []), e)
              {
                case "new":
                  Inventory.showLastItems(),
                    void 0 !== Inventory.guiElements.scrollPane && Inventory.guiElements.scrollPane.verticalBar.move(0, !1, !0), self.repTitle("TWIR - " + TWIRlang.invent, "TWIR");
                  break;
                case "twir":
                  self.showItems(),
            ...
            Inventory.updateFilters = function()
            {
              ...
              for (var n = 0; n < a.length; n++) t[a[n] + "_count"] < 1 ? ($(".filter_" + a[n]).addClass("no-items"), $(".filter_" + a[n]).unbind("mouseenter"), $(".filter_" + a[n]).unbind("mouseleave")) : ($(".filter_" + a[n]).removeClass("no-items"), $(".filter_" + a[n]).mouseenter(function()
              {
                $(this).css(
                {
                  filter: "opacity(100%)",
              ...
              for (var r = 0; r < i.length; r++) Bag.getItemsByType(i[r]).length < 1 && "new" !== i[r] ? ($(".inventory .filters .filter_" + i[r]).unbind("mouseenter"), $(".inventory .filters .filter_" + i[r]).unbind("mouseleave"), $(".inventory .filters .filter_" + i[r] + ".active").unbind("mouseenter"), $(".inventory .filters .filter_" + i[r] + ".active").unbind("mouseleave")) : ($(".inventory .filters .filter_" + i[r]).mouseenter(function()
              {
                $(this).css(
                {
                  filter: "opacity(100%)",
        ...
        {
          TWIR.storage.get("inv_window_minititle") ? Inventory.window.setMiniTitle(t.cutIt(50)) : Inventory.window.setMiniTitle("TWIR"), TWIR.storage.get("inv_window_title") ? Inventory.window.setTitle('<span style="margin-top: 4px; font-size: 16pt;">' + e.replace("*", "").replace("#", "").cutIt(50) + "</span>") : Inventory.window.setTitle('<span style="margin-top: 4px; font-size: 16pt;">TWIR - ' + TWIRlang.invent + "</span>"), TWIR.isJokeTime() && this.joke_title()
        },
        joke_title: function()
        {
        ...
        injectTrader: function()
        {
          tw2widget.TraderItem.prototype.twir_Collections = function()
          {
            ...
            return this.divMain.find(".twir_collectible").remove(),
              TWIR.marketWatcher.missing.includes(e) && !1 === TWIR.marketWatcher.getBuyed(t) && this.divMain.append('<img class="tw2gui-iconset tw2gui-icon-achievement twir_collectible" src="/images/tw2gui/pixel-vfl3z5WfW.gif" title="' + TWIRlang.tooltips.collection + '" style="position:absolute;top:0px;right:0px;padding:0px;border:0px;margin:0px;" />'), this.divMain
          };
        ...
        showSearch: function()
        {
          ...
          try
          {
            ...
            var t = this.gui.searchShowButton.getMainDiv(),
              ...
              s = Inventory.guiElements.searchTextfield = new west.gui.Textfield("inventory_search").maxlength(24).setPlaceholder(Inventory.categoryDesc.set + ".. [Enter]").setWidth(150);
            ...
            W.addItem("asc", TWIRlang.organizing.sort_up), W.addItem("desc", TWIRlang.organizing.sort_down),
              ...
              {
                R.isSelected() && void 0 !== localStorage ? localStorage.setItem("twir_sort", JSON.stringify(e.data.order)) : R.isSelected() || void 0 === localStorage ? (new UserMessage(TWIRlang.informative.storage_error + "!", UserMessage.TYPE_ERROR).show(), R.setEnabled(!1)) : localStorage.removeItem("twir_sort")
              }), T.addListener(function(t)
              {
                e.data.order[0] = t,
                  Inventory.update(), R.isSelected() && void 0 !== localStorage ? localStorage.setItem("twir_sort", JSON.stringify(e.data.order)) : R.isSelected() || void 0 === localStorage ? (new UserMessage(TWIRlang.informative.storage_error + "!", UserMessage.TYPE_ERROR).show(), R.setEnabled(!1)) : localStorage.removeItem("twir_sort")
            ...
            S.setX(i - S.getMainDiv().width()), S.setTitle('<span style="margin-top: 4px; font-size: 16pt;">' + TWIRlang.inventory.search + '</span><a id="twir_as_stats" title="' + TWIRlang.stats.stats + '" style="background: url(' + TWIR.images.statsIcon + ') no-repeat;position: relative;text-align: center;display: inline-block;margin-left: 10px;width: 16px;height: 16px;cursor: help;"></a>'), S.getMainDiv().find(".tw2gui_inner_window_title").append($('<div title="' + TWIRlang.informative.hide + '" class="tw2gui_window_buttons_close" style="position: absolute;right: 6px;top: 8px;"></div>').click(function()
            {
          ...
          for (var i = [], a = this.data.filter[1], n = 0; n < e.length; n++)
          {
            ...
            switch ("filt_" + t)
            {
              ...
              case "filt_upgradeable":
                ...
                break;
              case "filt_tradeable":
                1 == r.obj.tradeable && r.obj.traderlevel <= 20 && 0 == a ? i.push(r) : (0 == r.obj.tradeable || r.obj.traderlevel > 20) && 1 == a && i.push(r);
                break;
              case "filt_dropable":
              ...
              case "filt_from_set":
                ...
                break;
              case "filt_gender":
                null === r.obj.characterSex && null === r.obj.characterClass || 0 != a ? null == r.obj.characterSex && null == r.obj.characterClass && 1 == a && i.push(r) : i.push(r);
                break;
              case "filt_colls":
                TWIR.storage.inventory.collectibles.indexOf(r.obj.item_base_id) > -1 && 0 == a ? i.push(r) : TWIR.storage.inventory.collectibles.indexOf(r.obj.item_base_id) < 0 && 1 == a && i.push(r);
                break;
              case "filt_upgraded":
        ...
        setsButton: function()
        {
          ...
          try
          {
            this.gui.setShowButton || (this.gui.setShowButton = new west.gui.Iconbutton(new west.gui.Icon("shirt")).addClass("twir_setShowButton").setTitle(TWIRlang.inventory.sets).getMainDiv()),
              $(".actions", Inventory.DOM).append(this.gui.setShowButton),
              $(".twir_setShowButton").css("cssText", "position: absolute !important;right: 5px; display: inline-block;"), $(e.gui.setShowButton).on("click", function(t)
              {
          ...
          try
          {
            ...
            switch (t)
            {
              ...
              case "other":
                ...
                b && n.length < 6 ? i.push(b.image) : (g && i.push(g.image), d && i.push(d.image), !d && w && i.push(w.image), w && "set_sleeper" === w.set ? i.push(w.image) : m ? i.push(m.image) : b ? i.push(b.image) : h ? i.push(h.image) : u && i.push(u.image))
            }
            return i
          }
          catch (e)
        ...
        makeSetsSelect: function(e, t, i)
        {
          ...
          try
          {
            ...
            var n = $('<div style="text-align: center;"/>'),
              ...
              s = $('<span id="twir_sets_weapons" title="' + TWIRlang.inventory.weapons + '" style="border: 2px solid #6B5A3F;border-radius: 8px;height: 50px;width: 50px;display: inline-block; margin: 5px; cursor: pointer;position: relative;"/>');
            s.click(function(t)
            {
            ...
            var l = $('<span id="twir_sets_clothes" title="' + TWIRlang.inventory.clothes + '" style="border: 2px solid #6B5A3F;border-radius: 8px;height: 50px;width: 50px;display: inline-block; margin: 5px; cursor: pointer; position: relative;"/>');
            l.click(function(t)
            {
            ...
            var p = $('<span id="twir_sets_ride" title="' + TWIRlang.inventory.ride + '" style="border: 2px solid #6B5A3F;border-radius: 8px;height: 50px;width: 50px;display: inline-block; margin: 5px; cursor: pointer; position: relative;"/>');
            p.click(function(t)
            {
            ...
            var c = $('<span id="twir_sets_other" title="' + TWIRlang.inventory.other_sets + '" style="border: 2px solid #6B5A3F;border-radius: 8px;height: 50px;width: 50px;display: inline-block; margin: 5px; cursor: pointer; position: relative;"/>');
            c.click(function(t)
            {
            ...
            {
              var v = '<span style="vertical-align: middle;display: inline-block;margin-bottom: 2px;margin-right: 2px;"><img src="' + TWIR.images.gameEvents[b[x].key] + '" height="16" width="auto"/></span>';
            ...
            var y = this.gui.setsDialog = new west.gui.Dialog(TWIRlang.inventory.sets, n).setDraggable(!0).setId("twir_sm").setBlockGame(!1).setPosition(t, i).show();
            y.setX(t - y.getMainDiv().width()), $(".tw2gui_inner_window_title", y.getMainDiv()).find(".textart_title").css(
              {
                "margin-top": "4px",
                "font-size": "16pt"
              }), y.getMainDiv().find(".tw2gui_inner_window_title").append($('<div title="' + TWIRlang.informative.hide + '" class="tw2gui_window_buttons_close" style="position: absolute;right: 6px;top: 8px;"></div>').click(function()
              {
        ...
        itemShowcase: function(e, t, i)
        {
          function a(a)
          {
            ...
            if (i)
            {
              ...
              if (o && (l = '<img style="position: relative;' + ("right_arm" === a || "left_arm" === a ? "max-height: 58px" : "max-height: 38px") + ';width: auto;margin: auto;display: block;" src="' + ("left_arm" === a || "right_arm" === a ? o.wear_image : o.image) + '"/>'), o) return {
                img: l,
                lvl: 0
              }
            }
            else
            {
              ...
              if ((n || r) && (s = '<img style="position: relative;' + ("right_arm" === a || "left_arm" === a ? "max-height: 58px" : "max-height: 38px") + ";width: auto;margin: auto;display: block;" + (r ? "opacity: 0.6" : "opacity: 1") + ';" src="' + (n ? "left_arm" === a || "right_arm" === a ? n.obj.wear_image : n.obj.image : "left_arm" === a || "right_arm" === a ? r.obj.wear_image : r.obj.image) + '"/>'), n || r) return {
                img: s,
                lvl: n ? n.obj.item_level : r.obj.item_level
              }
            }
            var w = "right_arm" === a || "left_arm" === a ? '<img style="position: relative;max-height: 58px;width: auto;margin: auto;display: block;" src="/images/inventory/default/' + a + '_blank.png" />' : '<img style="position: relative;max-height: 38px;width: auto;margin: auto;display: block;" src="/images/inventory/default/' + a + '_blank.png" />';
            return {
              img: w,
              lvl: 0
            }
        ...
        fullBonusTooltip: function(e, t, i)
        {
          ...
          {
            var r, o, s, l;
            if (a.indexOf("_sector") > -1 && (l = !0, a = a.replace("_sector", ""), t && (t = t.replace("_sector", ""))), e && (r = TWIR.images[e]), r && (o = r[a]), !o && !$.isNumeric(a)) return "";
            $.isNumeric(a) && (s = JobsModel.getById(Number(a)));
            var p = '<div style="width: 34px;height: 50px;position: relative;background: rgba(127, 111, 85, 0.7);display: inline-block;margin-top: 5px;margin-right: 5px;">';
            return i && (p = '<div style="width: 25px;height: 30px;position: relative;background: rgba(127, 111, 85, 0.7);display: inline-block;margin-right: 2px;">'), p += '<img src="' + (o || (s ? "/images/jobs/" + s.get("shortname") + ".png" : "/images/items/unknown.png")) + '" style="position: absolute; ' + (CharacterSkills.allSkillKeys.includes(a) ? i ? "top: 4px; width: 22px; right: 2px;" : "top: 8px; width: 34px; right: 0;" : (i ? "width: 18px;" : "width: 28px;") + "left: 3px;right: 4px;top: 3px;") + '"/>',
              l && (p += '<div style="width: 9px;height: 9px;position: absolute;right: 1px;bottom: ' + (i ? "11px" : "18px") + "; background: url(" + TWIR.images.sector + ');"></div>'),
              p += '<div style="background: url(/images/tw2gui/pagebar/bg.png);' + (i ? "width: 24px;height: 10px;position: absolute;line-height: 12px;font-size:" + (n.toString().length > 3 ? "8px;" : "10px;") : "width: 34px;height: 17px;position: absolute;line-height: 17px;font-size: 11px;") + "bottom: 0;" + (t && t === a ? "color: #26ff00;" : "color: #FFE7B1") + ';text-align: center;">' + (n || 0) + (["dollar", "experience", "luck", "drop", "regen", "ms"].includes(a) ? "%" : "") + "</div>", p += "</div>"
          }
            ...
            if (sets = this.getSetMenuSorted(sets), isDefined(west.storage.ItemSetManager) && sets.length)
              for (var complete_count = 0, n = 0; n < sets.length; n++)
              {
                ...
                var wanted = this.data.searchVal,
                  ...
                  wantedEvent = "all" === eventW || (!("all" === eventW || !TWIR.storage.setList.eventIcons[t.key] || TWIR.storage.setList.eventIcons[t.key][
                    0
                ...
                if (wantedEvent && (null === wanted || this.getSetsSearch(t, skills)))
                {
                  ...
                  for (var ownedColor = diffArr.length ? "#8b4513" : "#800080",
                      ...
                      ownedOpacity = diffArr.length && 1 === invItems.length && t.items.length >= 4 ? .5 : 1, event = TWIR.storage.setList.eventIcons[t.key],
                      setGameEventIcon = TWIR.storage.setList.eventIcons[t.key] ? TWIR.images.gameEvents[event[0]] : "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7",
                      setGameEventText = TWIR.storage.setList.eventIcons[t.key] ? "(" + event[1] + ")" : "",
                      setGameEventTitle = TWIR.storage.setList.eventIcons[t.key] && !Array.isArray(TWIRlang.keyWords[event[0]]) ? TWIRlang.keyWords[event[0]] : TWIR.storage.setList.eventIcons[t.key] && Array.isArray(TWIRlang.keyWords[event[0]]) ? TWIRlang.keyWords[event[0]][
                        0
                      ] : "",
                      missingTitle = missingItems.length > 0 ? '<div style="color: #8b4513;margin-bottom: 10px;">' + TWIRlang.tooltips.missing_items + ":</div>" : "",
                  ...
                  node.append($('<span title="' + ownedBonusTitle.escapeHTML() + '" style="display: inline-block; height: 20px; width: 32px;vertical-align: top;position: relative;"><img style="left: 0px; right: unset;opacity: ' + featOpacity + ';display: inline-block;" src="' + itemicon + '" height="20" width="auto"></img><img title="' + setGameEventTitle.escapeHTML() + "&nbsp;" + setGameEventText + '" style="display: ' + featEventDisplay + ';right: 0px;bottom: 0px;" src="' + setGameEventIcon + '" height="16" width="auto"></img></span>')), node.append($('<span style="margin-top: 2px;word-wrap: break-word;max-width: 230px;display: inline-block;margin-left: 5px; text-overflow:ellipsis; white-space:nowrap; overflow:hidden;opacity: ' + featOpacity + ";color: " + featNameColor + ';vertical-align: middle;">' + nameQuotesFix + "</span>").data("items", t.items.join(",")).mouseenter(function()
                    ...
                    node.append($('<span title="' + missingTitle.escapeHTML() + '" style="display: inline-block;margin-top: 3px;color: ' + featColor + ";position: relative;font-size: 12px;font-style: italic;float: right;opacity: " + featOpacity + ';">' + ownedCount + "</span>")),
          ...
          Bag.search = function(t)
          {
            if (Bag.loaded)
            {
              var i = new RegExp("^.*" + t + "(.*)$", "i"),
                ...
                n = [],
                r = "";
              for (var o in TWIRlang.keyWords)(void 0 !== TWIRlang.keyWords[o] && Array.isArray(TWIRlang.keyWords[o]) && TWIRlang.keyWords[o].findIndex(function(e)
              {
              ...
              }) || !Array.isArray(TWIRlang.keyWords[o]) && TWIRlang.keyWords[o].toLowerCase() === t.toLowerCase().replace(/[0-9\%\+\:\-\$\.]/g, "").replace(/(\(|\)).*/g, "").trim()) && (r = t.replace(/[^0-9.]/g, "").replace(/(\(|\)).*/g, "").trim(), t = o);
              return west.common.forEach(a, function(a, o)
              {
                ...
                if (!r.length && c) switch (t.toLowerCase())
                {
                  ...
                  case "pb":
                    for (var A = 0; A < p.length; A++)
                      (p[A].type && "job" === p[A].type && "all" === p[A].job || s(p[A].bonus) && "job" === p[A].bonus.type && "all" === p[A].bonus.job) && n.push(a);
                    break;
                  case "resistance":
                    for (var A = 0; A < p.length; A++)
                      (p[A].type && "fortbattle" === p[A].type && "resistance" === p[A].name || s(p[A].bonus) && "fortbattle" === p[A].bonus.type && "resistance" === p[A].bonus.name) && n.push(a);
                    break;
                  case "damage":
                  case "dmg":
                    for (var A = 0; A < p.length; A++)
                      (p[A].type && "fortbattle" === p[A].type && "damage" === p[A].name || s(p[A].bonus) && "fortbattle" === p[A].bonus.type && "damage" === p[A].bonus.name) && n.push(a);
                    break;
                  case "defense":
                  case "def":
                    for (var A = 0; A < p.length; A++)
                      (p[A].type && "fortbattle" === p[A].type && "defense" === p[A].name || s(p[A].bonus) && "fortbattle" === p[A].bonus.type && "defense" === p[A].bonus.name) && n.push(a);
                    break;
                  case "offense":
                  case "off":
                    for (var A = 0; A < p.length; A++)
                      (p[A].type && "fortbattle" === p[A].type && "offense" === p[A].name || s(p[A].bonus) && "fortbattle" === p[A].bonus.type && "offense" === p[A].bonus.name) && n.push(a);
                    break;
                  case "speed":
                  case "ms":
                    for (var A = 0; A < p.length; A++)
                  ...
                  case "pray":
                    ...
                    break;
                  default:
                    i.test(l.item_id) || i.test(l.name) || null !== l.set && i.test(west.storage.ItemSetManager.get(l.set).name) || Bag.searchAttrib(l.bonus, i) || Bag.searchUseBonus(l, i) || t == l.level || void 0 !== l.profession && i.test(l.profession) ? n.push(a) : (TWIR.storage.setList.eventIcons[l.set] && TWIR.storage.setList.eventIcons[l.set]
                      [
                        1
        ...
        {
          var t = this,
            i = ($('<span title="<b>' + TWIRlang.donate_title + '</b>" id="twir_menu" style="background-image: url(' + TWIR.images.menuicon + ');cursor: pointer;position: relative;z-index: 9999991;background-repeat: no-repeat;width: 20px;height: 20px;display: inline-block;float: left;"</span>').appendTo(".inventory .tw2gui_window_buttons").click(function(e)
            {
              TWIR.menu.open("Donate")
            }), $('<div class="twir_enchanted_filters ui-state-default" style="display: inline-block; position: absolute; width: auto; height: 40px;top: 55px;right:13px;border-radius: 3px;-webkit-box-shadow: 0 0 20px inset;box-shadow: 0 0 20px inset;border: 3px solid #4d392c;background-image: url(' + TWIR.images.menubg + ");padding-right: 5px;padding-left: 5px;border: 3px solid transparent;-webkit-border-image: url(" + TWIR.images.menuborder + ') 0 0 stretch;"></div>')),
          ...
          $('<span title="' + TWIRlang.inventory.useable + '" class="filter_inventory filter_useable" style= "-webkit-filter: opacity(75%); filter: opacity(75%);"></span>').appendTo(i).click(function(e)
          {
            TWIR.invSelect(e, TWIR.storage.inventory.use, "useable")
          }), $('<span title="' + TWIRlang.inventory.buffs + '" class="filter_inventory filter_buff" style="-webkit-filter: opacity(75%); filter: opacity(75%);"></span>').appendTo(i).click(function(e)
          {
            TWIR.invSelect(e, TWIR.storage.inventory.buffs, "buffs")
          }), $('<span title="' + TWIRlang.inventory.crafting + '" class="filter_inventory filter_craft" style="-webkit-filter: opacity(75%); filter: opacity(75%);" ></span>').appendTo(i).click(function(e)
          {
            TWIR.invSelect(e, TWIR.storage.inventory.crafting, "crafting")
          });
          var n = $('<span title="' + TWIRlang.inventory.equipment + '" class="filter_inventory filter_bonus" style="-webkit-filter: opacity(75%); filter: opacity(75%);" ></span>').appendTo(a),
            r = $('<span title="' + TWIRlang.inventory.work_items + '" class="filter_inventory filter_work" style="-webkit-filter: opacity(75%); filter: opacity(75%);" ></span>').appendTo(a),
            o = $('<span title="' + TWIRlang.inventory.quest_items + '" class="filter_inventory filter_quest" style="-webkit-filter: opacity(75%); filter: opacity(75%);" ></span>').appendTo(a);
          r.click(function(e)
          {
      ...
      comboCalc:
      {
        ...
        showCase: function(e, t)
        {
          function i(i)
          {
            ...
            var g = "";
            if ((a || n) && (g = "javascript:void(TWIR.Inventory.wear(event, " + (a ? a.obj.item_id : n.obj.item_id) + ", this))"), (a || n) && (r = '<img onclick="' + g + '" data-item-id="' + (a ? a.obj.item_id : n.obj.item_id) + '" title="' + new ItemPopup(ItemManager.get(a ? a.getId() : n.getId())).getXHTML().escapeHTML() + '" style="position: relative;' + ("right_arm" === i || "left_arm" === i ? t ? "max-height: 40px" : "max-height: 90px" : t ? "max-height: 40px" : "max-height: 56px") + ";width: auto;margin: auto;display: block;" + (n ? "opacity: 0.3" : "opacity: 1") + ';" src="' + (a ? "left_arm" === i || "right_arm" === i ? a.obj.wear_image : a.obj.image : "left_arm" === i || "right_arm" === i ? n.obj.wear_image : n.obj.image) + '"/>' + (a && 0 !== a.obj.item_level || n && 0 !== n.obj.item_level ? '<span class="item_level" style="' + (n ? "opacity: 0.3" : "opacity: 1") + ';">' + (a ? a.obj.item_level : n.obj.item_level) + "</span>" : "")), a || n) return {
              img: r
            };
            var d = '<img style="position: relative;' + ("right_arm" === i || "left_arm" === i ? t ? "max-height: 40px" : "max-height: 90px" : t ? "max-height: 40px" : "max-height: 58px") + ';width: auto;margin: auto;display: block;" src="/images/inventory/default/' + i + '_blank.png" />';
            return {
              img: d
            }
          }
          var a = "";
          return a += '<div class="item" style="' + (t ? "width: 44px;height: 44px;position: relative;background: none;display: inline-block;margin-right: 5px; margin-top: 2px;" : "position:absolute;left: 62px;height: 60px;width: 60px;background: none;") + '"><img style="position: absolute;' + (t ? "height: 44px;width: 44px;left: 0;top: 0;" : "height: 60px;width: 60px;left: 0;top: 0;") + '" src="/images/inventory/foot_head_animal.png" >' + i("head").img + "</div>", a += '<div class="item" style="' + (t ? "width: 44px;height: 44px;position: relative;background: none;display: inline-block;margin-right: 5px; margin-top: 2px;" : "position:absolute;left: 124px;height: 60px;width: 60px;background: none;") + '"><img style="position: absolute;' + (t ? "height: 44px;width: 44px;left: 0;top: 0;" : "height: 60px;width: 60px;left: 0;top: 0;") + '" src="/images/inventory/foot_head_animal.png" >' + i("neck").img + "</div>", a += '<div class="item" style="' + (t ? "width: 44px;height: 44px;position: relative;background: none;display: inline-block;margin-right: 5px; margin-top: 2px;" : "position:absolute;left: 62px;top: 62px;height: 60px;width: 60px;background: none;") + '"><img style="position: absolute;' + (t ? "height: 44px;width: 44px;left: 0;top: 0;" : "height: 60px;width: 60px;left: 0;top: 0;") + '" src="/images/inventory/foot_head_animal.png" >' + i("body").img + "</div>", a += '<div class="item" style="' + (t ? "width: 44px;height: 44px;position: relative;background: none;display: inline-block;margin-right: 5px; margin-top: 2px;" : "position:absolute;left: 62px;bottom: 0px;height: 60px;width: 60px;background: none;") + '"><img style="position: absolute;' + (t ? "height: 44px;width: 44px;left: 0;top: 0;" : "height: 60px;width: 60px;left: 0;top: 0;") + '" src="/images/inventory/foot_head_animal.png" >' + i("pants").img + "</div>", a += '<div class="item" style="' + (t ? "width: 44px;height: 44px;position: relative;background: none;display: inline-block;margin-right: 5px; margin-top: 2px;" : "position:absolute;left: 124px;top: 62px;height: 60px;width: 60px;background: none;") + '"><img style="position: absolute;' + (t ? "height: 44px;width: 44px;left: 0;top: 0;" : "height: 60px;width: 60px;left: 0;top: 0;") + '" src="/images/inventory/foot_head_animal.png" >' + i("belt").img + "</div>", a += '<div class="item" style="' + (t ? "width: 44px;height: 44px;position: relative;background: none;display: inline-block;margin-right: 5px; margin-top: 2px;" : "position:absolute;left: 124px;bottom: 0px;height: 60px;width: 60px;background: none;") + '"><img style="position: absolute;' + (t ? "height: 44px;width: 44px;left: 0;top: 0;" : "height: 60px;width: 60px;left: 0;top: 0;") + '" src="/images/inventory/foot_head_animal.png" >' + i("foot").img + "</div>", a += '<div class="item" style="' + (t ? "width: 44px;height: 44px;position: relative;background: none;display: inline-block;margin-right: 5px; margin-top: 2px;" : "position:absolute;top: 20px;height: 100px;width: 60px;background: none;") + '"><img style="position: absolute;' + (t ? "height: 44px;width: 44px;left: 0;top: 0;" : "height: 100px;width: 60px;left: 0;top: 0;") + '" src="/images/inventory/foot_head_animal.png" >' + i("right_arm").img + "</div>", a += '<div class="item" style="' + (t ? "width: 44px;height: 44px;position: relative;background: none;display: inline-block;margin-right: 5px; margin-top: 2px;" : "position:absolute;right: 0px;top: 20px;height: 100px;width: 60px;background: none;") + '"><img style="position: absolute;' + (t ? "height: 44px;width: 44px;left: 0;top: 0;" : "height: 100px;width: 60px;left: 0;top: 0;") + '" src="/images/inventory/foot_head_animal.png" >' + i("left_arm").img + "</div>", a += '<div class="item" style="' + (t ? "width: 44px;height: 44px;position: relative;background: none;display: inline-block;margin-right: 5px; margin-top: 2px;" : "position:absolute;bottom: 0px;height: 60px;width: 60px;background: none;") + '"><img style="position: absolute;' + (t ? "height: 44px;width: 44px;left: 0;top: 0;" : "height: 60px;width: 60px;left: 0;top: 0;") + '" src="/images/inventory/foot_head_animal.png" >' + i("animal").img + "</div>", a += '<div class="item" style="' + (t ? "width: 44px;height: 44px;position: relative;background: none;display: inline-block;margin-right: 5px; margin-top: 2px;" : "position:absolute;right: 0px;bottom: 0px;height: 60px;width: 60px;background: none;") + '"><img style="position: absolute;' + (t ? "height: 44px;width: 44px;left: 0;top: 0;" : "height: 60px;width: 60px;left: 0;top: 0;") + '" src="/images/inventory/foot_head_animal.png" >' + i("yield").img + "</div>"
        },
        calcStats: function()
        {
          var e = this,
        ...
        loadMore: function(e)
        {
          if ((e = e || TWIR_calc.result).length)
          {
            ...
            this.gui.lmCount = $('<span style="position: absolute;right: 40px; bottom: 0px;font-size: 11px;">' + TWIRlang.calc.combo_count.replace("$1", i).replace("$2", e.length) + "</span>"), this.gui.loadMore.on("click", function(r)
              {
                r.preventDefault(),
        ...
        appendRes: function(e, t)
        {
          ...
          s += TWIR.Inventory.fullBonusTooltip(o, !1), n.line = $('<div style="display: inline-block;position: relative;width: 490px;height: 30px;font-family: Arial,Verdana,sans-serif;font-weight: bold;color: rgb(58,46,16);cursor: pointer;"></div>').data("id", a);
          var l, p, c, A = $('<span style="position: absolute;left: 5px;top: 8px;">' + TWIRlang.calc.equipment_number.replace("$1", "#" + (a + 1)) + ":</span>").mouseenter(function()
            {
            ...
            g = $('<span style="float: right";>' + TWIR.Inventory.fullBonusTooltip(e.stats ? TWIR_calc.mergeBonus(e.stats) : o, !1, !0) + "</span>").mouseenter(function()
            {
              $(this).hasClass("hasMousePopup") || $(this).addMousePopup(s)
            });
          n.cont = $((l = r, p = a, c = $('<div id="twir_bw_' + p + '" style="display: inline-block;width: 490px;height: 50px; margin-bottom: 4px;padding-left: 2px;"></div>'), c.append(i.showCase(l, !0)), c)).data("id", a), n.items = r, i.gui.resultHtml.push(n),
        ...
        loadPreset: function()
        {
          this.gui.presetDiv.empty(), this.gui.presetSel = {},
            this.gui.presetSel.lvl = (new west.gui.Textfield).onlyNumeric().maxlength(3).setValue(TWIR_calc.preset.level).setWidth(75), this.gui.presetSel.lvl.getField().on("input paste", TWIR.delay(function(e)
            {
          ...
          e.setCallback(function()
            ...
            }), e.setSelected("shot" === TWIR_calc.preset.weapon || "none" === TWIR_calc.preset.weapon, !0), t.setCallback(function()
            {
              t.isSelected() || e.isSelected() || e.toggle(),
                TWIR_calc.preset.weapon = e.isSelected() && t.isSelected() ? "none" : e.isSelected() ? "shot" : "hand"
            }), t.setSelected("hand" === TWIR_calc.preset.weapon || "none" === TWIR_calc.preset.weapon, !0), this.gui.presetDiv.append($('<div style="position: absolute; top: 40px; left: 10px;max-width: 130px;"/>').append('<div style="font-weight: bold;">' + TWIRlang.calc.level + "</div>", this.gui.presetSel.lvl.getMainDiv())),
            this.gui.presetDiv.append($('<div style="position: absolute;top: 105px; left: 10px;max-width: 130px;"></div>').append(e.getMainDiv(), "<br>", t.getMainDiv()))
        },
        open: function()
        {
          var e = this;
          ...
          this.gui.window = wman.open("twir_comboCalc", null, "escape noreload").setMiniTitle("TWIR - " + TWIRlang.calc.add_name).setSize(760, 431),
            ...
            }), this.gui.window.addTab(TWIRlang.calc.ob, "twir_bw_2", function(i)
            {
              ...
              e.load_bw2(t(a)[0], t(a)[1]), e.reset_bw0(),
                e.reset_bw1()
            }), this.gui.presetDiv = $('<div style="position: absolute;width: 155px;height: 330px;top: -5px;left: 2px;"></div>'), this.gui.resultContent = new west.gui.Scrollpane, this.gui.resultFrame = new west.gui.Groupframe, $("> div.tw2gui_groupframe_background", this.gui.resultFrame.getMainDiv()).css(
            {
              background: "none"
            }), this.gui.pageBar = $('<div class="tw2gui_pagebar" style="height: 18px;"/>'),
            this.gui.resultFrame.appendToContentPane($('<div style="width: 510px;height: 270px;text-align: center;"></div>').append(this.gui.resultContent.getMainDiv()), this.gui.pageBar);
          ...
          i.click(function()
            ...
            }), $(this.gui.window.getContentPane()).append(this.gui.presetDiv, $('<div style="position: absolute;top: -15px;right: 10px;"></div>').append(i.getMainDiv()), $('<div style="position: absolute;top: -10px;left: 158px;width: 10px;height: 349px;background: url(/images/window/report/devider_wood.png) repeat-y center bottom;"/>'), $('<div style="position: absolute;top: 15px; right: 0px;"></div>').append(this.gui.resultFrame.getMainDiv())),
            $(".tw2gui_inner_window_title", this.gui.window.getMainDiv()).empty(), $("div.tw2gui_window_tabbar > .tw2gui_window_tabbar_tabs > .tw2gui_window_tab_active", this.gui.window.getMainDiv()).removeClass("tw2gui_window_tab_active"), this.gui.resultContent.getContentPane().empty(), this.init()
        },
        init: function()
        {
          this.loadPreset(),
        ...
        buttonLogic: function(e, t, i)
        {
          ...
          return a.current_value += r, "object" != typeof TWIR_calc.preset.skills && (TWIR_calc.preset.skills = {}),
            0 === a.current_value ? delete TWIR_calc.preset.skills[n] : TWIR_calc.preset.skills[n] = a.current_value, $(".twir_comboCalc_choose #" + n + " span.displayValue").text(a.current_value),
        ...
        getBonImg: function(e, t, i, a)
        {
          var n = TWIR.images[i]
            [e];
          return n ? '<img style="margin: auto;display: block;margin-right: 2px; ' + (a ? "margin-top: 4px;background: rgba(129,94,17,0.25);padding:" + (28 == t ? "2" : "4") + "px;border-radius: 4px;" : "") + '" src="' + n + '" width="' + t + '"/>' : ""
        },
        getCustomImg: function(e)
        {
          var t = TWIR.images.group4[e] || TWIR.images.group5[e];
          return t ? '<div style="display: block;height: 30px;background: url(' + t + ");width: 30px;background-size: " + (CharacterSkills.allAttrKeys.includes(e) ? 40 : 54) + 'px auto;background-position: center;position: absolute;top: 4px;left: 7px;border-radius: 6px;"></div><div style="background: url(' + TWIR.images.skill_universal + ');background-size: cover;position: absolute;height: 40px;width: 40px;display: block;top: 2px;left: 1px;"></div>' : ""
        },
        reset_bw0: function()
        {
          var e = this.gui.bw0;
          for (var t in e)
            if (e[t].selector)
            {
              ...
              TWIR_calc.preset.skills[t] && delete TWIR_calc.preset.skills[t], "Plusminusfield" === i.component ? (i.selector.setValue(0), $(".twir_comboCalc_choose #" + i.selector.id + " span.displayValue").text(i.selector.current_value), $(".twir_comboCalc_choose #twir_" + i.selector.id + "_displayValue").text(i.selector.current_value), i.selector.toggleMinus(), i.selector.togglePlus()) : "Checkbox" === i.component && i.selector.isSelected() && i.selector.reset()
            }
        },
        reset_bw1: function()
        {
          ...
          for (var t in e)
            ...
            {
              var i = e[t];
              "Combobox" === i.component ? i.selector.select(void 0) : "Checkbox" === i.component && "attack" === i.selector.getValue() && i.selector.setSelected()
            }
        },
        reset_bw2: function(e)
        {
          ...
          for (var i in t)
            ...
            {
              var a = t[i];
              "Checkbox" === a.component && (a.selector.isSelected() && !e && a.selector.reset(), TWIR_calc.preset.skills[i] && delete TWIR_calc.preset.skills[i])
            }
        },
        load_bw2: function(e, t)
        {
          ...
          {
            i.gui.bw2[e] || (i.gui.bw2[e] = {}), i.gui.bw2[e].dom = $('<div title="' + TWIRlang.calc[e] + '" class="twir_bestWear_choose" style="display:inline-block;width: 50px; height: 56px; margin-right: 2px;margin-bottom: 2px;position: relative;">' + i.getBonImg(e, 34, "group2", !0) + '<div style="background: url(' + TWIR.images.skill_universal_nocount + ');background-size: cover;position: absolute;height: 48px;width: 48px;display: block;top: 2px;left: 1px; cursor: pointer;"></div></div>').data("sel", e).appendTo(a),
              i.gui.bw2[e].selector = new west.gui.Checkbox("", "twir_bw_group2").setRadiobutton().setValue(e).setCallback(function(e)
              {
                var t;
                t = this.getValue(),
                  i.reset_bw2(!0), "ms" === t || "construct" === t ? TWIR_calc.preset.skills = t : (TWIR_calc.preset.skills = {}, TWIR_calc.preset.skills[t] = 1)
              }).appendTo(i.gui.bw2[e].dom), (TWIR_calc.preset.skills === e || "object" == typeof TWIR_calc.preset.skills && e in TWIR_calc.preset.skills) && i.gui.bw2[e].selector.setSelected(),
          ...
          }), n.getMainDiv().css(
          {
            "min-width": "unset",
            "min-height": "100px"
          }), n.getMainDiv().append($('<div title="' + TWIRlang.informative.hide + '" class="tw2gui_window_buttons_close" style="position: absolute;right: 6px;top: 8px;"></div>').click(function()
          {
        ...
        load_bw1: function(e, t)
        {
          ...
          var a = ["fort_offense", "fort_defense", "fort_damage", "fort_resistance", "fort_hp"],
            ...
            r = $('<div title="' + TWIRlang.calc.attack + '" style="display:inline-block;width: 50px; height: 50px; margin-right: 2px;position: relative;cursor: pointer;"><img style="margin: auto;display: block; border-radius: 4px;" src="' + TWIR.images.calcSet.attack + '" width="37"/></div>');

          function o(e, t)
          {
            TWIR_calc.preset.side = t
          }
          this.gui.bw1[2] || (this.gui.bw1[2] = {}), this.gui.bw1[2].selector = new west.gui.Checkbox("", "twir_bw_adSel").setRadiobutton().setValue("attack").setCallback(function(e)
            {
              o(e, this.getValue())
          ...
          var s = $('<div title="' + TWIRlang.calc.defense + '" style="display:inline-block;width: 50px; height: 50px; margin-right: 2px;position: relative;cursor: pointer;"><img style="margin: auto;display: block; border-radius: 4px;" src="' + TWIR.images.calcSet.defense + '" width="37"/></div>');
          this.gui.bw1[3] || (this.gui.bw1[3] = {}), this.gui.bw1[3].selector = new west.gui.Checkbox("", "twir_bw_adSel").setRadiobutton().setValue("defense").setCallback(function(e)
            {
              o(e, this.getValue())
            ...
            this.gui.bw1[0] || (this.gui.bw1[0] = {}), this.gui.bw1[0].selector = (new west.gui.Combobox).setWidth(100), this.gui.bw1[0].component = "Combobox", this.gui.bw1[1] || (this.gui.bw1[1] = {}),
            this.gui.bw1[1].selector = (new west.gui.Combobox).setWidth(100), this.gui.bw1[1].component = "Combobox", this.gui.bw1[0].selector.addItem(0, "&#8226;&#8226;&#8226;"), this.gui.bw1[1].selector.addItem(void 0, "&#8226;&#8226;&#8226;"), a.forEach(function(e)
            {
              i.gui.bw1[0].selector.addItem(e, TWIRlang.calc[e])
            }), this.gui.bw1[0].selector.addListener(function(e)
            {
              i.gui.bw1[1].selector.getValue() === e && i.gui.bw1[1].selector.select(void 0), i.gui.bw1[1].selector.items.splice(1), e && (TWIR_calc.preset.skills = e, a.forEach(function(t)
              {
            ...
            }), this.gui.bw1[0].selector.select("string" == typeof TWIR_calc.preset.skills && a.includes(TWIR_calc.preset.skills) ? TWIR_calc.preset.skills : 0), this.gui.bw1[1].selector.select(TWIR_calc.preset.sort), n.append(this.gui.bw1[0].selector.getMainDiv().css(
            {
              "margin-right": "10px"
          ...
          {
            "min-width": "unset"
          }), l.getMainDiv().append($('<div title="' + TWIRlang.informative.hide + '" class="tw2gui_window_buttons_close" style="position: absolute;right: 6px;top: 8px;"></div>').click(function()
          {
        ...
        load_bw0: function(e, t)
        {
          ...
          for (var o in n)
          {
            var s = $('<div title="' + TWIRlang.calc[o] + '" class="twir_comboCalc_choose" style="display:inline-block;width: 40px; height: 40px; margin-bottom: 2px;position: relative;">' + this.getBonImg(o, 28, "group3", !0) + '<div style="background: url(' + TWIR.images.skill_universal + ');background-size: cover;position: absolute;height: 40px;width: 40px;display: block;top: 2px;left: 1px;"></div></div>').data("sel", o).mouseenter(function()
            {
            ...
            this.gui.bw0[o] || (this.gui.bw0[o] = {}), this.gui.bw0[o].selector = new west.gui.Plusminusfield(o, this.gui.bw0[o].selector ? this.gui.bw0[o].selector.getValue() : 0, 0, 5, 0, this.buttonLogic, this.buttonLogic, this.buttonLogic).setWidth(40).appendTo(s), this.gui.bw0[o].component = "Plusminusfield";
            $('<div id="twir_' + o + '_displayValue" style="position: absolute;width: 20px;height: 13px;left: 4px;bottom: 0px;color: #FFF;font-size: 11px;font-weight: bold;text-align: center;text-shadow: #000 1px 1px 1px;">' + this.gui.bw0[o].selector.getValue() + "</div>").appendTo(s);
          ...
          function c(e)
          {
            var t = $('<div title="' + CharacterSkills.keyNames[e] + '" class="twir_comboCalc_choose" style="display:inline-block;width: 40px; height: 40px; margin-bottom: 2px;position: relative;">' + i.getCustomImg(e) + "</div>").data("sel", e).mouseenter(function()
            {
              i.gui.bw0[$(this).data("sel")].selector.getMainDiv().show()
            }).mouseleave(function()
            {
            ...
            i.gui.bw0[e] || (i.gui.bw0[e] = {}), i.gui.bw0[e].selector = new west.gui.Plusminusfield(e, i.gui.bw0[e].selector ? i.gui.bw0[e].selector.getValue() : 0, 0, 5, 0, i.buttonLogic, i.buttonLogic, i.buttonLogic).setWidth(40).appendTo(t), i.gui.bw0[e].component = "Plusminusfield";
            $('<div id="twir_' + e + '_displayValue" style="position: absolute;width: 23px;height: 13px;left: 3px;bottom: 0px;color: #FFF;font-size: 11px;font-weight: bold;text-align: center;text-shadow: #000 1px 1px 1px;">' + i.gui.bw0[e].selector.getValue() + "</div>").appendTo(t);
          ...
          {
            "min-width": "unset"
          }), u.getMainDiv().append($('<div title="' + TWIRlang.informative.hide + '" class="tw2gui_window_buttons_close" style="position: absolute;right: 6px;top: 8px;"></div>').click(function()
          {
            ...
            setTimeout(function()
            {
                ...
                }))
              {
                var t = 0 != Character.homeTown.town_id ? Chat.Resource.Manager.getRoom("room_town_" + Character.homeTown.town_id) : Chat.Resource.Manager.getGeneralRoom(),
                  i = !0 === scriptUpdate.changelog ? '<a target="_blank" href="https://github.com/JamzaSK/TWInventoryReloaded/blob/master/changelog/' + scriptUpdate.TWIR + '.md">[' + TWIRlang.update_changelog + "] </a>" : TWIRlang.changes + ":&nbsp;" + scriptUpdate.TWIRNew,
                  a = TWIRlang.donate_text_2.replace(/\$(.*?)\$/, '<a href="javascript:void(TWIR.menu.open(&quot;Donate&quot;))">$1</a>.&nbsp;' + TWIRlang.tyty + "!"),
                  n = TWIRlang.update_message + "&nbsp;<b>" + TWIRlang.download + ':&nbsp;</b> <a target="_blank" href="' + TWIR.updateAds + '">[' + TWIRlang.ads + '] </a>&nbsp;|&nbsp;<a href="' + TWIR.downloadUrl + '">[' + TWIRlang.no_ads + "]</a><br> /555" + i + "<br> /991" + a;
                ChatWindow.open(t, !0);
