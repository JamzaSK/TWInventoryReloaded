...
! function(e) {
    ...
    t.setAttribute("type", "application/javascript"), t.textContent = "(" + function() {
        ...
        TWIR = {
            ...
            if (r.hasOwnProperty("preferences") && (r.preferences.ids_popup = !1), null != localStorage.TWToolkit_preferences) {
            ...
            sleep: {},
            init: function() {
                TWIR.storage.updateFeat(), TWIR.storage.find_MarketData(), TWIR.storage.find_MarketAlertSettings(), TWIR.storage.find_LimitedPrices(), TWIR.storage.get_ToolkitEventIcons()
            },
            inventory: {
                buffs: [],
                use: [],
            ...
            find_MarketAlertSettings: function() {
                null == localStorage ? new UserMessage(e.informative.storage_error + "!", UserMessage.TYPE_ERROR).show() : null != localStorage.twir_marketAlert ? TWIR.storage.marketWatcher.mwl = JSON.parse(localStorage.twir_marketAlert) : TWIR.storage.marketWatcher.mwl = [{
                    item_id: 862e3,
                    item_price: 1e5
                }]
            },
            ...
            return t = t.reduce((e, t) => {
                if ($.isNumeric(t.date) || (t.date = new Date(t.date).valueOf()), null != t.offer_id) var a = e.find(({
                    ...
                    auction_price: o,
                    auction_end_date: n
                }) => t.item_base_id === e && t.seller_name === a && t.max_price === r && t.item_count === i && t.auction_price === o && t.auction_end_date === n);
                return a || e.push(t), e
            }, [])
            ...
            showSelect: function(t) {
                var a = (new west.gui.Selectbox).setWidth(240).setHeader("TWIR");
            ...
            openFeat: function() {
                try {
                    ...
                    var t = (new west.gui.Scrollpane).appendContent("<div/>"),
                        a = (new west.gui.Combobox).addClass("twir_combobox").setWidth(165);
                    const m = {};
                    for (var r in Object.keys(TWIR.translations).sort().forEach(function(e) {
                            m[e] = TWIR.translations[e]
                        }), m) a.addItem(r, '<span title="' + m[r].translator + '" style="background: url(//portal-bar.innogamescdn.com/images/west-sprite_01.1541670091.png) no-repeat top left;height: 12px;padding-left: 25px;background-position:' + m[r].icon + ';">' + m[r].translate + "</span>");
                    a.select(TWIR.lang);
                    ...
                    t.appendContent('<div style="font-weight: bold;margin-top: 8px;text-shadow: 2px 1px 2px #fae3ad;color: #5e321a;font-size: 16px;margin-bottom: 5px;">' + e.features.inventory_menus + "</div>"), t.appendContent(n), t.appendContent('<div style="font-weight: bold;margin-top: 8px;text-shadow: 2px 1px 2px #fae3ad;color: #5e321a;font-size: 16px;margin-bottom: 5px;">' + e.features.popup_tooltips + "</div>"), t.appendContent(s), t.appendContent('<div style="font-weight: bold;margin-top: 8px;text-shadow: 2px 1px 2px #fae3ad;color: #5e321a;font-size: 16px;margin-bottom: 5px;">' + e.market_watcher.add_name + "</div>"), t.appendContent(p), t.appendContent('<div style="font-weight: bold;margin-top: 8px;text-shadow: 2px 1px 2px #fae3ad;color: #5e321a;font-size: 16px;margin-bottom: 5px;">' + e.features.other + "</div>"), t.appendContent(l), t.appendContent("<br>"), $(t.getMainDiv()).css({
                        height: "305px",
                        "margin-top": "10px",
                        "margin-left": "20px",
                        width: "680px"
                    });
                    var A = new west.gui.Button(e.organizing.submit, function() {
                            if (null != localStorage) {
                                for (var t in TWIR.menu.gui.check) TWIR.storage.features[t] = TWIR.menu.gui.check[t].isSelected();
                                localStorage.setItem("scriptsLang", a.getValue()), localStorage.setItem("twir_features", JSON.stringify(TWIR.storage.features));
                        ...
                        g = $('<div style="margin-top: 10px; margin-right: 50px; float: right;"/>');
                    g.append(A.getMainDiv()), $(TWIR.menu.gui.window.getContentPane()).append(t.getMainDiv()).append(g)
                } catch (e) {
                    TWIR.bugHunt(e)
                }
            },
            ...
            if (ItemManager.isLoaded() && Bag.loaded && west.storage.ItemSetManager._initialized) try {
                ...
                }, Inventory), TWIR.marketBest.init(), TWIR.checkShop(), TWIR.marketWatcher.init(), TWIR.fillOther(), $.when(e, t).done(function() {
                    TWIR.menulink()
            ...
            jobPopup: function() {
                try {
                    ...
                    Ajax.remoteCallMode("character", "ajax_get_buffs", {}, function(t) {
                        if (t.msg.event && null != t.msg.event.description)
                        ...
                        if (t.msg.character && null != t.msg.character.description)
                        ...
                        if (JobsModel.Beans.hasOwnProperty(a.id)) {
                            ...
                            for (var m in a.yields) {
                                var d = ItemManager.get(m),
                                    u = null != n[d.short] && 0 != n[d.short].percentage ? n[d.short].percentage : Math.ceil(600 * a.yields[m].prop),
                    ...
                    try {
                        ...
                        if (TWIR.storage.popups.shop_prices.hasOwnProperty(this.item_obj.short) && TWIR.storage.get("pop_ups_price")) {
                            var y = 1 === this.item_obj.item_level ? 3 : 2 === this.item_obj.item_level ? 9 : 3 === this.item_obj.item_level ? 27 : 4 === this.item_obj.item_level ? 81 : 5 === this.item_obj.item_level ? 243 : 1,
                                w = 3 === TWIR.storage.popups.shop_prices[this.item_obj.short].currency ? '<span style="display: inline-block;position: relative;top: 3px;background: url(' + TWIR.images.currency.bonds_nuggets + ') no-repeat;width: 16px;height: 16px;"></span><span>&nbsp;' + (TWIR.storage.get("pop_short_currency") ? TWIR.replSum(TWIR.storage.popups.shop_prices[this.item_obj.short].price_bonds * y) : TWIR.storage.popups.shop_prices[this.item_obj.short].price_bonds * y) + "</span>" : 2 === TWIR.storage.popups.shop_prices[this.item_obj.short].currency ? '<span style="display: inline-block;position: relative;top: 3px;background: url(' + TWIR.images.currency.nuggets + ') no-repeat;width: 16px;height: 16px;"></span><span>&nbsp;' + (TWIR.storage.get("pop_short_currency") ? TWIR.replSum(TWIR.storage.popups.shop_prices[this.item_obj.short].price_nuggets * y) : TWIR.storage.popups.shop_prices[this.item_obj.short].price_nuggets * y) + "</span>" : 1 === TWIR.storage.popups.shop_prices[this.item_obj.short].currency ? '<span style="display: inline-block;position: relative;top: 3px;background: url(' + TWIR.images.currency.bonds + ') no-repeat;width: 16px;height: 16px;"></span><span>&nbsp;' + (TWIR.storage.get("pop_short_currency") ? TWIR.replSum(TWIR.storage.popups.shop_prices[this.item_obj.short].price_bonds * y) : TWIR.storage.popups.shop_prices[this.item_obj.short].price_bonds * y) + "</span>" : 8 === TWIR.storage.popups.shop_prices[this.item_obj.short].currency ? '<span style="display: inline-block;position: relative;top: 3px;background: url(' + TWIR.images.currency.veteran + ') no-repeat;width: 16px;height: 16px;"></span><span>&nbsp;' + (TWIR.storage.get("pop_short_currency") ? TWIR.replSum(TWIR.storage.popups.shop_prices[this.item_obj.short].price_veteran * y) : TWIR.storage.popups.shop_prices[this.item_obj.short].price_veteran * y) + "</span>" : 7 === TWIR.storage.popups.shop_prices[this.item_obj.short].currency ? '<span style="display: inline-block;position: relative;top: 3px;background: url(' + TWIR.images.currency.bonds_nuggets + ') no-repeat;width: 16px;height: 16px;"></span><span>&nbsp;' + (TWIR.storage.get("pop_short_currency") ? TWIR.replSum(TWIR.storage.popups.shop_prices[this.item_obj.short].price_nuggets * y) : TWIR.storage.popups.shop_prices[this.item_obj.short].price_nuggets * y) + '</span><span style="display: inline-block;position: relative;top: 3px;background: url(' + TWIR.images.currency.dollars + ') no-repeat;width: 16px;height: 16px;margin-left: 5px;"/><span>&nbsp;&#36;' + TWIR.replSum(TWIR.storage.popups.shop_prices[this.item_obj.short].price_dollar * y) + "</span>" : "",
                            ...
                            var y = 1 === this.item_obj.item_level ? 3 : 2 === this.item_obj.item_level ? 9 : 3 === this.item_obj.item_level ? 27 : 4 === this.item_obj.item_level ? 81 : 5 === this.item_obj.item_level ? 243 : 1,
                                w = 3 === TWIR.storage.popups.shop_limited_prices[this.item_obj.short].currency ? '<span style="display: inline-block;position: relative;top: 3px;background: url(' + TWIR.images.currency.bonds_nuggets + ') no-repeat;width: 16px;height: 16px;"></span><span>&nbsp;' + (TWIR.storage.get("pop_short_currency") ? TWIR.replSum(TWIR.storage.popups.shop_limited_prices[this.item_obj.short].price_bonds * y) : TWIR.storage.popups.shop_limited_prices[this.item_obj.short].price_bonds * y) + "</span>" : 2 === TWIR.storage.popups.shop_limited_prices[this.item_obj.short].currency ? '<span style="display: inline-block;position: relative;top: 3px;background: url(' + TWIR.images.currency.nuggets + ') no-repeat;width: 16px;height: 16px;"></span><span>&nbsp;' + (TWIR.storage.get("pop_short_currency") ? TWIR.replSum(TWIR.storage.popups.shop_limited_prices[this.item_obj.short].price_nuggets * y) : TWIR.storage.popups.shop_limited_prices[this.item_obj.short].price_nuggets * y) + "</span>" : 1 === TWIR.storage.popups.shop_limited_prices[this.item_obj.short].currency ? '<span style="display: inline-block;position: relative;top: 3px;background: url(' + TWIR.images.currency.bonds + ') no-repeat;width: 16px;height: 16px;"></span><span>&nbsp;' + (TWIR.storage.get("pop_short_currency") ? TWIR.replSum(TWIR.storage.popups.shop_limited_prices[this.item_obj.short].price_bonds * y) : TWIR.storage.popups.shop_limited_prices[this.item_obj.short].price_bonds * y) + "</span>" : 8 === TWIR.storage.popups.shop_limited_prices[this.item_obj.short].currency ? '<span style="display: inline-block;position: relative;top: 3px;background: url(' + TWIR.images.currency.veteran + ') no-repeat;width: 16px;height: 16px;"></span><span>&nbsp;' + (TWIR.storage.get("pop_short_currency") ? TWIR.replSum(TWIR.storage.popups.shop_limited_prices[this.item_obj.short].price_veteran * y) : TWIR.storage.popups.shop_limited_prices[this.item_obj.short].price_veteran * y) + "</span>" : 7 === TWIR.storage.popups.shop_limited_prices[this.item_obj.short].currency ? '<span style="display: inline-block;position: relative;top: 3px;background: url(' + TWIR.images.currency.bonds_nuggets + ') no-repeat;width: 16px;height: 16px;"></span><span>&nbsp;' + (TWIR.storage.get("pop_short_currency") ? TWIR.replSum(TWIR.storage.popups.shop_limited_prices[this.item_obj.short].price_nuggets * y) : TWIR.storage.popups.shop_limited_prices[this.item_obj.short].price_nuggets * y) + '</span><span style="display: inline-block;position: relative;top: 3px;background: url(' + TWIR.images.currency.dollars + ') no-repeat;width: 16px;height: 16px;margin-left: 5px;"/><span>&nbsp;&#36;' + TWIR.replSum(TWIR.storage.popups.shop_limited_prices[this.item_obj.short].price_dollar * y) + "</span>" : "";
                        ...
                        if (!this.item_obj.sellable && this.item_obj.auctionable && TWIR.storage.get("pop_min_market_price")) {
                            ...
                            r = r.replace(/(inventory_popup_prices")(>)/g, '$1 style="margin-bottom: 5px;"> <span class="inventory_popup_trader_price_buy"><span class="tw2gui-iconset tw2gui-icon-friends" style="display: inline-block; vertical-align: top;"/>&nbsp;&#36;' + B + "</span>" + W)
                        }
                        ...
                        if (JobList.dropsItem(this.item_obj.item_id) && TWIR.storage.get("pop_job_table")) {
                            ...
                            for (var Q = '<div class="twir_better_popup" style="text-align:center;margin: 0 auto;display: table;"><table style="display: table !important;border-collapse: separate !important;border-spacing: 1px !important;border-radius: 3px;border: 1px solid #804000;"><tbody>', J = 0; J < F.length; J++) {
                                var O = 0,
                                    H = 0;
                                if ($.isEmptyObject(JobsModel.Beans) || null == JobsModel.Beans[F[J].id].basis.long.yields[0]) O = Math.ceil(600 * F[J].yields[this.item_obj.item_id].prop), H = 0;
                                else if (!$.isEmptyObject(JobsModel.Beans) && null != JobsModel.Beans[F[J].id].basis.long.yields[0])
                                    for (var D = 0; D < JobsModel.Beans[F[J].id].basis.long.yields.length; D++) JobsModel.Beans[F[J].id].basis.long.yields[D].itemid === this.item_obj.item_id && (O = JobsModel.Beans[F[J].id].basis.long.yields[D].prop, H = JobsModel.Beans[F[J].id].basis.long.yields[D].probBonus);
                                var Z = O + H,
                                    P = $.isEmptyObject(JobsModel.Beans) || 0 == Z ? "" : "&nbsp;(" + Z.toFixed(0) + "&nbsp;%)";
                                F.hasOwnProperty(J) && (Q += '<tr><td style="vertical-align: middle!important;padding: 5px;border: 1px solid #996b39;border-color: rgba(110,57,0,0.5);background-color: #d4ba91 !important;background-image: none !important;color: #5e321a !important;font-size: 16px;border-collapse: separate !important;border-spacing: 1px !important;"><img style="width: 30px;height: 30px;" src="' + Game.cdnURL + "/images/jobs/" + F[J].shortname + '.png"/></td><td style="vertical-align: middle!important;padding: 5px;border: 1px solid #996b39;border-color: rgba(110,57,0,0.5);background-color: #d4ba91 !important;background-image: none !important;color: #5e321a !important;font-style: italic;font-size: 8pt;border-collapse: separate !important;border-spacing: 1px !important;width: 125px;"><span>' + F[J].name + P + "</span></td></tr>")
                            }
                            r += Q += "</tbody></table></div>"
                        }
                        if (null != this.item_obj.set) var z = west.storage.ItemSetManager.get(this.item_obj.set),
                            N = z.getWornItems().length,
                            L = null != Wear.get(this.item_obj.type) ? Wear.get(this.item_obj.type).obj.set : null,
                        ...
                        if (TWIR.storage.get("pop_partial_bonus") && null != this.item_obj.set && 0 === N && (r += '<td><div style="display: inline-block;background: url(' + Game.cdnURL + '/images/window/wof/prizes_sep.jpg);width: 25px;height: 270px;margin: 15px 0;"/></td><td class="twir_popup_pb" style="min-width: 200px;max-width: 250px;">'), null != this.item_obj.set) {
                            ...
                            var fe = N > 0 ? "&nbsp;(" + N + "/" + ee + ")" : "";
                            if (N > 0) r = r.replace('<span class="text_bold">' + z.name + ":</span>", '<span style="color: #800080 !important;font-weight: bold;max-width: 220px;display: block;text-align: center;">' + z.name + fe + "</span>");
                            else if (0 === N)
                                if (TWIR.storage.get("pop_partial_bonus")) {
                                    var We = '<span style="color: #800080 !important;font-weight: bold;max-width: 220px;display: block;text-align: center;margin-top: 15px;margin-bottom: 15px;">' + z.name + "</span>";
                                    r = r.replace('<span class="text_bold">' + z.name + ":</span>", ""), r += We
                                } else r = r.replace('<span class="text_bold">' + z.name + ":</span>", '<span style="color: #800080 !important;font-weight: bold;max-width: 220px;display: block;text-align: center;">' + z.name + "</span>");
                            ...
                            for (var Ae = 0; Ae < ce.usebonus.length; Ae++) {
                                ...
                                if (TWIR.storage.popups.crafting.hasOwnProperty(ce.item_id)) switch (!0) {
                                    case TWIR.usebonus.same(f, ge):
                                        ...
                                        break;
                                    case !TWIR.usebonus.same(f, ge):
                                        -1 === q.indexOf(ce.item_id) && q.push(ce.item_id)
                                }
                            }
                        TWIR.storage.popups.crafting.hasOwnProperty(ce.item_id) && (1 === TWIR.storage.popups.crafting[ce.item_id].profsymbol && -1 === C.indexOf(ce.item_id) ? C.push(ce.item_id) : 2 === TWIR.storage.popups.crafting[ce.item_id].profsymbol && -1 === E.indexOf(ce.item_id) ? E.push(ce.item_id) : 3 === TWIR.storage.popups.crafting[ce.item_id].profsymbol && -1 === Y.indexOf(ce.item_id) ? Y.push(ce.item_id) : 4 === TWIR.storage.popups.crafting[ce.item_id].profsymbol && -1 === G.indexOf(ce.item_id) && G.push(ce.item_id))
                    ...
                    for (var a in t.inventory)
                        if (t.inventory.hasOwnProperty(a))
                            for (var r = 0; r < t.inventory[a].length; r++) {
                                var i = t.inventory[a][r],
                                    o = ItemManager.get(i.item_id);
                                TWIR.storage.popups.shop_prices.hasOwnProperty(o.short) || Object.assign(TWIR.storage.popups.shop_prices, {
                                    [o.short]: {
                                        currency: i.currency,
                                        price_bonds: 0 != i.reduced_value ? Math.round(i.price_bonds - i.reduced_value / 100 * i.price_bonds) : i.price_bonds,
                                        price_nuggets: 0 != i.reduced_value ? Math.round(i.price_nuggets - i.reduced_value / 100 * i.price_nuggets) : i.price_nuggets,
                                        price_veteran: 0 != i.reduced_value ? Math.round(i.price_veteran - i.reduced_value / 100 * i.price_veteran) : i.price_veteran,
                                        price_dollar: 0 != i.reduced_value ? Math.round(i.price_dollar - i.reduced_value / 100 * i.price_dollar) : i.price_dollar,
                                        limited_time: i.limited_time,
                                        reduced_value: i.reduced_value
                                    }
                                }), null != i.limited_time && Object.assign(TWIR.storage.popups.shop_limited_prices, {
                                    [o.short]: {
                                        currency: i.currency,
                                        price_bonds: i.price_bonds,
                                        price_nuggets: i.price_nuggets,
                                        price_veteran: i.price_veteran,
                                        price_dollar: i.price_dollar,
            ...
            getBestItems: function() {
                try {
                    var e = TWIR.reduceMarketDB(TWIR.storage.marketWatcher.marketData);
                    TWIR.storage.popups.marketBest = {};
                    for (var t = 0; t < e.length; t++) {
                        var a = ItemManager.getByBaseId(e[t].item_base_id),
                            r = null != Bag.getItemByItemId(a.item_id);
            ...
            getBestProducts: function() {
                try {
                    var e = TWIR.reduceMarketDB(TWIR.storage.marketWatcher.marketDataJunk);
                    ...
                    for (var t = 0; t < e.length; t++) {
                        ...
                        if (TWIR.storage.popups.marketBestJunk.hasOwnProperty(a.short) || null == e[t].max_price || Object.assign(TWIR.storage.popups.marketBestJunk, {
                            ...
                            var i = parseInt(e[t].max_price / e[t].item_count);
                            TWIR.storage.popups.marketBestJunk[a.short].avg = TWIR.storage.popups.marketBestJunk[a.short].price_sum / TWIR.storage.popups.marketBestJunk[a.short].offer_count, i <= TWIR.storage.popups.marketBestJunk[a.short].avg && (TWIR.storage.popups.marketBestJunk[a.short].avg_min.price_sum += i, TWIR.storage.popups.marketBestJunk[a.short].avg_min.count += 1), i >= TWIR.storage.popups.marketBestJunk[a.short].avg && (TWIR.storage.popups.marketBestJunk[a.short].avg_max.price_sum += i, TWIR.storage.popups.marketBestJunk[a.short].avg_max.count += 1), (e[t].max_price / e[t].item_count > TWIR.storage.popups.marketBestJunk[a.short].offer_max.price || e[t].max_price / e[t].item_count == TWIR.storage.popups.marketBestJunk[a.short].offer_max.price && new Date(e[t].date) > new Date(TWIR.storage.popups.marketBestJunk[a.short].offer_max.date)) && (TWIR.storage.popups.marketBestJunk[a.short].offer_max.price = parseInt(e[t].max_price / e[t].item_count), TWIR.storage.popups.marketBestJunk[a.short].offer_max.name = e[t].seller_name, TWIR.storage.popups.marketBestJunk[a.short].offer_max.date = e[t].date), (e[t].max_price / e[t].item_count > TWIR.storage.popups.marketBestJunk[a.short].offer_max_x.each && e[t].item_count <= TWIR.storage.popups.marketBestJunk[a.short].offer_max_x.count || e[t].max_price / e[t].item_count == TWIR.storage.popups.marketBestJunk[a.short].offer_max_x.each && e[t].item_count <= TWIR.storage.popups.marketBestJunk[a.short].offer_max_x.count && new Date(e[t].date) > new Date(TWIR.storage.popups.marketBestJunk[a.short].offer_max_x.date)) && (TWIR.storage.popups.marketBestJunk[a.short].offer_max_x.each = parseInt(e[t].max_price / e[t].item_count), TWIR.storage.popups.marketBestJunk[a.short].offer_max_x.count = e[t].item_count, TWIR.storage.popups.marketBestJunk[a.short].offer_max_x.price = e[t].max_price, TWIR.storage.popups.marketBestJunk[a.short].offer_max_x.date = e[t].date), (e[t].max_price / e[t].item_count < TWIR.storage.popups.marketBestJunk[a.short].offer_min.price || e[t].max_price / e[t].item_count == TWIR.storage.popups.marketBestJunk[a.short].offer_min.price && new Date(e[t].date) > new Date(TWIR.storage.popups.marketBestJunk[a.short].offer_min.date)) && (TWIR.storage.popups.marketBestJunk[a.short].offer_min.price = parseInt(e[t].max_price / e[t].item_count), TWIR.storage.popups.marketBestJunk[a.short].offer_min.name = e[t].seller_name, TWIR.storage.popups.marketBestJunk[a.short].offer_min.date = e[t].date), (e[t].max_price / e[t].item_count < TWIR.storage.popups.marketBestJunk[a.short].offer_min_x.each && e[t].item_count >= TWIR.storage.popups.marketBestJunk[a.short].offer_min_x.count || e[t].max_price / e[t].item_count == TWIR.storage.popups.marketBestJunk[a.short].offer_min_x.each && e[t].item_count >= TWIR.storage.popups.marketBestJunk[a.short].offer_min_x.count && new Date(e[t].date) > new Date(TWIR.storage.popups.marketBestJunk[a.short].offer_min_x.date)) && (TWIR.storage.popups.marketBestJunk[a.short].offer_min_x.each = parseInt(e[t].max_price / e[t].item_count), TWIR.storage.popups.marketBestJunk[a.short].offer_min_x.price = e[t].max_price, TWIR.storage.popups.marketBestJunk[a.short].offer_min_x.count = e[t].item_count, TWIR.storage.popups.marketBestJunk[a.short].offer_min_x.date = e[t].date)
                        }
                    }
                } catch (e) {
                    TWIR.bugHunt(e)
            ...
            init: function() {
                var e = $.isNumeric(localStorage.getItem("twir_marketTimer")) ? JSON.parse(localStorage.getItem("twir_marketTimer")) : localStorage.getItem("twir_marketTimer"),
                    ...
                    r = t - a,
                    i = r >= 0 ? r : 6e4;
                TWIR.marketWatcher.addCss(), "none" != TWIR.marketWatcher.scan && TWIR.console("TWIR/: Next Market scan in: " + (i / 1e3).getTime2EndString(!1) + ".", "#8b4513"), setTimeout(function() {
                    TWIR.marketWatcher.getMarketAlert(TWIR.storage.marketWatcher.mwl)
                }, i), TWIR.marketWatcher.addMarketTabs()
            },
            ...
            isValidItem: function(t, a) {
                return void 0 === ItemManager.get(t) ? (a && new UserMessage(e.informative.valid_id.replace("$1", t) + "!", UserMessage.TYPE_ERROR).show(), !1) : null != ItemManager.get(t) && !1 === ItemManager.get(t).auctionable ? (a && new UserMessage(e.informative.valid_auctionable.replace("$1", t) + "!", UserMessage.TYPE_ERROR).show(), !1) : null == ItemManager.get(t) || !0 !== ItemManager.get(t).auctionable || !0 !== TWIR.storage.marketWatcher.mwl.some(e => e.item_id === t) || (a && new UserMessage(e.informative.valid_defined.replace("$1", t) + "!", UserMessage.TYPE_ERROR).show(), !1)
            },
            openMWTab: function() {
                ...
                function l() {
                    ...
                    for (var t = (new west.gui.Table).addColumn("twir_mw_idx").addColumn("twir_mw_item").addColumn("twir_mw_name").addColumn("twir_mw_price").addColumn("twir_mw_remove").appendToThCell("head", "twir_mw_price", e.market_watcher.max_price, s).appendToCell("head", "twir_mw_idx").appendToCell("head", "twir_mw_item").appendToCell("head", "twir_mw_name").appendToCell("head", "twir_mw_price").appendToCell("head", "twir_mw_remove"), a = 0; a < TWIR.storage.marketWatcher.mwl.length; a++) {
                        var r = ItemManager.get(TWIR.storage.marketWatcher.mwl[a].item_id),
                            i = $('<span title="' + new ItemPopup(r).getXHTML().escapeHTML() + '">' + r.name + "</span>").data("itemId", TWIR.storage.marketWatcher.mwl[a].item_id);
                        t.appendRow().appendToCell(-1, "twir_mw_idx", a + 1), t.appendToCell(-1, "twir_mw_item", '<img style="cursor: pointer;" title="' + new ItemPopup(r).getXHTML().escapeHTML() + '" src="' + r.image + '"; height="29"; width="29"></img>'), t.appendToCell(-1, "twir_mw_name", i), TWIR.storage.marketWatcher.mwl[a].item_price ? t.appendToCell(-1, "twir_mw_price", "$" + (TWIR.storage.marketWatcher.mwl[a].item_price >= 1e5 ? TWIR.replSum(TWIR.storage.marketWatcher.mwl[a].item_price) : TWIR.storage.marketWatcher.mwl[a].item_price)) : t.appendToCell(-1, "twir_mw_price", "-");
                        var n = new west.gui.Icon("abort").getMainDiv().css({
                            "margin-bottom": "2px",
                            "margin-left": "5px",
                            cursor: "pointer"
                        }).data("id", TWIR.storage.marketWatcher.mwl[a].item_id).click(function() {
                            c($(this).data("id"))
                        });
                        t.appendToCell(-1, "twir_mw_remove", n)
                    }
                    o.append(t.getMainDiv())
                }

                function c(t) {
                    if (1 != TWIR.marketWatcher.checking) {
                        ...
                        l(), localStorage.twir_marketAlert = JSON.stringify(TWIR.storage.marketWatcher.mwl)
                    } else new UserMessage(e.informative.error_wait + ".", UserMessage.TYPE_ERROR).show()
                }

                function A(e) {
                    return new tw2widget.InventoryItem(ItemManager.get(e, !0)).getMainDiv().css({
                        position: "absolute",
                        left: "45px",
                        top: "10px"
                    })
                ...
                var g = new west.gui.Textfield("twir_mw_idField").onlyNumeric().setName("idValue").maxlength(10).setPlaceholder(e.market_watcher.item_id).setWidth(125),
                    m = new west.gui.Textfield("twir_mw_priceField").onlyNumeric().setName("priceValue").maxlength(8).setTooltip(e.market_watcher.max_price).setPlaceholder("$").setWidth(65),
                ...
                u.append(A(0)), g.getMainDiv().on("input", function() {
                    MarketWindow.window.$("div.twir_mw_itemframe", MarketWindow.DOM).empty();
                    var e = $("#twir_mw_idField").val();
                    e >= 1e3 && TWIR.marketWatcher.isValidItem(e, !1) ? u.append(A(e)) : u.append(A(0))
                });
                var I = new west.gui.Button(e.market_watcher.add_item, function() {
                    if ("" != $("#twir_mw_idField").val()) {
                        $("#twir_mw_idField").val(Math.min(2147483647, Math.max(1e3, $("#twir_mw_idField").val()))), $("#twir_mw_priceField").val(Math.min(99e6, Math.max(0, $("#twir_mw_priceField").val())));
                        var t = JSON.parse($("#twir_mw_idField").val()),
                            a = JSON.parse($("#twir_mw_priceField").val());
                        TWIR.marketWatcher.isValidItem(t, !0) && TWIR.storage.marketWatcher.mwl.length <= 50 ? (TWIR.storage.marketWatcher.mwl.push({
                            item_id: t,
                            item_price: a
                        }), l(), null != localStorage ? (localStorage.twir_marketAlert = JSON.stringify(TWIR.storage.marketWatcher.mwl), TWIR.console('/TWIR: "' + ItemManager.get(t).name + '" added!', "#8b4513")) : new UserMessage(e.informative.storage_error + "!", UserMessage.TYPE_ERROR).show()) : TWIR.storage.marketWatcher.mwl.length > 50 && new UserMessage(e.informative.valid_max + "!", UserMessage.TYPE_ERROR).show()
                    }
                }).addClass("twir_mw_watch");
                d.append((new west.gui.Groupframe).appendToContentPane($('<div style="width: 145px;height: 240px;"/>').append(u).append(g.getMainDiv().css({
                    position: "absolute",
                    top: "115px",
                    left: "15px"
                    ...
                    top: "155px",
                    left: "45px"
                })).append(I.getMainDiv())).getMainDiv()), a.append(d, $('<div class="market_devider_bottom" style="left: 10px;width: 160px;" />'), $('<div class="market_devider_bottom" />'), i, r, o), MarketWindow.window.$("div.marketplace-twir_mw", MarketWindow.DOM).empty().append(a)
            },
            isUnderpriced: function(e, t, a) {
                var r = ItemManager.get(e),
                    i = TWIR.storage.popups.marketBest,
                    o = t && i.hasOwnProperty(r.short) ? Math.round(t / i[r.short].avg * 100) : 0;
                return 0 != o && o <= 50 || (!!(t && t <= 2 * r.price) || !!(a && a <= 2 * r.price))
            },
            getMarketAlert: function() {
                try {
                    WestUi.NotiBar.remove(TWIR.marketWatcher.OnGoing)
                } catch (e) {}
                var t = 1,
                    a = TWIR.reduceMarketDB(TWIR.storage.marketWatcher.marketData).length,
                    r = TWIR.reduceMarketDB(TWIR.storage.marketWatcher.marketDataJunk).length,
                    i = (new Date).getTime(),
                        ...
                        "none" !== p && (TWIR.marketWatcher.checking = !0, Ajax.remoteCall("building_market", "search", {
                            ...
                            if (!1 === c.error) {
                                for (var A = c.msg.search_result, g = 0; g < A.length; g++) {
                                    ...
                                    ("yield" != d.type || null != d.set || TWIR.storage.inventory.collectibles.indexOf(m) >= 0 || TWIR.storage.inventory.bonus.indexOf(m) >= 0) && "all" == p || "valuable" == p ? TWIR.storage.marketWatcher.marketData.push(u) : "all" == p && TWIR.storage.marketWatcher.marketDataJunk.push(u)
                                }
                                for (var I = [], h = 0; h < A.length; h++) {
                                    var k = s.find(e => e.item_id === A[h].item_id),
                                        R = ItemManager.get(A[h].item_id);
                                    if (void 0 === k && ("yield" != R.type || null != R.set || TWIR.storage.inventory.collectibles.indexOf(R.item_base_id) >= 0 || TWIR.storage.inventory.bonus.indexOf(R.item_base_id) >= 0) && TWIR.marketWatcher.isUnderpriced(A[h].item_id, A[h].max_price, A[h].auction_price)) {
                                        var b = {
                                            auction_ends_in: A[h].auction_ends_in,
                                            auction_end_date: A[h].auction_end_date,
                                            item_id: A[h].item_id,
                                            item_count: A[h].item_count,
                                            auction_price: A[h].auction_price,
                                            max_price: A[h].max_price,
                                            seller_name: A[h].seller_name,
                                            seller_id: A[h].seller_player_id,
                                            market_town_id: A[h].market_town_id,
                                            market_town: A[h].market_town_name,
                                            posx: A[h].market_town_x,
                                            posy: A[h].market_town_y,
                                            underprice: !0
                                        };
                                        I.push(b)
                                    }
                                ...
                                for (var y = 0; y < A.length; y++) {
                                    var k = s.find(e => e.item_id === A[y].item_id);
                                    if (null != k) {
                                        TWIR.storage.popups.marketBest, TWIR.storage.popups.marketBestJunk;
                                        var w = ItemManager.get(A[y].item_id);
                                        if (null != A[y].max_price && A[y].max_price <= k.item_price || null === A[y].max_price || 0 === k.item_price) {
                                            var x = {
                                                auction_ends_in: A[y].auction_ends_in,
                                                auction_end_date: A[y].auction_end_date,
                                                item_id: A[y].item_id,
                                                item_count: A[y].item_count,
                                                auction_price: A[y].auction_price,
                                                max_price: A[y].max_price,
                                                seller_name: A[y].seller_name,
                                                seller_id: A[y].seller_player_id,
                                                market_town_id: A[y].market_town_id,
                                                market_town: A[y].market_town_name,
                                                posx: A[y].market_town_x,
                                                posy: A[y].market_town_y
                                            };
                                            TWIR.storage.marketWatcher.wtb.hasOwnProperty(w.short) ? TWIR.storage.marketWatcher.wtb[w.short].push(x) : (TWIR.storage.marketWatcher.wtb[w.short] = [], TWIR.storage.marketWatcher.wtb[w.short].push(x))
                                        }
                                    }
                                }
                                setTimeout(function() {
                                    if (!0 === c.msg.next) t++, l();
                                        ...
                                        if (I.length > 0 && TWIR.storage.get("mw_underpriced_alert")) {
                                            var n = I[Math.floor(Math.random() * I.length)],
                                                s = ItemManager.get(n.item_id),
                                                p = TWIR.storage.marketWatcher.wtb;
                                            TWIR.storage.marketWatcher.wtb = {
                                                [s.short]: [],
                                                ...p
                                            }, TWIR.storage.marketWatcher.wtb[s.short].push(n)
                                        }
                                        var A = TWIR.reduceMarketDB(TWIR.storage.marketWatcher.marketData),
                                            g = TWIR.reduceMarketDB(TWIR.storage.marketWatcher.marketDataJunk);
                                        if (null != localStorage) {
                                            localStorage.twir_marketData = JSON.stringify(A), localStorage.twir_marketDataJunk = JSON.stringify(g);
                                            var m = (new Date).getTime();
                                            TWIR.marketBest.init(), TWIR.console("TWIR/: Market Scan completed at " + Chat.Formatter.formatTime((new Date).getTime(), !1) + " in " + ((m - i) / 1e3).getTime2EndToken() + " (" + t + " pages, " + (TWIR.reduceMarketDB(TWIR.storage.marketWatcher.marketData).length - a + (TWIR.reduceMarketDB(TWIR.storage.marketWatcher.marketDataJunk).length - r)) + " new listings). Next scan in: " + (o / 1e3).getTime2EndString(!1) + ".", "green"), localStorage.setItem("twir_marketTimer", (new Date).valueOf())
                                        } else new UserMessage(e.informative.storage_error + "!", UserMessage.TYPE_ERROR).show();
                                        TWIR.marketWatcher.showMarketAlert(), TWIR.marketWatcher.checking = !1, setTimeout(function() {
                                            TWIR.storage.marketWatcher.wtb = {}, TWIR.marketWatcher.getMarketAlert()
                                        }, o)
                                    }
            ...
            showMarketAlert: function() {
                ...
                var i = function() {
                        var e = 0;
                        for (var a in t) {
                            if (t[a].some(e => !0 === e.underprice)) {
                                var i = t[a].filter(e => !0 === e.underprice)[0].item_id;
                    ...
                    s = new Audio(TWIR.alert);
                if (s.volume = .5, TWIR.marketWatcher.OnGoing = null, $.isEmptyObject(t)) $.isEmptyObject(t) && (TWIR.marketWatcher.lastAlert = t, TWIR.console("TWIR/: No offers matching your list were found.", "#8b4513"));
                else {
                    if (TWIR.storage.get("mw_wtb_alert")) {
                        var p = "<div>" + e.market_watcher.add_name + "</div>";
                        TWIR.marketWatcher.OnGoing = new OnGoingPermanentEntry(function() {
                            TWIR.marketWatcher.formatMarketAlert()
                        }, p, "twir_marketWatcher", !1), WestUi.NotiBar.add(TWIR.marketWatcher.OnGoing), $("#ui_notibar .ui_ongoing .ui_ongoing_content .ongoing_entry").find(".twir_marketWatcher").after($('<div style="color:white;text-align:center;font-size:11px;top:27px;text-shadow:rgb(0,0,0) 0 0 4px;overflow:hidden;position:relative;background:url(' + Game.cdnURL + '/images/window/trader/preis_gross.png) no-repeat;">' + Object.keys(t).length + "</div>"))
                    }
                    TWIR.console("TWIR/: Found " + i + " offers matching your list (" + (i - o > -1 ? i - o : 0) + " new).", "green");
                    var l = new RegExp("^.*" + e.market_watcher.add_name + ":(.*)$", "i"),
                    ...
                    if (n && TWIR.storage.get("mw_wtb_chat_alert") && -1 === c.history.findIndex(e => l.test(e))) {
                        ChatWindow.open(c, !0);
                        var A = e.market_watcher.seen + '&nbsp;<a href="javascript:void(TWIR.marketWatcher.formatMarketAlert())">[' + Object.keys(t).length + "]</a>.",
                            g = Chat.Formatter.formatMessage(Chat.Formatter.formatText(A, !0), "&nbsp;<b>" + e.market_watcher.add_name + ":</b>", Date.now(), !0, "from_system"),
                            m = Chat.Formatter.formatMessage(Chat.Formatter.formatText(e.market_watcher.underpriced_found + "!", !0), "&nbsp;<b>" + e.market_watcher.add_name + ":</b>", Date.now(), !0, "from_system"),
                            d = Chat.Resource.Manager.getRooms();
                        for (var u in d) d[u].addMessage(g), !0 === r && d[u].addMessage(m)
                    }
                    if (i != o && (n && null != TWIR.marketWatcher.OnGoing && TWIR.marketWatcher.OnGoing.highlightBorder(!0), TWIR.marketWatcher.lastAlert = t), n && !TWIR.storage.get("mw_alert_playsound")) {
                        const e = s.play();
                        null !== e && e.catch(() => {
                            s.play()
                        })
            ...
            for (var N in e) {
                ...
                switch ("shot" === L.sub_type ? (U += 1, K += e[N].count) : "hand" === L.sub_type && (S += 1, v += e[N].count), "yield" != L.type && null != L.set && (m += 1, d += e[N].count), "yield" != L.type && "recipe" != L.type && e[N].count > s.item_count && (s = {
                    item_id: L.item_base_id,
                    item_count: e[N].count
                }), L.type) {
                    case "belt":
                        l += 1, c += e[N].count, V += 1, j += e[N].count;
                        break;
                    case "body":
                        l += 1, c += e[N].count, C += 1, E += e[N].count;
                        break;
                    case "foot":
                        l += 1, c += e[N].count, Y += 1, G += e[N].count;
                        break;
                    case "head":
                        l += 1, c += e[N].count, q += 1, F += e[N].count;
                        break;
                    case "neck":
                        l += 1, c += e[N].count, Q += 1, J += e[N].count;
                        break;
                    case "pants":
                        l += 1, c += e[N].count, O += 1, H += e[N].count;
                        break;
                    case "animal":
            ...
            for (var ae = 0; ae < n.length; ae++) B += 1, M += n[ae].count;
            ...
            for (var B in T) {
                ...
                l += $.isNumeric(ItemManager.get(M).price) ? 1 * ItemManager.get(M).price : 0, c += $.isNumeric(ItemManager.get(M).sell_price) ? 1 * ItemManager.get(M).sell_price : 0
            }
            for (var S in W) W.hasOwnProperty(S) && (e += $.isNumeric(ItemManager.get(S).price) ? ItemManager.get(S).price * W[S].count : 0), t += $.isNumeric(ItemManager.get(S).sell_price) ? ItemManager.get(S).sell_price * W[S].count : 0, 1 == W[S].count && (s += $.isNumeric(ItemManager.get(S).price) ? 1 * ItemManager.get(S).price : 0, p += $.isNumeric(ItemManager.get(S).sell_price) ? 1 * ItemManager.get(S).sell_price : 0);
            for (var v in TWIR.storage.popups.marketBest) TWIR.storage.popups.marketBest.hasOwnProperty(v) && !0 === TWIR.storage.popups.marketBest[v].owned && (a += TWIR.storage.popups.marketBest[v].price_sum);
            for (var U in W) {
                if (W.hasOwnProperty(U)) var K = W[U].obj;
                switch (K.type) {
                    case "yield":
                        o += $.isNumeric(ItemManager.get(U).price) ? ItemManager.get(U).price : 0, n += $.isNumeric(ItemManager.get(U).sell_price) ? ItemManager.get(U).sell_price : 0, A += $.isNumeric(ItemManager.get(U).price) ? ItemManager.get(U).price * W[U].count : 0, g += $.isNumeric(ItemManager.get(U).sell_price) ? ItemManager.get(U).sell_price * W[U].count : 0, K.price > w.item_price ? w = {
                        ...
                        break;
                    case "recipe":
                        u += $.isNumeric(ItemManager.get(U).price) ? ItemManager.get(U).price * W[U].count : 0, I += $.isNumeric(ItemManager.get(U).sell_price) ? ItemManager.get(U).sell_price * W[U].count : 0;
                        break;
                    case "belt":
                    case "body":
                    case "foot":
                    ...
                    case "right_arm":
                    case "left_arm":
                        r += $.isNumeric(ItemManager.get(U).price) ? ItemManager.get(U).price : 0, i += $.isNumeric(ItemManager.get(U).sell_price) ? ItemManager.get(U).sell_price : 0, m += $.isNumeric(ItemManager.get(U).price) ? ItemManager.get(U).price * W[U].count : 0, d += $.isNumeric(ItemManager.get(U).sell_price) ? ItemManager.get(U).sell_price * W[U].count : 0, K.price > y.item_price ? y = {
                            item_id: K.item_base_id,
                            item_price: K.price
                ...
                "yield" != K.type && W[U].count > 1 && (R += $.isNumeric(ItemManager.get(U).price) ? ItemManager.get(U).price * W[U].count : 0, b += $.isNumeric(ItemManager.get(U).sell_price) ? ItemManager.get(U).sell_price * W[U].count : 0), "yield" != K.type && !0 === K.dropable && (h += $.isNumeric(ItemManager.get(U).price) ? ItemManager.get(U).price * W[U].count : 0, k += $.isNumeric(ItemManager.get(U).sell_price) ? ItemManager.get(U).sell_price * W[U].count : 0)
            }
                ...
                if (Object.keys(TWIR.storage.sleep).length > 0) {
                    ...
                    for (var p in s) {
                        ...
                        if (i(s[p].name), s[p].stage > 0 && "fort" === s[p].type) {
                            if (null != s[p].fort_type) var c = Character.forts.some(e => e.name === s[p].name) ? Game.cdnURL + "/images/map/minimap/icons/miniicon_own_forts-" + s[p].fort_type + ".png?2" : Game.cdnURL + "/images/map/minimap/icons/miniicon_alliance_forts-" + s[p].fort_type + ".png?2";
            ...
            showSearch: function() {
                try {
                    ...
                    null != localStorage && localStorage.hasOwnProperty("twir_sort") ? w.setSelected(!0, !0) : void 0 === localStorage && w.setEnabled(!1);
                    for (var x = new west.gui.Combobox, f = TWIR.Inventory.getSortBox(), W = 0; W < f.length; W++) x.addItem(f[W].sort, f[W].name);
                    x.select(TWIR.Inventory.data.order[0]);
                    var T = (new west.gui.Combobox).setWidth(90);
                    T.addItem("asc", e.organizing.sort_up), T.addItem("desc", e.organizing.sort_down), T.select(TWIR.Inventory.data.order[1]), w.setCallback(function() {
                        w.isSelected() && null != localStorage ? localStorage.twir_sort = JSON.stringify(TWIR.Inventory.data.order) : w.isSelected() || null == localStorage ? (new UserMessage(e.informative.storage_error + "!", UserMessage.TYPE_ERROR).show(), w.setEnabled(!1)) : localStorage.removeItem("twir_sort")
                    }), x.addListener(function(t) {
                        TWIR.Inventory.data.order[0] = t, Inventory.update(), w.isSelected() && null != localStorage ? localStorage.twir_sort = JSON.stringify(TWIR.Inventory.data.order) : w.isSelected() || null == localStorage ? (new UserMessage(e.informative.storage_error + "!", UserMessage.TYPE_ERROR).show(), w.setEnabled(!1)) : localStorage.removeItem("twir_sort")
                    }), T.addListener(function(t) {
                        TWIR.Inventory.data.order[1] = t, Inventory.update(), w.isSelected() && null != localStorage ? localStorage.twir_sort = JSON.stringify(TWIR.Inventory.data.order) : w.isSelected() || null == localStorage ? (new UserMessage(e.informative.storage_error + "!", UserMessage.TYPE_ERROR).show(), w.setEnabled(!1)) : localStorage.removeItem("twir_sort")
                        ...
                        "margin-right": "10px"
                    })), t.append(k), new west.gui.Dialog(e.inventory.search, t).setDraggable(!0).setBlockGame(!1).setPosition("40%", Map.height / 4).setId("twir_as").addButton("ok", function() {
                ...
                try {
                    ...
                    if (3 == x.length) {
                        var f = $('<img src="' + x[0] + '" style="width: 40px; height: auto;position: absolute;left: -5px; top: 5px;"/>'),
                            W = $('<img src="' + x[1] + '" style="width: 30px;height: auto;position: absolute;right: -3px;top: -2px;"/>'),
                            T = $('<img src="' + x[2] + '" style="width: 30px;height: auto;position: absolute;right: -3px;bottom: -2px;"/>');
                        w.append(f, W, T)
                    } else if (1 == x.length) {
            ...
            makeSetsSelect: function(t) {
                try {
                        ...
                        if (1 !== e) {
                            switch (e) {
                                case 1:
                                    return;
                                case "experience":
                                    $("#twir_sets_search").val("xp");
                                    break;
                                case "job":
                                    "cs_CZ" === Game.locale || "sk_SK" === Game.locale ? $("#twir_sets_search").val("pb") : $("#twir_sets_search").val("lp");
                                    break;
                                case "damage":
                                    $("#twir_sets_search").val("dmg");
                                    break;
                                case "offense":
                                    $("#twir_sets_search").val("off");
                                    break;
                                case "defense":
                                    $("#twir_sets_search").val("def");
                                    break;
                                default:
                                    $("#twir_sets_search").val(e)
                            }
                            l(), A.select(1)
                        }
                    });
                    ...
                    $("<td/>").append(new west.gui.Icon("search", "").getMainDiv(), c.getMainDiv(), new west.gui.Icon("abort", "").getMainDiv().css({
                        ...
                        $("#twir_sets_search").val(""), TWIR.Inventory.data.searchVal = null, TWIR.Inventory.updateSetsHtml(t)
                    ...
                    u.addItem("none", e.informative.none), u.addListener(function(e) {
                        ...
                        "margin-right": "10px"
                    })), a.append(d), new west.gui.Dialog(e.inventory.sets, a).setDraggable(!0).setId("twir_sm").setBlockGame(!1).setPosition("40%", Map.height / 4).addButton("ok", function() {
                        ...
                        "margin-top": "4px",
                        "font-size": "16pt"
                    }), TWIR.Inventory.updateSetsHtml(t)
                } catch (e) {
                    TWIR.bugHunt(e)
                }
            },
                ...
                Bag.search = function(t) {
                    if (Bag.loaded) {
                        var a = new RegExp("^.*" + t + "(.*)$", "i"),
                            ...
                            i = [],
                            o = "";
                        for (var n in e.keyWords)(null != e.keyWords[n] && Array.isArray(e.keyWords[n]) && e.keyWords[n].findIndex(e => t.toLowerCase().replace(/[0-9\%\+\:\-\$\.]/g, "").replace(/(\(|\)).*/g, "").trim() === e.toLowerCase()) > -1 && e.keyWords[n].some(function(e) {
