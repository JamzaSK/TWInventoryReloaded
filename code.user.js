	...
	script.setAttribute("type", "application/javascript"), script.textContent = "(" + function() {
		isDefined(window.TWIR) ? new west.gui.Dialog(TWIR.name, '<div class="txcenter"><b><br>The UserScript ' + TWIR.name + " is installed twice. You will have to uninstall older version for the script to work properly!</br></b></div>", west.gui.Dialog.SYS_WARNING).addButton("OK").show() : (TWIRlang = {}, TWIR = {
			...
			initLang: function() {
				...
				TWIR.lang = e[localStorage.getItem("scriptsLang")] ? localStorage.getItem("scriptsLang") : e[Game.locale.substr(0, 2)] ? Game.locale.substr(0, 2) : "en", $.when($.getScript(TWIR.compressUrl, function(e) {
					TWIR.LZ = LZString
					...
					}), $("div#ui_menubar").find("#TWIR").length || $("div#ui_menubar").append($('<div class="ui_menucontainer" id="TWIR" />').append(i).append('<div class="menucontainer_bottom" />')), TWIR.beCompatible(), $(document).ready(function() {
			...
			storage: {
				sleep: {},
				init: function() {
					this.cleanUp(), this.updateFeat(), this.getMarketData(), this.getMarketWhitelist(), this.getLimitedPrices(), this.getEventIcons(), this.getValidMarketList(), TWIR.marketPrice.init(), localStorage.twir_customSets && localStorage.removeItem("twir_customSets")
				},
				NPC: {},
				inventory: {
					buffs: [],
				...
				getValidMarketList: function() {
					...
					for (var A = Object.keys(TWIR.marketWatcher.regexItems()), p = 0; p < A.length; p++) {
						var l = A[p];
						i.push({
							type: "buff",
							key: l,
				...
				getMarketData: function() {
					...
					TWIR.marketWatcher.marketMain = e ? TWIR.maxMarketData(e) : [], TWIR.marketWatcher.marketOther = t ? TWIR.maxMarketData(t) : []
				},
				features: {
					inv_window_title: !0,
			...
			minMarketData: function(e) {
				if (e) {
					for (var t = [], i = 0; i < e.length; i++) {
						var a = e[i];
						t[i] = {}, void 0 !== a.auction_end_date && (t[i].e = a.auction_end_date), void 0 !== a.auction_price && (t[i].b = a.auction_price), void 0 !== a.max_price && (t[i].p = a.max_price), void 0 !== a.date && (t[i].d = a.date), void 0 !== a.offer_id && (t[i].o = a.offer_id), void 0 !== a.item_base_id && (t[i].i = a.item_base_id), void 0 !== a.item_count && (t[i].c = a.item_count), void 0 !== a.seller && (t[i].s = a.seller)
					}
					return t
				}
			},
			maxMarketData: function(e) {
				if (e) {
					for (var t = [], i = 0; i < e.length; i++) {
						var a = e[i];
						t[i] = {}, void 0 !== a.e && (t[i].auction_end_date = a.e), void 0 !== a.b && (t[i].auction_price = a.b), void 0 !== a.p && (t[i].max_price = a.p), void 0 !== a.d && (t[i].date = a.d), void 0 !== a.o && (t[i].offer_id = a.o), void 0 !== a.i && (t[i].item_base_id = a.i), void 0 !== a.c && (t[i].item_count = a.c), void 0 !== a.s && (t[i].seller = a.s)
					}
					return t
				}
			},
			...
			menu: {
				...
				showSelect: function(e) {
					...
					return i.addItem(1, '<span style="color: #5e321a; display: inline-block; margin-left: 5px;">' + TWIRlang.features.preferences + "</span>"), i.addItem(3, '<span style="color: #5e321a; display: inline-block; margin-left: 5px;">' + TWIRlang.market_watcher.add_name + "</span>"), i.addItem(2, '<span style="color: #5e321a; display: inline-block; margin-left: 5px;">' + TWIRlang.donate_title + "</span>"), i.addListener(function(e) {
						switch (e) {
							case 1:
								t.open("Features");
								break;
				...
				openFeat: function() {
					...
					try {
						...
						var s = $("<div/>"),
							...
							A = $("<div/>"),
							p = $("<div/>");
						for (var c in TWIR.storage.features) c.indexOf("inv_") > -1 ? (this.gui.check[c] = (new west.gui.Checkbox).setLabel(TWIRlang.feat_strings[c]).setSelected(TWIR.storage.get(c)).appendTo(s), s.append('<br><div style="height:5px;" />')) : c.indexOf("pop_") > -1 ? (this.gui.check[c] = (new west.gui.Checkbox).setLabel(TWIRlang.feat_strings[c]).setSelected(TWIR.storage.get(c)).appendTo(l), l.append('<br><div style="height:5px;" />')) : c.indexOf("mw_") > -1 ? (this.gui.check[c] = (new west.gui.Checkbox).setLabel(TWIRlang.feat_strings[c]).setSelected(TWIR.storage.get(c)).appendTo(A), A.append('<br><div style="height:5px;" />')) : (this.gui.check[c] = (new west.gui.Checkbox).setLabel(TWIRlang.feat_strings[c]).setSelected(TWIR.storage.get(c)).appendTo(p), p.append('<br><div style="height:5px;" />'));
						var g = (new west.gui.Combobox).setWidth(50);
						g.addItem(2592e6, 2592e3.getTime2EndToken()), g.addItem(7776e6, 7776e3.getTime2EndToken()), g.addItem(15552e6, 15552e3.getTime2EndToken()), g.addItem(31104e6, 31104e3.getTime2EndToken()), g.select(TWIR.marketWatcher.settings.keep);
						...
						d.select(TWIR.Inventory.data.menuSize), t.appendContent('<div style="font-weight: bold;margin-top: 8px;text-shadow: 2px 1px 2px #fae3ad;color: #5e321a;font-size: 16px;margin-bottom: 5px;">' + TWIRlang.features.inventory_menus + "</div>"), t.appendContent("<span>" + TWIRlang.feat_strings.inv_menu_size + "</span>").appendContent(d.getMainDiv().css({
							"margin-left": "10px"
						})), t.appendContent(s), t.appendContent('<div style="font-weight: bold;margin-top: 8px;text-shadow: 2px 1px 2px #fae3ad;color: #5e321a;font-size: 16px;margin-bottom: 5px;">' + TWIRlang.features.popup_tooltips + "</div>"), t.appendContent(l), t.appendContent('<div style="font-weight: bold;margin-top: 8px;text-shadow: 2px 1px 2px #fae3ad;color: #5e321a;font-size: 16px;margin-bottom: 5px;">' + TWIRlang.market_watcher.add_name + "</div>"), t.appendContent("<span>" + TWIRlang.feat_strings.mw_clear_time + "</span>").appendContent(g.getMainDiv().css({
							"margin-left": "10px"
						})), t.appendContent(A), t.appendContent('<div style="font-weight: bold;margin-top: 8px;text-shadow: 2px 1px 2px #fae3ad;color: #5e321a;font-size: 16px;margin-bottom: 5px;">' + TWIRlang.features.other + "</div>"), t.appendContent(p), t.appendContent("<br>"), $(t.getMainDiv()).css({
							height: "305px",
							"margin-top": "10px",
							"margin-left": "20px",
							width: "680px"
						...
						var u = new west.gui.Button(TWIRlang.organizing.submit, function() {
								if (void 0 !== localStorage) {
									...
									localStorage.setItem("scriptsLang", i.getValue()), TWIR.marketWatcher.saveSettings(), localStorage.setItem("twir_inv_menu_size", d.getValue()), localStorage.setItem("twir_features", JSON.stringify(TWIR.storage.features));
						...
						w.append(u.getMainDiv()), h.append(I, w), $(this.gui.window.getContentPane()).append(t.getMainDiv()).append(h)
					} catch (e) {
						TWIR.bugHunt(e)
					}
				},
				openDonate: function() {
					try {
						...
						e.getContentPane().append(t), i.append((new west.gui.Groupframe).appendToContentPane(a).getMainDiv()), e.getContentPane().append(i), n.append((new west.gui.Groupframe).appendToContentPane(r).getMainDiv()), e.getContentPane().append(n), e.getContentPane().append(o), $(this.gui.window.getContentPane()).append(e.getMainDiv())
					} catch (e) {}
				}
			},
			handler: function() {
			...
			init: function() {
				if (ItemManager.isLoaded() && Bag.loaded && west.storage.ItemSetManager._initialized) try {
					TWIR.handler(), TWIR.storage.init(), TWIR.usebonus.getKeys(), TWIR.usebonus.getDesc(), TWIR.enhancedPlayerProfile(), TWIR.smarterChat(), TWIR.enhancedChatInfo(), TWIR.addPopup.init(), TWIR.enhancedPopups.init(), TWIR.checkJobs(), TWIR.updateCrafting(), TWIR.checkTown(), TWIR.checkForts(), TWIR.checkRank.init(), TWIR.Inventory.setInv(), TWIR.checkShop(), TWIR.marketWatcher.init(), TWIR.fillOther(), TWIR.checkMap(function() {
						TWIR.checkMarket(function() {
							TWIR.menulink()
						})
					}), TWIR.battleShortcuts.init(), TWIR.gameInject.init(), TWIR.images.getSkillImg(), TWIR.Inventory.initCol(), TWIR.console("TWIR version " + TWIR.version + " by Jamza SUCCESSFULLY LOADED.", "green")
				} catch (e) {
					TWIR.bugHunt(e)
			...
			gameInject: {
				init: function() {
					this.addAllToAddressbook(), this.addAliToTownWindow(), this.fixJobNumbers(), this.addBattleCount(), this.addBestClothes4Build(), this.addMsgToFb(), this.sendMsgAli(), this.afterBattleMsg(), this.bonusToProfile(), this.travelButton(), this.betterBattleTopic(), setInterval(this.addBattleCount, Math.floor(Math.random() * (3e5 + 1) + 3e5))
				},
				...
				bonusToProfile: function() {
					PlayerProfileMain.twir_setWear = PlayerProfileMain.twir_setWear || PlayerProfileMain.setWear, PlayerProfileMain.setWear = function(e, t) {
						...
						if (a.length) {
							...
							l += TWIR.Inventory.fullBonusTooltip(s, !1), i.append(new west.gui.Icon("shirt").getMainDiv().css({
								position: "absolute",
								cursor: "pointer",
								top: "36px",
								left: "230px",
						...
						if (TWIR.storage.get("fb_topic")) {
							...
							for (var i in t)
								if (t[i].id.indexOf("room_fortbattle_") > -1 && t[i].fortId == this.fortId) {
									...
									}).join(""), e += '<br><div><span style="font-weight: bold;color: #523F30;">Topic:&nbsp;</span>' + ("" !== a ? '<span style="font-size: 11px;">&quot;' + a + "&quot;</span>" : "") + "</div>"
								}
						}
						return e
					}
					...
					n.addListener(function(e) {
						if ("fort" === i) switch (e) {
							case 1:
								...
								break;
							case 2:
								var A = t.preBattle.battleData.fortCoords,
									p = r.filter(function(e) {
										var t = A.x - e.coords.x,
											i = A.y - e.coords.y;
					...
					if (!0 !== this.checking && void 0 !== e && void 0 !== t) {
						...
						! function o() {
							Ajax.remoteCallMode("building_cityhall", "list_residents", {
								...
								var l = s.list.data;
								if (l) {
									for (var A = 0; A < l.length; A++) l[A].name !== Character.name && l[A].town_rights > t && !i.includes(l[A].player_id) && r.push(l[A].name);
									if (n < e.length - 1) {
										var p = ++n > 20 ? Math.floor(501 * Math.random() + 500) : n > 30 ? Math.floor(501 * Math.random() + 1500) : 0;
										setTimeout(function() {
											o()
										}, p)
									} else {
				...
				sendMsgAli: function() {
					...
					buttonPos = buttonPos.replace(/this\.window\.\$\('div\.ally\-overview'\)\.append\(change_btn\.getMainDiv\(\)\);/, 'this.window.$(\'div.ally-overview\').append($(change_btn.getMainDiv()).css({"left":"350px"}));'), eval("AllianceWindow.OverviewinitCont = " + buttonPos), AllianceWindow.twir_calcCoord4Worldmap = function(e) {
						...
						for (var a = [], n = 0; n < e.length; n++) {
							var r = e[n],
								o = {};
							(o = AllianceWindow.twir_calcCoord4Worldmap([r.x, r.y])) && a.push($('<img onclick="javascript:void(Map.center(' + r.x + "," + r.y + '))" title="' + r.name + '" src="/images/map/minimap/icons/miniicon_alliance_' + t + '.png" class="mmap_wmappoint" style="cursor: pointer;" />').css({
								left: o.x + i.left + "px",
								top: o.y + i.top + "px"
							}))
						}
			...
			battleShortcuts: {
					...
					try {
						...
						for (var r in n)
							if (n[r].id.indexOf("room_fortbattle_") > -1 && n[r].fortId === a) {
								...
								return '<span><img class="chat_servicegrade_' + A[l][0] + '" src="/images/transparent.png" title="' + A[l][1] + '</span>"/>'
							} return !1
					} catch (e) {
						return !1
					}
				...
				getLiveData: function() {
					...
					FortBattle.twir_flashShowCharacterInfo = FortBattle.twir_flashShowCharacterInfo || FortBattle.flashShowCharacterInfo, FortBattle.flashShowCharacterInfo = function(t, i, a, n, r, o, s, l, A) {
						var p = JSON.parse(l),
							c = p.offense + p.defense + p.leadbonus != 0;
						e.data.playerId = i, e.data.fortId = t, e.data.isAllied = c, FortBattle.twir_flashShowCharacterInfo.apply(this, arguments)
					}
				},
				addInfo: function() {
					var e = TWIR.battleShortcuts;
					FortBattle.twir_getCharDataSheet = FortBattle.twir_getCharDataSheet || FortBattle.getCharDataSheet, FortBattle.getCharDataSheet = function(t) {
						...
						if (a) {
							...
							var n = a.westPlayerId,
								...
								l = o ? o.statusId : 0,
								A = e.formatStatus(l, n),
								p = e.formatPlayerRank(n, r) ? e.formatPlayerRank(n, r) : "",
							...
							g += '<table style="margin:0;padding:0;font-size:8pt"><tr style="font-size:8pt;height:20px;font-weight:bold;">', g += '<td style="vertical-align: middle;"><div style="font-size:13px; font-family: georgia, times new roman, serif; font-weight: bold;">' + a.name + '&nbsp;</div></td><td style="vertical-align: middle;">' + (TWIR.storage.get("fb_online_status") && n !== Character.playerId ? A : "") + '&nbsp;</td><td style="vertical-align: middle;">' + (TWIR.storage.get("fb_ranks") ? p : "") + "</td>";
			...
			smarterChat: function() {
				...
				TWIR.storage.get("chat_smart") && (! function() {
					...
					var i = new RegExp(/\b(?:([\w-]+:\/\/?|www[.])[^\s()<>]+(?:\([\w\d]+\)|([^.,?!:;<=>"\#$%&'()*+,\-\/@\\_{|}~\s]|\/)))/gi),
						...
						A = new RegExp(/https?:\/\/\S+?\/\S+?\.(?:jpg|jpeg|gif|png)/);
					switch (!0) {
						case A.test(e):
							var p = A.exec(e);
							if (p && e.length === p[0].length) {
								var c = '<div style="width: 280px; height: 165px; margin: 15px; cursor: pointer;" onclick="showlink(\'' + p[0].escapeHTML() + '\');return false" target="_blank"> <img src="' + p[0] + '" style="height: 100%;width: auto;"/></div>';
								return e = e.replace(p[0], c)
							}
							break;
						case a.test(e):
							var g = a.exec(e),
			...
			handleCopy: function(e) {
				var t = e.getAttribute("data-item-id"),
					...
					r = function(e) {
						(e.clipboardData || window.clipboardData || e.originalEvent.clipboardData).setData("text/plain", n), e.preventDefault(), window.removeEventListener("copy", r, !1)
					};
			...
			enhancedPlayerProfile: function() {
				...
				PlayerProfileMain.twir_ranking = {
					init: function(t, i) {
						PlayerProfileMain.twir_ranking.getDuelRank(t), PlayerProfileMain.twir_ranking.getFortRank(t), PlayerProfileMain.twir_ranking.getCraftRank(t), PlayerProfileMain.twir_ranking.getBuildRank(t), PlayerProfileMain.twir_ranking.getMpiRank(t), e && (PlayerProfileMain.twir_ranking.setRankBar(i), PlayerProfileMain.twir_ranking.addProfPoints(i))
					},
					...
					getDuelRank: function(i) {
						...
						for (var n = 0; n < a.length; n++) {
							var r = a[n];
							if (r.player_id == i) return t.duels.rank = r.counter, t.duels.win = r.duel_win, t.duels.loss = r.duel_loss, t.duels.diff = r.difference, e = r.name, !0
						}
						return !1
					},
					getFortRank: function(i) {
						...
						for (var n = 0; n < a.length; n++) {
							var r = a[n];
							if (r.player_id == i) return t.forts.rank = r.counter, t.forts.damage_dealt = r.damage_dealt, t.forts.dodges = r.dodges, t.forts.hits_taken = r.hits_taken, e = r.name, !0
						}
						return !1
					},
					getCraftRank: function(i) {
						...
						for (var n = 0; n < a.length; n++) {
							var r = a[n];
							if (r.player_id == i) return t.craft.id = r.profession_id, t.craft.rank = r.counter, t.craft.crafted = r.items_created, t.craft.learnt = r.learnt_recipes, t.craft.points = r.profession_skill, e = r.name, !0
						}
						return !1
					},
					getBuildRank: function(i) {
						...
						for (var n = 0; n < a.length; n++) {
							var r = a[n];
							if (r.player_id == i) return t.build.rank = r.counter, t.build.points = r.total_cp, t.build.stage_ups = r.stage_ups, t.build.fair = r.fair_points, e = r.name, !0
						}
						return !1
					},
					getMpiRank: function(i) {
						...
						for (var n = 0; n < a.length; n++) {
							var r = a[n];
							if (r.player_id == i) return t.mpi.rank = r.counter, t.mpi.games = r.games_played, t.mpi.friendly_dmg = r.friendly_dmg, t.mpi.ko = r.knockouts, t.mpi.rq = r.rage_quits, e = r.name, !0
						}
						return !1
					},
					...
					setDuelsTitle: function() {
						...
						return o += "<ul style=&quot;list-style-type:none&quot;>", o += "<li>" + a + ":&nbsp;" + t.duels.rank + "</li>", o += "<li>" + i + ":&nbsp;" + t.duels.win + "</li>", o += "<li>" + n + ":&nbsp;" + t.duels.loss + "</li>", o += "<li>" + r + ":&nbsp;" + t.duels.diff + "</li>", o += "</ul>"
					},
					setFortsTitle: function() {
						...
						return o += "<ul style=&quot;list-style-type:none&quot;>", o += "<li>" + i + ":&nbsp;" + t.forts.rank + "</li>", o += "<li>" + a + ":&nbsp;" + (t.forts.damage_dealt >= 1e4 ? TWIR.replSum(t.forts.damage_dealt) : t.forts.damage_dealt) + "</li>", o += "<li>" + n + ":&nbsp;" + t.forts.hits_taken + "</li>", o += "<li>" + r + ":&nbsp;" + t.forts.dodges + "</li>", o += "</ul>"
					},
					setBuildTitle: function() {
						...
						return o += "<ul style=&quot;list-style-type:none&quot;>", o += "<li>" + i + ":&nbsp;" + t.build.rank + "</li>", o += "<li>" + a + ":&nbsp;" + (t.build.points >= 1e4 ? TWIR.replSum(t.build.points) : t.build.points) + "</li>", o += "<li>" + n + ":&nbsp;" + (t.build.fair >= 1e4 ? TWIR.replSum(t.build.fair) : t.build.fair) + "</li>", o += "<li>" + r + ":&nbsp;" + t.build.stage_ups + "</li>", o += "</ul>"
					},
					setCraftTitle: function() {
						...
						return o += "<ul style=&quot;list-style-type:none&quot;>", o += "<li>" + i + ":&nbsp;" + t.craft.rank + "</li>", o += "<li>" + a + ":&nbsp;" + t.craft.points + "</li>", o += "<li>" + n + ":&nbsp;" + t.craft.learnt + "/35</li>", o += "<li>" + r + ":&nbsp;" + (t.craft.crafted >= 1e4 ? TWIR.replSum(t.craft.crafted) : t.craft.crafted) + "</li>", o += "</ul>"
					},
					setMpiTitle: function() {
						...
						return r += "<ul style=&quot;list-style-type:none&quot;>", r += "<li>" + i + ":&nbsp;" + t.mpi.rank + "</li>", r += "<li>" + a + ":&nbsp;" + t.mpi.games + "</li>", r += "<li>" + n + ":&nbsp;" + t.mpi.ko + "</li>", r += "<li>" + TWIRlang.ranking.rg + ":&nbsp;" + t.mpi.rq + "</li>", r += "</ul>"
					},
					setRankBar: function(e) {
						...
						t.duels.html = $('<span class="twir_profitem" title="' + PlayerProfileMain.twir_ranking.setDuelsTitle() + '" style="background: rgba(0,0,0,0.4) url(' + TWIR.images.profile.duels + ') 0 50% no-repeat;"/> ' + t.duels.rank + " </span>"), t.forts.html = $('<span class="twir_profitem" title="' + PlayerProfileMain.twir_ranking.setFortsTitle() + '" style="background: rgba(0,0,0,0.4) url(' + TWIR.images.profile.forts + ') 0 50% no-repeat;"/> ' + t.forts.rank + " </span>"), t.build.html = $('<span class="twir_profitem" title="' + PlayerProfileMain.twir_ranking.setBuildTitle() + '" style="background: rgba(0,0,0,0.4) url(' + TWIR.images.profile.build + ') 0 50% no-repeat;"/> ' + t.build.rank + " </span>"), t.craft.html = $('<span class="twir_profitem" title="' + PlayerProfileMain.twir_ranking.setCraftTitle() + '" style="background: rgba(0,0,0,0.4) url(' + TWIR.images.profile.craft + ') 0 50% no-repeat;"/> ' + t.craft.rank + " </span>"), t.mpi.html = $('<span class="twir_profitem" title="' + PlayerProfileMain.twir_ranking.setMpiTitle() + '" style="background: rgba(0,0,0,0.4) url(' + TWIR.images.profile.mpi + ') 0 50% no-repeat;"/> ' + t.mpi.rank + " </span>");
			...
			addPopup: {
				...
				calcPosition: function(e, t) {
					try {
						...
						var A = e.width,
							p = Map.height;
						i || (i = $("#popup-container").find(".twir_popup")), (o = MousePopup.prototype.wrap(l)) !== a && (i.html(o), a = o, n = i.height(), r = i.width()), t > Map.width / 2 ? e.left = e.left - r : e.left = e.left + A, p - e.top < n + 10 && (e.top = p - (n + 10)), i.css({
							top: e.top,
							left: e.left
						})
					} catch (e) {}
				...
				getMarketPrice: function(e) {
					try {
						...
						if (i[t.short] && TWIR.storage.get("mw_item_price_tooltip")) {
							...
							0 != i[t.short].change && i[t.short].change < 1e3 && i[t.short].change > -1e3 && i[t.short].offer_count >= 5 && (n += '<span style="color:' + (i[t.short].change < 0 ? "#900" : "#070") + '; text-align: center;margin-bottom: 2px;padding-left: 15px;">' + (i[t.short].change > 0 ? "+" : "") + i[t.short].change + "%</span>"), n += '<div class="twir_better_popup" style="text-align:left;margin: 0 auto;display: table;"><table style="display: table !important;border-spacing: 1px !important;min-width: 200px; max-width: 220px;"><tbody>';
							var r = i[t.short].weight_min,
								o = i[t.short].weight_max;
							n += '<tr><td style="vertical-align: middle!important;padding-left: 2px;color: #00153f;border-spacing: 1px !important;">' + TWIRlang.tooltips.suggested_price + ':&nbsp;</td><td style="color: black;float: right;vertical-align: middle;">$' + TWIR.replSum(r) + (o > r + 1e3 ? "&nbsp;-&nbsp;$" + TWIR.replSum(o) : "") + "</td></tr>", n += '<tr><td style="vertical-align: middle!important;padding-left: 2px;color: #00153f;border-spacing: 1px !important;font-size: 12px;">' + TWIRlang.tooltips.minimal_price + "&nbsp;/&nbsp;" + TWIRlang.tooltips.maximal_price + ':&nbsp;</td><td style="color: black;vertical-align: middle;float: right;">$' + TWIR.replSum(i[t.short].offer_min.price) + "&nbsp;/&nbsp;$" + TWIR.replSum(i[t.short].offer_max.price) + "</td></tr>", n += '<tr><td style="vertical-align: middle!important;padding-left: 2px;color: #00153f;border-spacing: 1px !important;font-size: 12px;">' + TWIRlang.tooltips.average + ':&nbsp;</td><td style="color: black;vertical-align: middle;float: right;">$' + TWIR.replSum(i[t.short].weight) + "</td></tr>", 0 != i[t.short].weight_since && (n += '<tr><td style="vertical-align: middle!important;padding-left: 2px;color: #00153f;border-spacing: 1px !important;font-size: 12px;">' + TWIRlang.tooltips.average_since.replace("$1", "7") + ':&nbsp;</td><td style="color: black;vertical-align: middle;float: right;">$' + TWIR.replSum(i[t.short].weight_since) + "</td></tr>"), n += "</tbody></table></div><br>", n += '<div style="color: #00153f;font-size: 12px;text-align:center;">' + TWIRlang.tooltips.seen.replace("$1", i[t.short].offer_count) + "</div>", 0 != i[t.short].unique && (n += '<div style="color: #00153f;font-size: 12px;text-align:center;">' + TWIRlang.tooltips.uniq_sellers.replace("$1", i[t.short].unique) + "</div>");
					...
					try {
						...
						Ajax.remoteCallMode("character", "ajax_get_buffs", {}, function(t) {
							if (t.msg.event && void 0 !== t.msg.event.description)
								for (var i = t.msg.event.description, a = 0; a < i.length; a++) {
							...
							if (t.msg.character && void 0 !== t.msg.character.description)
								for (var o = t.msg.character.description, s = 0; s < o.length; s++) {
									var l = o[s].replace(/[0-9\%\+\:\-\$\.]/g, "").replace(/(\(|\)).*/g, "").trim(),
										A = new RegExp("^.*" + l + "(.*)$", "i");
									A.test(TWIR.usebonus.desc.experience) && (e += t.msg.character.description[s].replace(/[^0-9.]/g, ""))
								}
							...
							if (JobsModel.Beans[t.id]) {
								...
								for (var r = {}, o = 0, s = 0, l = 0; l < JobsModel.Beans[t.id].basis.long.yields.length; l++) {
									var A = ItemManager.get(JobsModel.Beans[t.id].basis.long.yields[l].itemid, !0).short;
						...
						try {
							...
							if (t = t.replace(/(<p\s+class="inventory_popup_type">)([\S\s]*?<\/p>)/gi, '<div style="text-align: center; display: ' + r + ';"><img src="' + o + '" height="16" width="auto"></img><span style="margin-right: 10px;position: relative;font-size: 11px;font-style: italic;vertical-align: middle;">' + s + '</span></div> <p class="inventory_popup_type" style="max-width: 250px!important;margin-left: auto;margin-right: auto;margin-top: 5px;"> $2'), this.item_obj.description.length && (t = t.replace(this.item_obj.description, '<span style="color: #007777;">' + this.item_obj.description + "</span>")), this.item_obj instanceof west.item.Weapon && TWIR.storage.get("pop_avg_dmg")) {
								var l = this.item_obj.getDamage(this.options.character),
									A = Math.floor((l.min + l.max) / 2);
								t = t.replace('-<span class="current_value">' + l.max + "</span>", '$&<span style="color: #084f29;">&nbsp;(' + A + ")</span>")
							}
							if (this.item_obj.usebonus && "recipe" !== this.item_obj.type && TWIR.storage.get("pop_bonus_calc")) {
								for (var p = TWIR.usebonus.keys.energy, c = TWIR.usebonus.keys.health, g = "", d = 0; d < this.item_obj.usebonus.length; d++)
									if (this.item_obj.usebonus[d].match(p)) {
							...
							if (b[this.item_obj.short] && TWIR.storage.get("pop_ups_price")) {
								var x = 1 === this.item_obj.item_level ? 3 : 2 === this.item_obj.item_level ? 9 : 3 === this.item_obj.item_level ? 27 : 4 === this.item_obj.item_level ? 81 : 5 === this.item_obj.item_level ? 243 : 1,
									...
									V = null !== b[this.item_obj.short].limited_time ? '<span style="color: #666;">&nbsp;(' + TWIR.msToTime((new Date(1e3 * b[this.item_obj.short].limited_time).getTime() - (new Date).getTime()) / 1e3) + ")</span>" : "",
							...
							if ("mapdrop" === this.item_obj.spec_type && "none" === this.item_obj.usetype && TWIR.storage.get("pop_job_table")) {
								...
								for (var H = '<div class="twir_better_popup" style="text-align:center;margin: 0 auto;display: table;"><table style="display: table !important;border-collapse: separate !important;border-spacing: 1px !important;border-radius: 3px;border: 1px solid #804000;"><tbody>', Z = 0; Z < D.length; Z++) {
									var P = 0,
										N = 0;
									if ($.isEmptyObject(JobsModel.Beans) || null == JobsModel.Beans[D[Z].id].basis.long.yields[0]) P = Math.ceil(600 * D[Z].yields[this.item_obj.item_id].prop), N = 0;
							...
							if (TWIR.storage.get("pop_partial_bonus") && null !== this.item_obj.set && 0 === ee && !1 === i && (t += '<td><div style="display: inline-block;background: url(/images/window/wof/prizes_sep.jpg);width: 25px;height: 270px;margin: 15px 0;"/></td><td class="twir_popup_pb" style="min-width: 200px;max-width: 275px;">'), null !== this.item_obj.set) {
								...
								if (TWIR.storage.get("pop_partial_bonus") && 0 == ee && !1 === i) {
									...
									le += '<div style="color: #666; margin-bottom: 5px;font-style: italic;">' + (null !== ie ? "&nbsp;>&nbsp;" + ie.name : "") + "</div>", le += '<ul class="twir_partial_bonus" style="max-width: 200px;display: block;min-width: 170px;margin-left: 10px;">';
									var Ae = ae > re ? _.getMergedStages(re) : 0 === ae ? _.getMergedStages(re) : _.getMergedStages(ae),
										pe = null !== ie && ae > re ? ie.getMergedStages(re) : null !== ie ? ie.getMergedStages(ae) : [];
									...
									for (var ce = [], ge = [], de = 0; de < Ae.length; de++) {
										var me = void 0 !== oe.getDesc(Ae[de]) ? oe.getDesc(Ae[de]).replace(/[^0-9.\%]/g, "") : "",
											ue = void 0 !== oe.getDesc(Ae[de]) ? oe.getDesc(Ae[de]).replace(/[0-9\%\+\.\,]/g, "").replace(/(\(|\)).*/g, "").trim() : "";
										ce.push({
											skill: ue,
											value: me
										})
									...
									for (var he = 0; he < pe.length; he++) {
										var we = void 0 !== oe.getDesc(pe[he]) ? oe.getDesc(pe[he]).replace(/[^0-9.\%]/g, "") : "",
											Ie = void 0 !== oe.getDesc(pe[he]) ? oe.getDesc(pe[he]).replace(/[0-9\%\+\.\,]/g, "").replace(/(\(|\)).*/g, "").trim() : "";
										ge.push({
											skill: Ie,
											value: we
										})
									}
									for (var be = [], fe = 0; fe < ce.length; fe++) {
			...
			initItems: function() {
				try {
					var e = Bag.items_by_id,
						...
						r = [CharacterSkills.keyNames.aim, CharacterSkills.keyNames.tough, CharacterSkills.keyNames.reflex, CharacterSkills.keyNames.dodge, CharacterSkills.keyNames.tactic, CharacterSkills.keyNames.appearance, n],
						o = Object.values(a),
						s = Object.keys(a),
						l = [],
						A = {};
					for (var p in e) {
								...
								for (var g = 0; g < c.usebonus.length; g++) {
									...
									switch (!0) {
										case m > -1 && !$.isNumeric(s[m]):
											A[s[m]] || (A[s[m]] = []), A[s[m]].includes(c.item_id) || A[s[m]].push(c.item_id);
											break;
										case Object.keys(CharacterSkills.keyNames).some(function(e) {
											...
											A.skills || (A.skills = []), A.skills.includes(c.item_id) || A.skills.push(c.item_id);
										case Object.keys(CharacterSkills.keyNames).some(function(e) {
											return i.same(CharacterSkills.keyNames[e].toLowerCase(), d.toLowerCase()) && $.inArray(CharacterSkills.keyNames[e], r) > -1
										}):
											A.duels || (A.duels = []), A.duels.includes(c.item_id) || A.duels.push(c.item_id);
											break;
										default:
									...
									if (u) switch (!0) {
										case i.same(a.unpack_card, d):
											A.craft_cards || (A.craft_cards = []), A.craft_cards.includes(c.item_id) || A.craft_cards.push(c.item_id);
											break;
										case !i.same(a.unpack_card, d):
											A.crafted_items || (A.crafted_items = []), A.crafted_items.includes(c.item_id) || A.crafted_items.push(c.item_id)
									}
								}
							var h = TWIR.storage.popups.crafting[c.item_id];
							h && (A["prof_" + h.profsymbol] || (A["prof_" + h.profsymbol] = []), A["prof_" + h.profsymbol].includes(c.item_id) || A["prof_" + h.profsymbol].push(c.item_id))
						} else if ("bonus_medal" === c.spec_type && "use" === c.usetype || 50991e3 === c.item_id) A.bonus_medal || (A.bonus_medal = []), A.bonus_medal.includes(c.item_id) || A.bonus_medal.push(c.item_id);
						...
						"recipe" === c.type && (A.recipes || (A.recipes = []), A.recipes.includes(c.item_id) || A.recipes.push(c.item_id))
					}

					function w(e) {
						if (!Array.isArray(e)) return A[e] || [];
						for (var t = [], i = 0; i < e.length; i++) A[e[i]] && (t = t.concat(A[e[i]]));
						return t
					}
					...
					}), TWIR.storage.inventory.use_all = y, TWIR.storage.inventory.buffs_all = b, TWIR.storage.inventory.crafting_all = v;
			...
			updateCrafting: function(e) {
				...
				} else TWIR.storage.popups.crafting = t || {}, (!a || a && Game.version > Number(a)) && TWIR.updateCrafting(!0), localStorage.twir_dataVersion = Game.version
			},
			checkJobs: function() {
			...
			checkShop: function() {
				...
				Ajax.remoteCallMode("shop_trader", "index", {}, function(i) {
					...
					if (void 0 !== i.inventory) {
						...
						for (var A in setTimeout(function() {
								TWIR.checkShop()
							}, l), i.inventory)
							if (i.inventory[A])
								for (var p = 0; p < i.inventory[A].length; p++) {
									var c = i.inventory[A][p],
			...
			checkMap: function(e) {
				if (!LinearQuestHandler.hasTutorialQuest()) return Ajax.get("map", "get_minimap", {}, function(t) {
					...
					var i = t.forts;
					for (var a in i)
						for (var n in i[a]) i[a][n].fort && (i[a][n].fort.alliance_id == Character.homeTown.alliance_id && TWIR.storage.sleep[i[a][n].fort.name] ? TWIR.storage.sleep[i[a][n].fort.name].fort_type = i[a][n].fort.type : Character.forts.some(function(e) {
					...
					for (var s in o)
						...
						p = t.quest_locations;
					for (var c in p) p[c] && p[c][0] && A.push([parseInt(p[c][0][0] / Map.tileSize), parseInt(p[c][0][1] / Map.tileSize)]);
					Ajax.get("map", "get_complete_data", {
						tiles: JSON.stringify(A)
					}).done(function(t) {
						for (var i = {}, a = t.quests, n = 0; n < A.length; n++)
							for (var r = a[A[n][0]][A[n][1]][0][1], o = 0; o < r.employer.length; o++)
						...
						if (!$.isEmptyObject(l))
							for (var p in i)
								for (var c = 0; c < i[p].length; c++)
									for (var g = 0; g < l[p].length; g++) void 0 !== l[p] && void 0 !== l[p][g].quests && l[p][g].posx == i[p][c].posx && l[p][g].posy == i[p][c].posy && (i[p][c].quests = l[p][g].quests);
					...
					try {
						...
						for (var t = {}, i = 0; i < e.length; i++) {
							...
							if ((!s || o || e[i].max_price) && (s || !o || e[i].auction_price) && (t[a.short] || (t[a.short] = {
								...
								var c = p(A, "weight_avg");
								c ? t[a.short].weight_avg[c] += 1 : t[a.short].weight_avg[A] = 1, t[a.short].item_count += e[i].item_count, t[a.short].offer_count += 1, isDefined(e[i].seller) && !t[a.short].sellers.includes(e[i].seller) && (t[a.short].unique += 1, t[a.short].sellers.push(e[i].seller)), t[a.short].owned = n;
								if (new Date - new Date(e[i].date) <= 6048e5) {
									var g = p(A, "weight_avg_since");
									g ? t[a.short].weight_avg_since[g] += 1 : t[a.short].weight_avg_since[A] = 1
								} else {
									var d = p(A, "weight_avg_old");
									d ? t[a.short].weight_avg_old[d] += 1 : t[a.short].weight_avg_old[A] = 1
								}
				...
				calcRecommended: function(e, t) {
					...
					for (var n in e) {
						...
						for (var A in o) {
							if (r <= Number(A)) {
								var p = i(Number(A), l);
								p ? l[p] += 1 : l[Number(A)] = 1
							}
							if (r >= Number(A)) {
								var c = i(Number(A), s);
								c ? s[c] += 1 : s[Number(A)] = 1
							}
						}
					...
					try {
						...
						for (var t = {}, i = 0; i < e.length; i++) {
							...
							if ((!s || o || e[i].max_price) && (s || !o || e[i].auction_price) && (t[a.short] || (t[a.short] = {
								...
								new Date(e[i].date) > new Date(t[a.short].seen) && (t[a.short].seen = e[i].date), (A > t[a.short].offer_max.price || A == t[a.short].offer_max.price && new Date(e[i].date) > new Date(t[a.short].offer_max.date)) && (t[a.short].offer_max.price = parseInt(l / e[i].item_count), t[a.short].offer_max.date = e[i].date), (A > t[a.short].offer_max_x.each && e[i].item_count <= t[a.short].offer_max_x.count || A == t[a.short].offer_max_x.each && e[i].item_count <= t[a.short].offer_max_x.count && new Date(e[i].date) > new Date(t[a.short].offer_max_x.date)) && (t[a.short].offer_max_x.each = A, t[a.short].offer_max_x.count = e[i].item_count, t[a.short].offer_max_x.price = l, t[a.short].offer_max_x.date = e[i].date), (A < t[a.short].offer_min.price || A == t[a.short].offer_min.price && new Date(e[i].date) > new Date(t[a.short].offer_min.date)) && (t[a.short].offer_min.price = A, t[a.short].offer_min.date = e[i].date), (A < t[a.short].offer_min_x.each && e[i].item_count >= t[a.short].offer_min_x.count || A == t[a.short].offer_min_x.each && e[i].item_count >= t[a.short].offer_min_x.count && new Date(e[i].date) > new Date(t[a.short].offer_min_x.date)) && (t[a.short].offer_min_x.each = A, t[a.short].offer_min_x.price = l, t[a.short].offer_min_x.count = e[i].item_count, t[a.short].offer_min_x.date = e[i].date)
							}
						}
			...
			itemList: {
				...
				reset: function(e) {
					this.ready[e] = !1, delete this.elements[e], this.elements[e] = [], this.getMainDiv(e).children().remove(), this.getMainDiv(e).append('<style type="text/css">.' + e + "_filter{display:none;}</style>")
				},
				init: function(e, t) {
					var i, a, n;
					this.reset(t), this.ready[t] = !0, this.gui[t].main || (this.gui[t].main = this.getMainDiv(t)), this.gui[t].result = $('<div class="tw2gui_jobsearchbar_allresults" style="width:225px;" />'), this.gui[t].input || (this.gui[t].input = (new west.gui.Textfield).maxlength(32).setClass4Input("tw2gui_jobsearch_string").setWidth(165)), this.gui[t].button = $('<div class="tw2gui_jobsearch_showall" style="display:block;cursor:pointer;"></div>'), this.gui[t].scrollpane = new west.gui.Scrollpane, $(this.gui[t].scrollpane.getMainDiv()).css({
						width: "225px",
						height: "0px"
					});
					for (var r = 0; r < e.length; r++) i = e[r], a = $("<p>" + i.name + "</p>"), (n = {}).dom = a, n.dom.addClass(t + "_filter"), n.id = r, n.str = "Â§" + i.name.toUpperCase() + "Â§", i.key && (n.key = i.key), n.type = i.type, "set" !== i.type && "buff" !== i.type && (n.str += String(i.key).toUpperCase() + "Â§"), this.elements[t].push(n);
				...
				open: function(e, t, i) {
					...
					$.each(a.elements[i], function(e, r) {
						r.dom.off(), n && r.dom.is(":visible") ? (a.focused[i] = e, r.dom.addClass("focused"), n = !1) : r.dom.removeClass("focused"), r.dom.click((r.id, function() {
							t.cmd({
								val: r.key,
								type: r.type
							}), a.gui[i].result.is(":visible") && a.gui[i].result.hide()
						})), a.gui[i].scrollpane.appendContent(r.dom)
					}), this.gui[i].result.children().remove(), this.gui[i].result.append(this.gui[i].scrollpane.getMainDiv()), this.gui[i].button.click(function() {
			...
			marketWatcher: {
				...
				init: function() {
					this.getSettings(), this.addCss(), this.checkCollectible(), this.start(), this.addMarketTabs(), this.handleConnection()
				},
				wait: function() {
				...
				start: function(e) {
					...
					this.t = setTimeout(function() {
						t.scanMarket()
					}, A), TWIR.console("TWIR/: Next market scan in: " + (A / 1e3).getTime2EndString(!1) + ".", "#8b4513"), e || A > 18e4 && n && setTimeout(function() {
						t.wtb = n || {}, t.auctions = r || {}, $.isEmptyObject(t.wtb) && $.isEmptyObject(t.auctions) || t.showMarketAlert()
					}, 6e4)
				},
				...
				openMWTab: function() {
					...
					var t = this.idField,
						...
						A = (TWIR.images.bell, TWIRlang.features.alert_sound, TWIR.images.bell, TWIR.images.currency.dollars, this.regexItems()),
						p = this.categories,
						c = (new west.gui.Combobox).setWidth(120);
					c.addItem("all", TWIRlang.market_watcher.all_items), c.addItem("valuable", TWIRlang.market_watcher.valuable), c.addItem("watched", TWIRlang.market_watcher.watched_items), c.addItem("none", TWIRlang.market_watcher.nothing), c.select(i), c.addListener(function(t) {
						e.settings.scan = t, TWIR.marketWatcher.saveSettings()
					});
					...
					function h() {
						m = "", MarketWindow.window.$("div.twir_mwl_tab", MarketWindow.DOM).empty(), e.gui.table = (new west.gui.Table).addColumn("twir_mw_idx").addColumn("twir_mw_item").addColumn("twir_mw_name").addColumn("twir_mw_price").addColumn("twir_mw_remove").appendToThCell("head", "twir_mw_name", TWIRlang.market_watcher.watching, TWIRlang.market_watcher.watching).appendToThCell("head", "twir_mw_price", TWIRlang.market_watcher.max_price, TWIRlang.market_watcher.max_price).appendToCell("head", "twir_mw_idx").appendToCell("head", "twir_mw_item").appendToCell("head", "twir_mw_name").appendToCell("head", "twir_mw_price").appendToCell("head", "twir_mw_remove");
						for (var t = e.mwl, i = 0; i < t.length; i++) {
							var a = t[i].type && "buff" === t[i].type ? A[t[i].item_id] : t[i].type && "set" === t[i].type ? west.storage.ItemSetManager.get(t[i].item_id) : ItemManager.get(t[i].item_id, !0),
								n = p.includes(t[i].type) ? 'data-item-id="' + t[i].item_id + '"' : "",
							...
							e.gui.table.appendToCell(-1, "twir_mw_item", "<img " + n + ' style="cursor: pointer;" title="' + (p.includes(t[i].type) ? new ItemPopup(a).getXHTML().escapeHTML() : t[i].type && "set" === t[i].type ? TWIR.Inventory.itemShowcase(a.items, !1, !0) : a.name) + '" src="' + (p.includes(t[i].type) ? a.image : t[i].type && "buff" === t[i].type ? ItemManager.get(A[t[i].item_id].image).image : t[i].type && "set" === t[i].type ? l.image : "") + '"; height="29"; width="29"></img>'), e.gui.table.appendToCell(-1, "twir_mw_name", r), t[i].item_price ? e.gui.table.appendToCell(-1, "twir_mw_price", "$" + (t[i].item_price >= 1e5 ? TWIR.replSum(t[i].item_price) : t[i].item_price)) : e.gui.table.appendToCell(-1, "twir_mw_price", "-");
							...
							if (e.gui.table.appendToCell(-1, "twir_mw_remove", c), $.isNumeric(t[i].item_id) && p.includes(t[i].type)) m += "[item=" + t[i].item_id + "]&nbsp;";
						...
						var d = new west.gui.Icon("link").getMainDiv().css({
							...
							! function() {
								...
								t.append("<br><br>", '<span style="margin-right: 5px;">' + TWIRlang.market_watcher.export+"</span>", a), new west.gui.Dialog("", t).setDraggable(!0).setBlockGame(!1).setId("twir_mw_import").addButton("ok", function() {
						...
						t.length && e.gui.table.appendToFooter("twir_mw_remove", I), o.append(e.gui.table.getMainDiv()), e.gui.table.noScrollbar || (null === u && (u = e.gui.table.bodyscroll.getScrollPos()), e.gui.table.bodyscroll.scrollTo(u.x, u.y), u = e.gui.table.bodyscroll.getScrollPos())
					}
					...
					function I(e) {
						...
						t.empty(), t.append(function(e) {
							...
							} else "buff" === i ? (l.text(TWIRlang.inventory[t].cutIt(36)), t = A[t].image) : $.isNumeric(t) && 0 != t ? l.text(ItemManager.get(t, !0).name.cutIt(36)) : l.text("-- " + TWIRlang.market_watcher.no_select + " --");
					...
					var x = $('<div style="position:absolute;top:95px;left:15px;width:26px;height:20px;background:url(/images/window/character/title_editbtn.jpg) no-repeat scroll 0 0 transparent;cursor:pointer;"></div>'),
						v = "twir_mw_mainlist";
					TWIR.itemList.init(TWIR.storage.itemList, v), x.on("click", function() {
						var e = {
							cmd: function(e) {
								k(e)
							}
					...
					V.append(g.getMainDiv().css({
						"margin-right": "25px"
					})).append(d.getMainDiv()), n.append($('<div style="position: absolute; left: 30px; top: 0px;">' + TWIRlang.market_watcher.settings_watch + ":</div>")).append(c.getMainDiv().css({
						position: "absolute",
						left: "40px",
						top: "15px"
					})).append(V);
					...
					return T.append($('<span style="width: 90px;display: inline-block;text-align: right;padding-right: 8px;vertical-align: middle;">' + TWIRlang.market_watcher.max_buyout + "</span>")).append(b.getMainDiv().css({
					...
					})), f.append((new west.gui.Groupframe).appendToContentPane($('<div style="height: 244px;"/>').append(s, x, l).append(TWIR.itemList.getMainDiv(v).css({
						left: "40px",
						top: "90px",
						display: "none"
						...
						k(t), b.setValue("")
					})).append(T).append(y.getMainDiv())).getMainDiv()), a.append(f, $('<div class="market_devider_bottom" style="left: 10px;width: 225px;top: 55px;" />'), $('<div class="market_devider_bottom" style="top: 55px; width: 426px;" />'), r, n, o), MarketWindow.window.$("div.marketplace-twir_mw", MarketWindow.DOM).empty().append(a), this
				},
					...
					for (var o = 0; o < a.length; o++) {
						if ((a[o].item_id === i.item_id || a[o].item_id === i.set || Object.keys(n).includes(a[o].item_id) && r(a[o].item_id)) && !t) {
							if (a[o].item_id === i.set && this.mwl.some(function(e) {
									return $.isNumeric(e.item_id) && west.storage.ItemSetManager.get(i.set).items.includes((e.item_id - e.item_id % 1e3) / 1e3)
								})) continue;
							return a[o]
						}
				...
				scanMarket: function() {
					...
					var a = 1,
						...
						l = (new Date).valueOf(),
						A = this.mwl,
						p = this.settings.scan;
					TWIR.storage.get("mw_status") && "none" !== p && i.show(TWIRlang.market_watcher.progress_title + "..", "..."),
						function c() {
							"none" !== p ? (e.checking = !0, TWIR.storage.get("mw_status") && i.status(s(TWIRlang.market_watcher.progress_page + " " + a)), Ajax.remoteCall("building_market", "search", {
								page: a
							}, function(g) {
								if (!g.error)
									if (!1 === g.error) {
										for (var d = g.msg.search_result, m = 0; m < d.length; m++) {
											0;
											...
											if (2 === d[m].sell_rights)
												if (!("yield" !== h.type || null !== h.set || TWIR.storage.inventory.collectibles.indexOf(u) >= 0 || TWIR.storage.inventory.bonus.indexOf(u) >= 0) || "all" != p && "valuable" != p) {
													if ("all" == p)
														if (e.marketOther.some(function(e) {
															...
															e.marketOther[I].date = l, e.marketOther[I].auction_price = d[m].current_bid ? d[m].current_bid : d[m].auction_price
												...
												e.marketMain[b].date = l, e.marketMain[b].auction_price = d[m].current_bid ? d[m].current_bid : d[m].auction_price
											...
											function y(e) {
												t[e][h.short] ? t[e][h.short].some(function(e) {
													return e.offer_id === d[m].market_offer_id
												}) || t[e][h.short].push(k) : (t[e][h.short] = [], t[e][h.short].some(function(e) {
													return e.offer_id === d[m].market_offer_id
												}) || t[e][h.short].push(k))
											}
										...
										setTimeout(function() {
											if (!0 === g.msg.next) a++, c();
												...
												if (e.wtb = t.wtb, e.wtb_missing = t.wtb_missing, e.auctions = t.auctions, TWIR.storage.get("mw_trader"))
													for (var s = e.trader, l = 0; l < s.length; l++) {
														var p = ItemManager.get(s[l].item_id, !0),
															d = A.find(function(e) {
																return e.item_id === s[l].item_id
															}),
															m = new Date(1e3 * s[l].auction_end_date).getTime() - (new Date).getTime();
														s[l].auction_ends_in = m / 1e3, s[l].posx = Character.position.x, s[l].posy = Character.position.y, e.wtb_missing[p.short] && 0 === e.wtb_missing[p.short].filter(function(e) {
															return "trader" === e.spec
														}).length ? e.wtb_missing[p.short].unshift(s[l]) : e.missing.indexOf(p.name) >= 0 && !e.wtb_missing[p.short] && (e.wtb_missing[p.short] = [], e.wtb_missing[p.short].push(s[l])), e.wtb[p.short] && 0 === e.wtb[p.short].filter(function(e) {
															return "trader" === e.spec
														}).length ? e.wtb[p.short].unshift(s[l]) : !e.wtb[p.short] && d && (e.wtb[p.short] = [], e.wtb[p.short].push(s[l]))
													}
												e.marketMain = TWIR.beatMarketData(e.marketMain), e.marketOther = TWIR.beatMarketData(e.marketOther);
												var u = e.marketMain,
													h = e.marketOther;
												if (void 0 !== localStorage) {
													var w = TWIR.minMarketData(u),
														...
														b = e.wtb,
														f = e.auctions;
													TWIR.storage.save("twir_marketData", w), TWIR.storage.save("twir_marketDataJunk", I), TWIR.storage.save("twir_marketDataTemp", b, !0), TWIR.storage.save("twir_marketDataFullTemp", f, !0);
													var k = (new Date).getTime();
													TWIR.marketPrice.init(), TWIR.console("TWIR/: Market Scan completed at " + Chat.Formatter.formatTime((new Date).getTime(), !1) + " in " + ((k - o) / 1e3).getTime2EndToken() + " (" + a + " pages, " + (e.marketMain.length - n + (e.marketOther.length - r)) + " new listings).", "green"), sessionStorage && sessionStorage.setItem("twir_timer", (new Date).getTime().toString())
												} else new UserMessage(TWIRlang.informative.storage_error + "!", UserMessage.TYPE_ERROR).show();
												e.showMarketAlert(), e.checking = !1, TWIR.storage.get("mw_status") && i.hide(), e.checkCollectible(), TWIR.checkShop(), e.start(!0)
											}
				...
				searchMarket: function(e) {
					...
					$("div.marketplace").is(":visible") || (i ? MarketWindow.open(Character.homeTown.town_id) : MarketWindow.open()), MarketWindow.showTab("buy"), $("div.market-buy .iSearchbox input", MarketWindow.DOM).val(e), $("span.iconBut_mpb_refresh", MarketWindow.DOM).click(), $("div.market-buy .iSearchbox input", MarketWindow.DOM).val(""), wman.close("inventory")
				},
				setMarketAlert: {
					gui: {
						window: {},
					...
					open: function(e) {
						...
						this.itemList.wtb = this.getList(a), this.itemList.buff = this.getList(n), this.itemList.coll = this.getList(i), this.itemList.all = this.getList(r);
						var o = this.itemList;
						this.gui.window = wman.open("TWIR_MW", null, "escape noreload").setTitle(TWIRlang.market_watcher.add_name).setMiniTitle(TWIRlang.market_watcher.add_name).setSize(570, 475), $.isEmptyObject(a) || this.gui.window.addTab(TWIRlang.market_watcher.watched, "twir_MWA_watched", function() {
						...
						}), TWIR.itemList.init("watched" == e ? o.wtb : "buffs" == e ? o.buff : "coll" == e ? o.coll : o.all, "twir_mw_alertlist"), this.makeHtml(), this.browse(e), this.gui.window.activateTab("watched" == e ? "twir_MWA_watched" : "buffs" == e ? "twir_MWA_buffs" : "coll" == e ? "twir_MWA_coll" : "twir_MWA_browse")
					},
					makeHtml: function() {
						var e = this;
						this.gui.window.clearContentPane(), this.gui.scroll = (new west.gui.Scrollpane).appendContent("<div/>"), this.input.player = (new west.gui.Textfield).maxlength(14).setWidth(95), this.input.town = (new west.gui.Textfield).maxlength(14).setWidth(95), this.input.name = TWIR.itemList.getInput("twir_mw_alertlist"), this.gui.main.table = $('<div style="position: absolute; top: 40px; width: 515px;"></div>').append((new west.gui.Groupframe).appendToContentPane($('<div style="height: 288px;"/>').append(this.gui.scroll.getMainDiv())).getMainDiv());
						var t = $('<div style="position: relative; display: inline-block; top: 7px; width:26px;height:20px;background:url(/images/window/character/title_editbtn.jpg) no-repeat scroll 0 0 transparent;cursor:pointer;"></div>'),
							...
							o = $('<img class="click_icon icon__map" src="/images/transparent.png" style="position: absolute;left: 35px;bottom: -10px;" onclick="TWIR.marketMap.show()"/>'),
					...
					browse: function(e) {
						...
						function i(e) {
							var i = t.gui.tab,
								a = "";
							a = "object" == typeof e && !Object.keys(e).length || !e ? "browse" !== i ? t.format(i) : "" : t.format(i, e), t.gui.scroll.getContentPane().empty().append($(a))
						}
						this.gui.tab = e, i();
						var a = {
							cmd: function(e) {
					...
					getList: function(e) {
						...
						var p = ["set", ...Inventory.availableCategories, "buff", "yield", "recipe"];
					...
					filterBySettings: function(e, t) {
						...
						for (var s in e) {
							o[s] = [];
							for (var l = 0; l < e[s].length; l++) n && !a && !e[s][l].max_price || !n && a && !e[s][l].auction_price || t && t.name && !r(t.name).test(ItemManager.get(e[s][l].item_id, !0).name) || t && t.val && "set" === t.type && e[s][l].set !== t.val || t && t.val && TWIR.marketWatcher.categories.includes(t.type) && e[s][l].item_id !== t.val || t && t.player && !r(t.player).test(e[s][l].seller_name) || t && t.town && !r(t.town).test(e[s][l].market_town) && !r(t.player).test(e[s][l].seller_town) || o[s].push(e[s][l]);
						...
						if (i = this.filterBySettings(i, t), Object.keys(i).length) {
							...
							for (var r = a, o = 0; o < r.length; o++) {
								...
								if (!s[0].spec || "buff" != s[0].spec || "buffs" === e) {
									...
									var l = "<table>";
									if (s.length > 1) {
										for (var A = s.length <= 11 ? s.length : 11, p = 1; p < A; p++) {
											var c = null !== s[p].max_price ? TWIRlang.market_watcher.price : TWIRlang.market_watcher.bid,
												g = null !== s[p].max_price ? parseInt(s[p].max_price / s[p].item_count) : null !== s[p].curr_bid ? parseInt(s[p].curr_bid / s[p].item_count) : parseInt(s[p].auction_price / s[p].item_count);
											l += "<tr><td>[" + p + "]</td>", l += "<td>@" + s[p].seller_name.cutIt(14) + "</td>", l += "<td>(x" + s[p].item_count + "),&nbsp;</td>", l += "<td>" + c + ":</td>", l += "<td>$" + TWIR.replSum(g, !0) + (s[p].item_count > 1 ? "&nbsp;(" + TWIRlang.tooltips.each + ")" : "") + ",&nbsp;</td>", l += "<td>" + TWIRlang.market_watcher.time_left + ":</td>", l += "<td>" + TWIR.msToTime(s[p].auction_ends_in) + "</td></tr>"
										}
										l += "</table>", s.length >= 11 && (l += '<div style="text-align: center;">...</div>')
									}
									...
									n += '<tr style="border-spacing: 1px !important;background: rgba(220, 165, 118, 0.4);border-radius: 3px;box-shadow: 0 0 1px inset;border-bottom: ' + y + ';"><td style="vertical-align: middle;padding-left: 4px;"><div style="position: relative; height: 29px; width: 35px;"><img data-item-id="' + s[0].item_id + '" style="cursor: pointer;" title="' + new ItemPopup(d).getXHTML().escapeHTML() + '" src="' + d.image + '"; height="29"; width="29"></img>' + V + "</div></td>", n += '<td style="padding: 2px;vertical-align: middle;"><div style="margin-bottom: -2px; cursor: pointer;"><span title="' + d.name + '" data-item-id="' + s[0].item_id + '" style="width: 190px;text-overflow: ellipsis;white-space: nowrap;overflow: hidden;display: inline-block; color: ' + b + ';">' + d.name + '</span><span style="display: inline-block;overflow: hidden;float: right;">(x' + TWIR.replSum(s[0].item_count) + ")</span></div>" + x + "</td>", n += '<td title="' + s[0].auction_end_date.getFormattedTimeString4Timestamp() + '" style="text-align: center;padding: 2px; padding-right: 8px; padding-left: 8px;cursor: pointer;"><div style="font-size: 8pt;">' + TWIRlang.market_watcher.time_left + '</div><div style="margin-top: 4px;">' + TWIR.msToTime(s[0].auction_ends_in) + "</div></td>", n += '<td title="' + (m ? m.escapeHTML() : "") + '" style="text-align: center;padding: 2px;cursor: pointer; padding-left: 8px;"><div style="font-size: 8pt;">' + u + '</div><div style="color: ' + b + '; margin-top: 4px;">$' + TWIR.replSum(h) + "</div></td>", n += '<td style="text-align: center;padding: 2px;cursor: pointer; padding-left: 8px;"><div style="font-size: 8pt;">' + TWIRlang.market_watcher.curr_bid + '</div><div style="margin-top: 4px;">' + ("trader" != s[0].spec && null !== w ? TWIR.replSum(w) : "trader" !== s[0].spec && null !== s[0].auction_price ? '<span style="font-size: 8pt;color: #666;">' + TWIRlang.market_watcher.no_bids + "</span>" : "-") + "</div></td>", n += '<td style="vertical-align: middle;padding-right: 4px;"><div onclick="' + v + '" style="margin-left: 10px;cursor: pointer;"><img src="/images/icons/bid.png" title="' + ("trader" != s[0].spec ? TWIRlang.market_watcher.bid_now : TWIRlang.market_watcher.buy_trader) + '" /> </div></td>', n += "</tr>"
								}
							}
				...
				showMarketAlert: function() {
					...
					if (delete this.OnGoing, $.isEmptyObject(t) && $.isEmptyObject(i) && $.isEmptyObject(n)) $.isEmptyObject(t) && (this.lastAlert = t, TWIR.console("TWIR/: No offers matching your list were found.", "#8b4513"));
						...
						r !== o && (s && this.OnGoing && this.OnGoing.highlightBorder(!0), this.lastAlert = t), s && !TWIR.storage.get("mw_alert_playsound") && this.notify()
					}
				}
			},
			stats: {
				...
				statsQuantities: function() {
					...
					for (var A in t) {
						if (t[A]) var p = t[A].obj;
						switch ("yield" !== p.type && null !== p.set && (l("set_count", 1), l("set_total", t[A].count)), "yield" !== p.type && "recipe" !== p.type && (!e.count_max.obj_max || t[A].count > e.count_max.obj_max.count) && (e.count_max.obj_max = {
							item_id: p.item_base_id,
							count: t[A].count
						}), p.type) {
							case "belt":
							case "body":
							...
							case "animal":
							case "left_arm":
								l("obj_count", 1), l("obj_total", t[A].count), l(p.type + "_count", 1), l(p.type + "_total", t[A].count);
								break;
							case "right_arm":
								l("obj_count", 1), l("obj_total", t[A].count), p.sub_type && (l(p.sub_type + "_count", 1), l(p.sub_type + "_total", t[A].count));
								break;
							case "yield":
								l("prod_count", 1), l("prod_total", t[A].count), (!e.count_max.prod_max || t[A].count > e.count_max.prod_max.count) && (e.count_max.prod_max = {
									count: t[A].count,
									item_id: p.item_base_id
								});
								break;
							case "recipe":
								l(p.type + "_count", 1), l(p.type + "_total", t[A].count)
						}
					}
				...
				statsSalesValue: function() {
					...
					for (var o in t)
						if (t[o]) {
							var s = t[o].obj;
							a("inventory_buy_price", $.isNumeric(s.price) ? s.price * t[o].count : 0), a("inventory_sell_price", $.isNumeric(s.sell_price) ? s.sell_price * t[o].count : 0), 1 != t[o].count || i[s.type] && i[s.type].obj.item_id === s.item_id || (a("unique_buy_price", $.isNumeric(s.price) ? 1 * s.price : 0), a("unique_sell_price", $.isNumeric(s.sell_price) ? 1 * s.sell_price : 0))
						} var l = TWIR.storage.popups.marketPrice;
					for (var A in t)
						if (t[A]) {
							var p = t[A].obj,
								c = $.isNumeric(p.price) ? p.price * t[A].count : 0,
								g = $.isNumeric(p.sell_price) ? p.sell_price * t[A].count : 0;
							switch (l[p.short] && a("market_price", l[p.short].weight * t[A].count), p.type) {
								case "yield":
									a("average_prod_buy_price", c), a("average_prod_sell_price", g), a("products_buy_price", c), a("products_sell_price", g);
									break;
								case "recipe":
									a(p.type + "_buy_price", c), a(p.type + "_sell_price", g);
									break;
								case "belt":
								case "body":
								case "foot":
							...
							"yield" !== p.type && t[A].count > 1 && (a("duplicates_buy_price", c), a("duplicates_sell_price", g)), "yield" !== p.type && !0 === p.dropable && (a("droppable_buy_price", c), a("droppable_sell_price", g))
			...
			pps: {
				...
				apply: function(e) {
					...
					if (t && e) {
						...
						a += '<tr style="height: 20px;"><td style="font-size:13px; font-family: georgia, times new roman, serif; font-weight: bold;border-bottom: 2px solid rgba(25,25,25,0.25);">' + TWIRlang.stats.quantities + '</td><td style="border-bottom: 2px solid rgba(25,25,25,0.25);"></td><td style="text-align: center;font-weight: bold;border-bottom: 2px solid rgba(25,25,25,0.25);">[&#8800;]</td></tr>', e.head && (a += "<tr><td>" + i.head + ':&nbsp;</td><td style="text-align: center;">' + TWIR.replSum(e.head[1], !0) + '&nbsp;</td><td style="text-align: center;">[' + TWIR.replSum(e.head[0], !0) + "]</td></tr>"), e.neck && (a += "<tr><td>" + i.neck + ':&nbsp;</td><td style="text-align: center;">' + TWIR.replSum(e.neck[1], !0) + '&nbsp;</td><td style="text-align: center;">[' + TWIR.replSum(e.neck[0], !0) + "]</td></tr>"), e.body && (a += "<tr><td>" + i.body + ':&nbsp;</td><td style="text-align: center;">' + TWIR.replSum(e.body[1], !0) + '&nbsp;</td><td style="text-align: center;">[' + TWIR.replSum(e.body[0], !0) + "]</td></tr>"), e.pants && (a += "<tr><td>" + i.pants + ':&nbsp;</td><td style="text-align: center;">' + TWIR.replSum(e.pants[1], !0) + '&nbsp;</td><td style="text-align: center;">[' + TWIR.replSum(e.pants[0], !0) + "]</td></tr>"), e.belt && (a += "<tr><td>" + i.belt + ':&nbsp;</td><td style="text-align: center;">' + TWIR.replSum(e.belt[1], !0) + '&nbsp;</td><td style="text-align: center;">[' + TWIR.replSum(e.belt[0], !0) + "]</td></tr>"), e.foot && (a += "<tr><td>" + i.foot + ':&nbsp;</td><td style="text-align: center;">' + TWIR.replSum(e.foot[1], !0) + '&nbsp;</td><td style="text-align: center;">[' + TWIR.replSum(e.foot[0], !0) + "]</td></tr>"), e.hand && (a += "<tr><td>" + TWIRlang.stats.hand + ':&nbsp;</td><td style="text-align: center;">' + TWIR.replSum(e.hand[1], !0) + '&nbsp;</td><td style="text-align: center;">[' + TWIR.replSum(e.hand[0], !0) + "]</td></tr>"), e.shot && (a += "<tr><td>" + TWIRlang.stats.shot + ':&nbsp;</td><td style="text-align: center;">' + TWIR.replSum(e.shot[1], !0) + '&nbsp;</td><td style="text-align: center;">[' + TWIR.replSum(e.shot[0], !0) + "]</td></tr>"), e.left_arm && (a += "<tr><td>" + i.left_arm + ':&nbsp;</td><td style="text-align: center;">' + TWIR.replSum(e.left_arm[1], !0) + '&nbsp;</td><td style="text-align: center;">[' + TWIR.replSum(e.left_arm[0], !0) + "]</td></tr>"), e.animal && (a += "<tr><td>" + i.animal + ':&nbsp;</td><td style="text-align: center;">' + TWIR.replSum(e.animal[1], !0) + '&nbsp;</td><td style="text-align: center;">[' + TWIR.replSum(e.animal[0], !0) + "]</td></tr>"), e.yield && (a += "<tr><td>" + i.yield + ':&nbsp;</td><td style="text-align: center;">' + TWIR.replSum(e.yield[1], !0) + '&nbsp;</td><td style="text-align: center;">[' + TWIR.replSum(e.yield[0], !0) + "]</td></tr>"), e.recipe && (a += "<tr><td>" + TWIRlang.stats.recipes + ':&nbsp;</td><td style="text-align: center;">' + TWIR.replSum(e.recipe[1], !0) + '&nbsp;</td><td style="text-align: center;">[' + TWIR.replSum(e.recipe[0], !0) + "]</td></tr>"), a += '<tr style="height: 10px;"><td style="border-bottom: 2px solid rgba(25,25,25,0.25);"></td><td style="border-bottom: 2px solid rgba(25,25,25,0.25);"></td><td style="border-bottom: 2px solid rgba(25,25,25,0.25);"></td></tr>', e.total && (a += '<tr><td style="font-weight: bold;">' + TWIRlang.stats.total + ':&nbsp;</td><td style="text-align: center;">' + TWIR.replSum(e.total[1], !0) + '&nbsp;</td><td style="text-align: center;">[' + TWIR.replSum(e.total[0], !0) + "]</td></tr>"), a += "</table>", a += '<table style="display:inline-table; width: 225px;">', a += '<tr style="height: 20px;"><td style="font-size:13px; font-family: georgia, times new roman, serif; font-weight: bold;border-bottom: 2px solid rgba(25,25,25,0.25);">' + TWIRlang.stats.sales_value + '</td><td style="border-bottom: 2px solid rgba(25,25,25,0.25);text-align: center;"><img src="' + TWIR.images.sell + '"/></td><td style="text-align: center;font-weight: bold;border-bottom: 2px solid rgba(25,25,25,0.25);"></td></tr>', null != e.cashObj && (a += "<tr><td>" + TWIRlang.stats.items + ':&nbsp;</td><td style="text-align: center;">$' + format_money(e.cashObj) + "&nbsp;</td><td></td></tr>"), null != e.cashProd && (a += "<tr><td>" + TWIRlang.stats.products + ':&nbsp;</td><td style="text-align: center;">$' + format_money(e.cashProd) + "&nbsp;</td><td></td></tr>"), null != e.cashRec && (a += "<tr><td>" + TWIRlang.stats.recipes + ':&nbsp;</td><td style="text-align: center;">$' + format_money(e.cashRec) + "&nbsp;</td><td></td></tr>"), a += '<tr style="height: 10px;"><td style="border-bottom: 2px solid rgba(25,25,25,0.25);"></td><td style="border-bottom: 2px solid rgba(25,25,25,0.25);"></td><td style="border-bottom: 2px solid rgba(25,25,25,0.25);"></td></tr>', e.cash && (a += '<tr><td style="font-weight: bold;">' + TWIRlang.stats.total_buy_price + ':&nbsp;</td><td style="text-align: center;">$' + format_money(e.cash[0]) + "&nbsp;</td><td></td></tr>"), e.cash && (a += '<tr><td style="font-weight: bold;">' + TWIRlang.stats.total_sell_price + ':&nbsp;</td><td style="text-align: center;">$' + format_money(e.cash[1]) + "&nbsp;</td><td></td></tr>"), a += "</table></div></div>", t.addMousePopup(a)
					}
				}
			},
			marketMap: {
				...
				onClick: function(e, t) {
					...
					return i.addItem([1, t], '<span style="color: #5e321a;">' + TWIRlang.menulink.window_open + "</span>").addItem([2, t], '<span style="color: #5e321a;">' + TWIRlang.menulink.map_show + "</span>").addItem([3, t], '<span style="color: #5e321a;">' + TWIRlang.menulink.walk + "</span>").addListener(function(e) {
						switch (e[0]) {
							case 3:
				...
				createItemsPoints4Worldmap: function(e, t) {
					...
					for (var a in e) {
						...
						var l = Object.values(n.items),
							A = (Object.keys(n.items), l.filter(function(e) {
								return "offer_sold" === e.type
							})),
							p = l.filter(function(e) {
								return "bid" === e.type || "offer" === e.type
							}),
							c = p[~~(p.length * Math.random())] || [],
							g = ItemManager.get(c ? c.id : 0, !0),
							d = {};
						if (d = this.calcCoord4Worldmap([n.posx, n.posy])) {
							var m = A.length === l.length ? TWIR.images.currency.dollars : g.image,
								u = "javascript:void(TWIR.marketMap.onClick(arguments, " + JSON.stringify(n).escapeHTML() + "))";
							i.push($('<img onclick="' + u + '" title="' + r + '" src="' + m + '" style="cursor: pointer; position: absolute;width:' + (A.length === l.length ? "16px" : "22px") + ';height: auto;-webkit-filter: drop-shadow(rgb(34, 34, 34) 2px 3px 3px);filter: drop-shadow(rgb(48, 21, 6) 2px 3px 3px);" />').css({
								left: d.x + t.left + "px",
								top: d.y + t.top + "px"
							}))
						}
				...
				createPosPoint4Worldmap: function(e) {
					var t = {};
					return (t = this.calcCoord4Worldmap([Character.getPosition().x, Character.getPosition().y])) ? $('<img title="' + Character.name + '" src="/images/map/minimap/icons/miniicon_pos.png" style="cursor: pointer; position: absolute;width: 16px;height: auto;-webkit-filter: drop-shadow(2px 2px 2px #222);filter: drop-shadow(2px 2px 2px #222);" />').css({
						left: t.x + e.left + "px",
						top: t.y + e.top + "px"
					}) : $([])
				},
				show: function() {
					this.addCss();
					var e = TWIR.storage.market;
					this.gui.window = wman.open("twir_marketmap", null, "escape").setSize(800, 440), this.gui.window.showLoader(), this.gui.window.setTitle('<span style="margin-top: 4px; font-size: 16pt;">' + TWIRlang.menulink.market_map + "</span>"), this.gui.window.setMiniTitle("TWIR - " + TWIRlang.menulink.market_map), $(".tw2gui_window_inset", this.gui.window.getMainDiv()).css("background-size", "100%"), this.gui.window.addEventListener("WINDOW_RELOAD", function() {
						TWIR.marketMap.show()
					}), this.gui.window.clearContentPane();
					...
					if (!1 === $.isEmptyObject(i)) {
						...
						for (var r in t.addItem(["premium_bids"], ' <img src="' + TWIR.images.currency.nuggets + '" height="16px width="auto" style="left: 5px;top: 5px;"/><span style="margin-left: 15px;color: #5e321a; text-overflow: ellipsis;white-space: nowrap;overflow: hidden;word-wrap: break-word; margin-top: 2px; max-width: 200px;display: inline-block;">' + TWIRlang.menulink.premium_bids + "</span>", TWIRlang.menulink.premium_bids), t.addItem(["premium_offers"], ' <img src="' + TWIR.images.currency.nuggets + '" height="16px width="auto" style="left: 5px;top: 5px;"/><span style="margin-left: 15px;color: #5e321a; text-overflow: ellipsis;white-space: nowrap;overflow: hidden;word-wrap: break-word; margin-top: 2px; max-width: 200px;display: inline-block;">' + TWIRlang.menulink.premium_offers + "</span>", TWIRlang.menulink.premium_offers).addEmpty(), t.addItem(["map"], ' <img src="/images/icons/welt.png" height="16px width="auto" style="left: 5px;top: 5px;"/><span style="margin-left: 15px;color: #5e321a; text-overflow: ellipsis;white-space: nowrap;overflow: hidden;word-wrap: break-word; margin-top: 2px; max-width: 200px;display: inline-block;">' + TWIRlang.menulink.market_map + "</span>", TWIRlang.menulink.market_map).addEmpty(), a) {
							var o = a[r],
								...
								l = 0,
								A = 0;
							for (var p in s += "<div class=&quot;popup_yield&quot; style=&quot;display: block;max-width: 396px;&quot;>", o.items) {
								"offer_sold" === o.items[p].type ? A += o.items[p].money : "offer_sold" !== o.items[p].type && (l += o.items[p].count), Object.keys(o.items).length;
								var c = ItemManager.get(p, !0);
								s += "<div class=&quot;popup_yield_image&quot; style=&quot;margin-right: 1px;margin-bottom: 1px;display: inline-block;&quot;><div class=&quot;item&quot;><span class=&quot;count&quot; style=&quot;display:block;top:30px;left:1px&quot;>" + TWIR.replSum(o.items[p].count) + "</span><img src=&quot;" + c.image + "&quot; alt=&quot;" + c.name + "&quot; width=&quot;43&quot; height=&quot;43&quot; /></div>", "offer_sold" === o.items[p].type && (s += "<span style=&quot;font-size: 11px;text-align: center;display: block;&quot;>$" + TWIR.replSum(o.items[p].money) + "</span>"), s += "</div>"
							}
							s += "</div>", t.addItem(0, '<img src="/images/map/minimap/icons/miniicon_market_items.png" style="left: 5px;top: 8px;"/><span title="' + ("<div>" + o.name + "</div><div>" + TWIRlang.informative.distance + ":&nbsp;" + o.distance.formatDuration() + "</div>").escapeHTML() + '" style="margin-left: 15px;color: #5e321a; text-overflow: ellipsis;white-space: nowrap;overflow: hidden;word-wrap: break-word; margin-top: 2px; max-width: 170px;display: inline-block;">' + o.name + '</span><span title="' + s + '" style="display: inline-block;margin-top: 3px;color: #5e321a;position: relative;float: right;font-size: 12px;">&#124;&nbsp;' + (0 != A ? "$" + TWIR.replSum(A) + (0 != l ? ",&nbsp;" : "") : "") + (0 != l ? TWIR.replSum(l) + "&nbsp;" + TWIRlang.tooltips.items : "") + "</span>", (new west.gui.Selectbox).setHeader(o.name.cutIt(16)).setWidth(180).addItem([1, o], '<span style="color: #5e321a;">' + TWIRlang.menulink.window_open + "</span>").addItem([2, o], '<span style="color: #5e321a;">' + TWIRlang.menulink.map_show + "</span>").addItem([3, o], '<span style="color: #5e321a;">' + TWIRlang.menulink.walk + "</span>").addListener(n, this))
						}
			...
			makeSleepMenu: function(e) {
				try {
					...
					for (var l = 0, A = 0; A < t.items.length; A++) {
						var p = t.items[A].node.text(),
							c = 7.5 * p.length + 60;
					...
					return t.addListener(function(e) {
						...
						function o(e) {
							...
							Ajax.remoteCallMode("building_hotel", "get_data", {
								...
								var l = s.waytime,
									A = l.split(":"),
									p = 60 * +A[0] * 60 + 60 * +A[1] + +A[2];
								return s.hotel_level >= e && p <= 3600 ? TaskQueue.add(new TaskSleep(a[t].town_id, i[s.hotel_level - 1])) : p > 3600 ? new UserMessage(TWIRlang.informative.error_hotel + "!").show() : n < r.length - 1 ? (n++, void setTimeout(function() {
									o(e)
			...
			loadNPCData: function(e, t) {
				...
				if (!0 !== i.npcLoading) {
					...
					! function r() {
						...
						var s = e ? 1 : o.length;
						for (var l = 0; l < s; l++) {
							var A = e ? t : TWIR.storage.NPC[a[n]][l];
							Ajax.remoteCall("quest_employer", "", {
								...
								for (var p = 0; p < l.length; p++) {
									...
									switch (c) {
										case 1:
											var g = l[p].requirements.filter(function(e) {
												return !0 === e.solved
											});
											g.length === l[p].requirements.length ? o.p1f += 1 : o.p1 += 1;
											break;
										case 2:
											var g = l[p].requirements.filter(function(e) {
												return !0 === e.solved
											});
											g.length === l[p].requirements.length ? o.p2f += 1 : o.p2 += 1;
											break;
										case 3:
											var g = l[p].requirements.filter(function(e) {
												return !0 === e.solved
											});
											g.length === l[p].requirements.length ? o.p3f += 1 : o.p3 += 1;
											break;
										case 4:
											var g = l[p].requirements.filter(function(e) {
												return !0 === e.solved
											});
											g.length === l[p].requirements.length ? o.p4f += 1 : o.p4 += 1
									}
								}
								e ? TWIR.storage.NPC[A.index[0]][A.index[1]].quests = o : A.quests = o, n < a.length - 1 ? (n++, setTimeout(function() {
									r()
					...
					if (Object.keys(TWIR.storage.NPC).length > 0) {
						...
						for (var n in Object.keys(TWIR.storage.NPC).sort(function(e, t) {
							...
							for (var r = i[n], o = 0; o < r.length; o++) {
								var s = r[o],
									l = r[o].quests || {},
									A = ('<span style="display: inline-block;"><img src="/images/quest/employer/' + r[o].key + '.png" height="33" width="auto" style="border-radius: 5px;"/></span><span style="display: inline-block;vertical-align: middle;margin-left: 2px;"><div>' + n + "</div></span><br><div>" + TWIRlang.informative.distance + ":&nbsp;" + Map.calcWayTime(TWIR.lastPos(), {
										x: s.posx,
										y: s.posy
									}).formatDuration() + "</div>").escapeHTML(),
									p = '<div style="max-width:250px"><span class="teaser_headline"></span>';
								p += '<div class="teaser_content">', 0 != l.p4 && (p += '<span><img style="margin-right: 2px;margin-bottom: 2px;" class="tw2gui-iconset tw2gui-icon-exclamation-priority-4" src="/images/tw2gui/pixel-vfl3z5WfW.gif"><span style="vertical-align: middle;">' + l.p4 + "x</span></span>"), 0 != l.p4f && (p += '<span><img style="margin-right: 2px;margin-bottom: 2px;" class="tw2gui-iconset tw2gui-icon-question-priority-4" src="/images/tw2gui/pixel-vfl3z5WfW.gif"><span style="vertical-align: middle;">' + l.p4f + "x</span></span>"), 0 != l.p3 && (p += '<span><img style="margin-right: 2px;margin-bottom: 2px;" class="tw2gui-iconset tw2gui-icon-exclamation-priority-3" src="/images/tw2gui/pixel-vfl3z5WfW.gif"><span style="vertical-align: middle;">' + l.p3 + "x</span></span>"), 0 != l.p3f && (p += '<span><img style="margin-right: 2px;margin-bottom: 2px;" class="tw2gui-iconset tw2gui-icon-question-priority-3" src="/images/tw2gui/pixel-vfl3z5WfW.gif"><span style="vertical-align: middle;">' + l.p3f + "x</span></span>"), 0 != l.p2 && (p += '<span><img style="margin-right: 2px;margin-bottom: 2px;" class="tw2gui-iconset tw2gui-icon-exclamation-priority-2" src="/images/tw2gui/pixel-vfl3z5WfW.gif"><span style="vertical-align: middle;">' + l.p2 + "x</span></span>"), 0 != l.p2f && (p += '<span><img style="margin-right: 2px;margin-bottom: 2px;" class="tw2gui-iconset tw2gui-icon-question-priority-2" src="/images/tw2gui/pixel-vfl3z5WfW.gif"><span style="vertical-align: middle;">' + l.p2f + "x</span></span>"), 0 != l.p1 && (p += '<span><img style="margin-right: 2px;margin-bottom: 2px;" class="tw2gui-iconset tw2gui-icon-exclamation-priority-1" src="/images/tw2gui/pixel-vfl3z5WfW.gif"><span style="vertical-align: middle;">' + l.p1 + "x</span></span>"), 0 != l.p1f && (p += '<span><img style="margin-right: 2px;margin-bottom: 2px;" class="tw2gui-iconset tw2gui-icon-question-priority-1"; src="/images/tw2gui/pixel-vfl3z5WfW.gif"><span style="vertical-align: middle;">' + l.p1f + "x</span></span>"), p += "</div></div>", (TWIR.npcLoaded && null == r[o].quests || 0 == l.tot) && (p = "");
								var c = TWIR.npcLoaded && null != r[o].quests && 0 != l.tot ? '<span title="' + p.escapeHTML() + '" style="display: inline-block;margin-top: 3px;color: #5e321a;position: relative;float: right;font-size: 12px;">|&nbsp;' + l.tot + "&nbsp;" + TWIRlang.tooltips.quests + "</span>" : "";
								t.addItem(0, '<img src="/images/quest/employer/' + r[o].key + '.png" height="22px;" width="auto" style="left: 2px;border-radius: 5px;""><span title= "' + A + '"style="margin-left: 20px;color: #5e321a; text-overflow: ellipsis;white-space: nowrap;overflow: hidden;word-wrap: break-word; margin-top: 2px; max-width: ' + (TWIR.npcLoaded && null != r[o].quests && 0 != l.tot ? "150px" : "250px") + ';display: inline-block;">' + n + "</span>" + c, (new west.gui.Selectbox).setHeader(n.cutIt(16)).setWidth(180).addItem([1, r[o]], '<span style="color: #5e321a;">' + TWIRlang.menulink.window_open + "</span>").addItem([2, r[o]], '<span style="color: #5e321a;">' + TWIRlang.menulink.map_show + "</span>").addItem([3, r[o]], '<span style="color: #5e321a;">' + TWIRlang.menulink.walk + "</span>").addListener(a, this))
							}
						for (var g = 0, d = 0; d < t.items.length; d++) {
							var m = t.items[d].node.text(),
			...
			makeSelectMenu: function(e, object, header) {
				try {
					...
					changeSize(selectbox), changeWidth(selectbox), selectbox.addListener(function(e) {
						...
						if (0 < i.length) return TWIR.Inventory.data.lastItems = i, TWIR.Inventory.data.title = [sorted[e].name, TWIRlang.inventory[header]], Inventory.addItems("twir", 1, !1);
			...
			Inventory: {
				...
				setInv: function() {
					var self = this;
					Inventory.uid = "inventory", Inventory.size = 99999, Inventory.sizeSearch = 99999, Inventory.sizeCustom = 66, Inventory.width = 608, Inventory.availableCategories = ["new", "head", "neck", "body", "pants", "belt", "foot", "right_arm", "left_arm", "animal"], Inventory.addedCategories = ["bonus", "useable", "buff", "craft", "work", "quest"], Inventory.defaultCategory = "new", Inventory.latestSize = 66, Inventory.context = null, EventHandler.listen("inventory_ready", function() {
						TWIR.storage.get("inv_searchwindow_remember_search") || self.as_reset(), TWIR.storage.get("inv_setwindow_remember_search") || self.ss_reset()
					...
					return upButtonString && upButtonString[1] && (upButtonString = upButtonString[1]), upButtonString = upButtonString.match(/'(.*?)'/) && upButtonString.match(/'(.*?)'/)[1] ? upButtonString.match(/'(.*?)'/)[1] : "???", oldFL = oldFL.replace(upButton, "Inventory.guiElements.upgradeButton=new west.gui.Iconbutton(TWIR.images.upgradeicon, west.window.item_upgrade.open, west.window.item_upgrade, null, null).setTitle(upTitle).addClass('upgrade_items');"), oldFL = oldFL.replace(/Inventory\.guiElements\.searchShowButton\s{0,1}\=\s{0,1}new west\.gui\.Iconbutton\(new west\.gui\.Icon\('search'\),\s{0,1}function\(\)\s{0,1}\{/, "Inventory.guiElements.searchShowButton=new west.gui.Iconbutton(new west.gui.Icon('search'),function(){").replace(/Inventory\.showCategory\('set'\);/, "TWIR.Inventory.showSearch();").replace(/\.addClass\('open_search'\)/, ".addClass('open_search').addClass('twir_searchButton')"), oldFL = oldFL.replace(/Inventory\.window\.appendToContentPane\([\w\W]*Inventory\.DOM\s{0,1}\=\s{0,1}Inventory\.window\.\$\('div\.tw2gui_window_content_pane'\);/, "Inventory.guiElements.scrollPane=new west.gui.Scrollpane().appendContent($(\"<div id='bag'></div>\"));Inventory.window.appendToContentPane($filters,$(\"<div id='twir_content_pane' style='width: 700px!important;height: 355px!important;overflow: hidden; position: absolute;top: 100px;'></div>\").append(Inventory.guiElements.scrollPane.getMainDiv()),$(\"<div class='instant_wear_container'></div>\").append(Inventory.guiElements.instantWearButton.getMainDiv()),$('<div class=\"actions\"></div>').append(Inventory.guiElements.upgradeButton.getMainDiv(),Inventory.guiElements.searchShowButton.getMainDiv()));Inventory.DOM=Inventory.window.$('div.tw2gui_window_content_pane');"), eval("Inventory.firstLoad=(function(){ var upTitle=upButtonString; return " + oldFL + "})();"), Inventory.addItemsByCategory = function(e) {
						...
						try {
							...
							var t = 0,
								i = e.length;
							setTimeout(function() {
								for (var e = 0; e < i; ++e) Bag.getItemCount(Inventory.searchResult[e].obj.item_id) && Inventory.addItemDivToInv(Inventory.searchResult[e]), t++;
						...
						i || void 0 === Inventory.guiElements.scrollPane || Inventory.guiElements.scrollPane.verticalBar.move(0, !1, !0), Inventory.category = e, Inventory.page = 1
				...
				showSearch: function() {
					...
					try {
						...
						kbItems = this.getSearchKeywords(), r.addItem(1, "&#8226;&#8226;&#8226;");
						for (var o = 0; o < kbItems.length; o++) r.addItem(kbItems[o][0], kbItems[o][1]);
						r.select(1), r.addListener(function(e) {
							if (1 !== e) {
								var t = function(e) {
								...
								$("#inventory_search").val() !== t && ($("#inventory_search").val(t), Inventory.search()), r.select(1)
							}
						});
						var s = (new west.gui.Combobox).setWidth(45);
						bItems = this.getBonusKeywords(), s.addItem(1, "&#8226;&#8226;&#8226;");
						for (var l = 0; l < bItems.length; l++) s.addItem(bItems[l][0], bItems[l][1]);
						...
						})).appendTo(A), $("<td/>").append(r.getMainDiv().css({
							"margin-left": "20px"
						})).appendTo(A), $("<td/>").append(s.getMainDiv().css({
							"margin-left": "20px"
						})).appendTo(A), $('<table style="margin-bottom: 5px;margin-left: auto;margin-right: auto;"/>').append(i, A).appendTo(t);
						var p = $("<tr/>"),
							c = new west.gui.Checkbox(TWIRlang.organizing.invert, ""),
							g = new west.gui.Combobox;
						g.addItem("none", TWIRlang.informative.any);
						for (var d = this.getFiltBox(), m = 0; m < d.length; m++) g.addItem(d[m].filter, d[m].name);
						g.select(e.data.filter[0]), g.addListener(function(t) {
							var i = $("#inventory_search").val();
							e.data.filter[0] = t, "" === i && $("#inventory_search").val("allitems"), Inventory.search()
						}), c.setCallback(function() {
							var t = $("#inventory_search").val();
							e.data.filter[1] = c.isSelected(), "" === t && $("#inventory_search").val("allitems"), Inventory.search()
						}), c.setSelected(e.data.filter[1], !0);
						var u = (new west.gui.Combobox).setWidth(90);
						u.addItem("none", TWIRlang.informative.any);
						for (var h = this.getSearchTypes(), w = 0; w < h.length; w++) u.addItem(h[w].type, h[w].name);
						u.select(e.data.searchType), u.addListener(function(t) {
							var i = $("#inventory_search").val();
							...
							"margin-right": "25px"
						})).appendTo(p), $("<td/>").append(u.getMainDiv().css({
							"margin-right": "10px"
						})).appendTo(p), $('<table style="margin-bottom: 10px;margin-left: auto;margin-right: auto;"/>').append(a, p).appendTo(t), t.append("<hr>");
						...
						f.append(k), b.append(f.on("click", function() {
							I.toggle(), $(k).toggleClass("twir_flip")
						})), t.append(b);
						...
						for (var R = new west.gui.Combobox, x = this.getSortBox(), v = 0; v < x.length; v++) R.addItem(x[v].sort, x[v].name);
						R.select(e.data.order[0]);
						var V = (new west.gui.Combobox).setWidth(90);
						V.addItem("asc", TWIRlang.organizing.sort_up), V.addItem("desc", TWIRlang.organizing.sort_down), V.select(e.data.order[1]), y.setCallback(function() {
							...
							e.data.order[0] = t, Inventory.update(), y.isSelected() && void 0 !== localStorage ? localStorage.setItem("twir_sort", JSON.stringify(e.data.order)) : y.isSelected() || void 0 === localStorage ? (new UserMessage(TWIRlang.informative.storage_error + "!", UserMessage.TYPE_ERROR).show(), y.setEnabled(!1)) : localStorage.removeItem("twir_sort")
						}), V.addListener(function(t) {
							e.data.order[1] = t, Inventory.update(), y.isSelected() && void 0 !== localStorage ? localStorage.setItem("twir_sort", JSON.stringify(e.data.order)) : y.isSelected() || void 0 === localStorage ? (new UserMessage(TWIRlang.informative.storage_error + "!", UserMessage.TYPE_ERROR).show(), y.setEnabled(!1)) : localStorage.removeItem("twir_sort")
						...
						T.setTitle('<span style="margin-top: 4px; font-size: 16pt;">' + TWIRlang.inventory.search + '</span><a id="twir_as_stats" title="' + TWIRlang.stats.stats + '" style="background: url(' + TWIR.images.statsIcon + ') no-repeat;position: relative;text-align: center;display: inline-block;margin-left: 10px;width: 16px;height: 16px;cursor: help;"></a>'), T.getMainDiv().find(".tw2gui_inner_window_title").append($('<div title="' + TWIRlang.informative.hide + '" class="tw2gui_window_buttons_close" style="position: absolute;right: 6px;top: 8px;"></div>').click(function() {
							TWIR.storage.get("inv_searchwindow_remember_search") || e.as_reset(), T.hide()
						})), n.focus()
					} catch (e) {
						TWIR.bugHunt(e)
					}
							...
							switch (a) {
								...
								case "sort_marketprice":
									var l = TWIR.storage.popups.marketPrice[e.obj.short] ? TWIR.storage.popups.marketPrice[e.obj.short].weight : 0,
										A = TWIR.storage.popups.marketPrice[i.obj.short] ? TWIR.storage.popups.marketPrice[i.obj.short].weight : 0;
									if (0 < l && 0 < A && l === A) return 0;
									if (0 === l) return 1;
									if (0 === A) return -1;
									if (n) return l - A;
									if (r) return A - l;
								...
								case "sort_ups":
									var l = TWIR.storage.popups.shop_prices[e.obj.short] ? TWIR.storage.popups.shop_prices[e.obj.short].price_nuggets : TWIR.storage.popups.shop_limited_prices[e.obj.short] ? TWIR.storage.popups.shop_limited_prices[e.obj.short].price_nuggets : 0,
										A = TWIR.storage.popups.shop_prices[i.obj.short] ? TWIR.storage.popups.shop_prices[i.obj.short].price_nuggets : TWIR.storage.popups.shop_limited_prices[i.obj.short] ? TWIR.storage.popups.shop_limited_prices[i.obj.short].price_nuggets : 0,
									...
									if (!(l || p || g)) return 1;
									if (!(A || c || d)) return -1;
									if (n) return l - A || c - p || d - g;
									if (r) return A - l || p - c || g - d;
									break;
								default:
									if (!0 === n) return e.obj.item_id - i.obj.item_id;
									if (!0 === r) return i.obj.item_id - e.obj.item_id
				...
				setsButton: function() {
					var e = this;
					try {
						null == this.data.setsButton && (this.data.setsButton = new west.gui.Iconbutton(new west.gui.Icon("shirt")).addClass("twir_setsButton").setTitle(TWIRlang.inventory.sets).getMainDiv()), $(".actions", Inventory.DOM).append(this.data.setsButton), $(".twir_setsButton").css("cssText", "position: absolute !important;right: 5px; display: inline-block;"), $(e.data.setsButton).on("click", function(t) {
							! function() {
					...
					try {
						...
						if (2 == s.length) {
							var l = $('<img src="' + s[0] + '" style="width: 40px; height: auto;position: absolute;left: -1px; top: 5px;-webkit-transform: scaleX(-1);transform: scaleX(-1);"/>'),
								A = $('<img src="' + s[1] + '" style="width: 40px; height: auto;position: absolute;right: -3px; bottom: 2px;"/>');
							o.append(A, l)
						} else {
					...
					try {
						...
						switch (t) {
							case "weapons":
								...
								l && i.push(l.image), A && i.push(A.image);
								break;
							case "ride":
								...
								p && i.push(p.image), c && i.push(c.image);
								break;
							case "clothes":
				...
				makeSetsSelect: function(e) {
					...
					try {
						...
						var A = $('<span id="twir_sets_clothes" title="' + TWIRlang.inventory.clothes + '" style="border: 2px solid #6B5A3F;border-radius: 8px;height: 50px;width: 50px;display: inline-block; margin: 5px; cursor: pointer; position: relative;"/>');
						A.click(function(t) {
						...
						}), s.append(l, A, p, c), r.append(s);
						var g = (new west.gui.Textfield).maxlength(24).setPlaceholder(Inventory.categoryDesc.set + ".. ").setWidth(150);

						function d() {
							var t = g.getValue();
							t.length >= 3 ? n.data.searchVal = [t] : n.data.searchVal = null, n.updateSetsHtml(e)
						}
						g.getField().on("input paste", (t = function(e) {
							d()
						}, i = 500, a = 0, function(...e) {
							clearTimeout(a), a = setTimeout(t.bind(this, ...e), i || 0)
						}));
						var m = (new west.gui.Combobox).setWidth(45);
						bItems = this.getBonusKeywords(), m.addItem(1, "&#8226;&#8226;&#8226;");
						for (var u = 0; u < bItems.length; u++) m.addItem(bItems[u][0], bItems[u][1]);
						m.select(1), m.addListener(function(e) {
							if (1 !== e) {
								switch (e) {
									case 1:
										return;
						...
						$("<td/>").append(new west.gui.Icon("search", "").getMainDiv(), g.getMainDiv(), new west.gui.Icon("abort", "").getMainDiv().css({
							...
							g.setValue(""), n.data.searchVal = null, n.updateSetsHtml(e)
						})).appendTo(h), $("<td/>").append(m.getMainDiv().css({
							"margin-left": "20px"
						})).appendTo(h), $('<table style="margin-bottom: 5px;margin-left: auto;margin-right: auto;"/>').append(o, h).appendTo(r);
						...
						for (var f in TWIRlang.keyWords) {
							var k = Array.isArray(TWIRlang.keyWords[f]) ? TWIRlang.keyWords[f][0] : TWIRlang.keyWords[f],
						...
						I.addItem("none", TWIRlang.informative.none), I.addListener(function(t) {
							n.data.eventVal = t, n.updateSetsHtml(e)
						...
						$(".tw2gui_inner_window_title", v.getMainDiv()).find(".textart_title").css({
							...
							TWIR.storage.get("inv_setwindow_remember_search") || n.ss_reset(), v.hide()
						})), g.focus(), this.updateSetsHtml(e)
					} catch (e) {
						TWIR.bugHunt(e)
					}
				},
				fixDoubleDuel: function(e) {
					...
					for (var a = [], n = [], r = 0; r < t.length; r++) a.push(t[r].obj.item_base_id), "right_arm" === t[r].obj.type && n.push(t[r].obj.item_base_id);
				...
				getSetsSearch: function(e, t) {
					if (t && e) try {
						var i = this.data.searchVal,
							...
							n = "all" === a || (!("all" === a || !TWIR.storage.setList.eventIcons[e.key] || TWIR.storage.setList.eventIcons[e.key][0] !== a) || "none" === a && !TWIR.storage.setList.eventIcons[e.key]);
						if (null === i) return !1;
				...
				itemShowcase: function(e, t, i) {
					function a(a) {
						var n, r, o, s, l, A = (t ? Bag.getItemsByItemIds(e) : Bag.getItemsByItemIds(TWIR.makeEmUp(e))) || [],
							p = [];
						if (i) {
							...
							if (e && e.length)
								for (var d in Wear.wear) e.includes(t ? Wear.wear[d].getId() : Wear.wear[d].getItemBaseId()) && p.push(Wear.wear[d]);
							for (var m = 0; m < A.length; m++) {
								var u = A[m].obj;
								u.type === a && (!n || u.item_level > n.obj.item_level) && (n = A[m])
							}
							for (var h = 0; h < p.length; h++) {
								var u = p[h].obj;
								u.type === a && (!r || u.item_level > r.obj.item_level) && (r = p[h])
							}
				...
				fullBonusTooltip: function(e, t) {
					if (e) {
						...
						for (var a in e.attribute) i += p("group5", a, e.attribute[a]);
						for (var n in e.skill) i += p("group4", n, e.skill[n]);
						for (var r in e.job_bonus) i += p("group3", r, e.job_bonus[r]);
						for (var o in e.job) {
							var s = JobsModel.getById(Number(o));
							s && "all" !== o ? i += p(void 0, o, e.job[o]) : "all" === o && (i += p("group3", "job", e.job.all))
						}
						for (var l in e.fortbattle) i += p("group1", l, e.fortbattle[l]);
						for (var A in e.other_bonus) "ms" !== A && (i += p("group2", "speed" !== A ? A : "ms", e.other_bonus[A]));
						return i += "</div>"
					}

					function p(e, i, a) {
						var n, r, o;
						e && (n = TWIR.images[e]), n && (r = n.skills[i]), $.isNumeric(i) && (o = JobsModel.getById(Number(i)));
						...
						return s += '<img src="' + (r ? r.img : o ? "/images/jobs/" + o.get("shortname") + ".png" : "/images/items/unknown.png") + '" style="position: absolute; ' + (CharacterSkills.allSkillKeys.includes(i) ? "top: 8px; width: 34px; right: 0;" : "width: 28px; left: 3px;right: 4px;top: 3px;") + '"/>', s += '<div style="background: url(/images/tw2gui/pagebar/bg.png);width: 34px;height: 17px;position: absolute;line-height: 17px;font-size: 11px;bottom: 0;' + (t && t === i ? "color: #26ff00;" : "color: #FFE7B1") + ';text-align: center;">' + (a || 0) + (["dollar", "experience", "luck", "drop", "regen", "ms"].includes(i) ? "%" : "") + "</div>", s += "</div>"
					}
				},
					...
					Bag.search = function(t) {
						if (Bag.loaded) {
							...
							return west.common.forEach(a, function(a, o) {
								var l = a.obj,
									A = l.bonus.item,
									p = "none" === e.data.searchType || e.data.searchType === l.type;
								if (!r.length && p) switch (t.toLowerCase()) {
									case "allitems":
										l.active && n.push(a);
										break;
									case "setitems":
									...
									case "xp":
									case "experience":
										for (var c = 0; c < A.length; c++)(A[c].type && "experience" === A[c].type || s(A[c].bonus) && "experience" === A[c].bonus.type) && n.push(a);
										break;
									case "dollar":
										for (var c = 0; c < A.length; c++)(A[c].type && "dollar" === A[c].type || s(A[c].bonus) && "dollar" === A[c].bonus.type) && n.push(a);
										break;
									case "drop":
										for (var c = 0; c < A.length; c++)(A[c].type && "drop" === A[c].type || s(A[c].bonus) && "drop" === A[c].bonus.type) && n.push(a);
										break;
									case "luck":
										for (var c = 0; c < A.length; c++)(A[c].type && "luck" === A[c].type || s(A[c].bonus) && "luck" === A[c].bonus.type) && n.push(a);
										break;
									case "job":
									case "lp":
									case "pb":
										for (var c = 0; c < A.length; c++)(A[c].type && "job" === A[c].type && "all" === A[c].job || s(A[c].bonus) && "job" === A[c].bonus.type && "all" === A[c].bonus.job) && n.push(a);
										break;
									case "resistance":
										for (var c = 0; c < A.length; c++)(A[c].type && "fortbattle" === A[c].type && "resistance" === A[c].name || s(A[c].bonus) && "fortbattle" === A[c].bonus.type && "resistance" === A[c].bonus.name) && n.push(a);
										break;
									case "damage":
									case "dmg":
										for (var c = 0; c < A.length; c++)(A[c].type && "fortbattle" === A[c].type && "damage" === A[c].name || s(A[c].bonus) && "fortbattle" === A[c].bonus.type && "damage" === A[c].bonus.name) && n.push(a);
										break;
									case "defense":
									case "def":
										for (var c = 0; c < A.length; c++)(A[c].type && "fortbattle" === A[c].type && "defense" === A[c].name || s(A[c].bonus) && "fortbattle" === A[c].bonus.type && "defense" === A[c].bonus.name) && n.push(a);
										break;
									case "offense":
									case "off":
										for (var c = 0; c < A.length; c++)(A[c].type && "fortbattle" === A[c].type && "offense" === A[c].name || s(A[c].bonus) && "fortbattle" === A[c].bonus.type && "offense" === A[c].bonus.name) && n.push(a);
										break;
									case "speed":
									case "ms":
										for (var c = 0; c < A.length; c++)(A[c].type && "speed" === A[c].type || s(A[c].bonus) && "speed" === A[c].bonus.type) && n.push(a);
										break;
									case "regen":
										for (var c = 0; c < A.length; c++)(A[c].type && "regen" === A[c].type || s(A[c].bonus) && "regen" === A[c].bonus.type) && n.push(a);
										break;
									case "pray":
										for (var c = 0; c < A.length; c++)(A[c].type && "pray" === A[c].type || s(A[c].bonus) && "pray" === A[c].bonus.type) && n.push(a);
										break;
									default:
										i.test(l.item_id) || i.test(l.name) || null !== l.set && i.test(west.storage.ItemSetManager.get(l.set).name) || Bag.searchAttrib(l.bonus, i) || Bag.searchUseBonus(l, i) || t == l.level || void 0 !== l.profession && i.test(l.profession) ? n.push(a) : (TWIR.storage.setList.eventIcons[l.set] && TWIR.storage.setList.eventIcons[l.set][1] === t || TWIR.storage.setList.eventIcons[l.set] && TWIR.storage.setList.eventIcons[l.set][0].toLowerCase() + " " + TWIR.storage.setList.eventIcons[l.set][1] === t.toLowerCase()) && p && n.push(a)
								} else TWIR.storage.setList.eventIcons[l.set] && TWIR.storage.setList.eventIcons[l.set][0] === t && TWIR.storage.setList.eventIcons[l.set][1] === r && n.push(a)
							}), e.filter(n)
						}
				...
				addCategories: function(e) {
					...
					r.click(function(e) {
						...
						if (0 < i.length) return t.data.title = [TWIRlang.inventory.work_items, TWIRlang.inventory.work_items], Inventory.addItems("work", 1, !1)
					}), o.click(function(e) {
						var i = Bag.getItemsByItemIds(TWIR.storage.inventory.quest);
						if (0 < i.length) return t.data.title = [TWIRlang.inventory.quest_items, TWIRlang.inventory.quest_items], Inventory.addItems("quest", 1, !1)
					}), n.click(function(e) {
