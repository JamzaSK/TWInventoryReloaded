        ...
        TWIRlang = {}, TWIR = {
            ...
            openMWTab: function() {
                ...
                d.append((new west.gui.Groupframe).appendToContentPane($('<div style="width: 145px;height: 240px;"/>').append(u, new west.gui.Icon("abort", "").getMainDiv().css({
                    ...
                    top: "155px",
                    left: "45px"
                })).append(I.getMainDiv())).getMainDiv()), t.append(d, $('<div class="market_devider_bottom" style="left: 10px;width: 160px;" />'), $('<div class="market_devider_bottom" />'), r, a, i), MarketWindow.window.$("div.marketplace-twir_mw", 
                MarketWindow.DOM).empty().append(t)
